...
enum class ENDILandscape_SourceMode : uint8
{
	...
	Source                                   = 1,
	AttachParent                             = 2,
	WorldCompositionGrid                     = 3,
	FromRuntimeVirtualTextures               = 4,
	ENDILandscape_MAX                        = 5,
};
...
struct alignas(0x10) FNiagaraSystemUpdateContext final
{
public:
...
static_assert(alignof(FNiagaraSystemUpdateContext) == 0x000010, "Wrong alignment on FNiagaraSystemUpdateContext");
static_assert(sizeof(FNiagaraSystemUpdateContext) == 0x0000E0, "Wrong size on FNiagaraSystemUpdateContext");
...
static_assert(sizeof(FNiagaraWorldManagerTickFunction) == 0x000060, "Wrong size on FNiagaraWorldManagerTickFunction");
