...
{
public:
	TArray<struct FDirectoryPath>                 DirectoriesToScan;                                 // 0x0040(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          bInitializeAllLoadedRegistries;                    // 0x0050(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnoreMissingCookedAssetRegistryData;             // 0x0051(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDataRegistrySettings) == 0x000058, "Wrong size on UDataRegistrySettings");
static_assert(offsetof(UDataRegistrySettings, DirectoriesToScan) == 0x000040, "Member 'UDataRegistrySettings::DirectoriesToScan' has a wrong offset!");
static_assert(offsetof(UDataRegistrySettings, bInitializeAllLoadedRegistries) == 0x000050, "Member 'UDataRegistrySettings::bInitializeAllLoadedRegistries' has a wrong offset!");
static_assert(offsetof(UDataRegistrySettings, bIgnoreMissingCookedAssetRegistryData) == 0x000051, "Member 'UDataRegistrySettings::bIgnoreMissingCookedAssetRegistryData' has a wrong offset!");
...
{
public:
	class FName                                   RegistryType;                                      // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AssetRegistrySearchable, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDataRegistryIdFormat                  IdFormat;                                          // 0x0038(0x0008)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	class UScriptStruct*                          ItemStruct;                                        // 0x0040(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, AssetRegistrySearchable, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UDataRegistrySource*>            DataSources;                                       // 0x0048(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UDataRegistrySource*>            RuntimeSources;                                    // 0x0058(0x0010)(Edit, ExportObject, ZeroConstructor, Transient, DisableEditOnInstance, EditConst, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	float                                         TimerUpdateFrequency;                              // 0x0068(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDataRegistryCachePolicy               DefaultCachePolicy;                                // 0x006C(0x0014)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UDataRegistry, IdFormat) == 0x000038, "Member 'UDataRegistry::IdFormat' has a wrong offset!");
static_assert(offsetof(UDataRegistry, ItemStruct) == 0x000040, "Member 'UDataRegistry::ItemStruct' has a wrong offset!");
static_assert(offsetof(UDataRegistry, DataSources) == 0x000048, "Member 'UDataRegistry::DataSources' has a wrong offset!");
static_assert(offsetof(UDataRegistry, RuntimeSources) == 0x000058, "Member 'UDataRegistry::RuntimeSources' has a wrong offset!");
static_assert(offsetof(UDataRegistry, TimerUpdateFrequency) == 0x000068, "Member 'UDataRegistry::TimerUpdateFrequency' has a wrong offset!");
static_assert(offsetof(UDataRegistry, DefaultCachePolicy) == 0x00006C, "Member 'UDataRegistry::DefaultCachePolicy' has a wrong offset!");
...
class alignas(0x10) UMetaDataRegistrySource : public UDataRegistrySource
{
public:
	...
	struct FAssetManagerSearchRules               SearchRules;                                       // 0x0050(0x0080)(Edit, NativeAccessSpecifierPublic)
	TMap<class FName, class UDataRegistrySource*> RuntimeChildren;                                   // 0x00D0(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
#pragma pack(pop)
static_assert(alignof(UMetaDataRegistrySource) == 0x000010, "Wrong alignment on UMetaDataRegistrySource");
static_assert(sizeof(UMetaDataRegistrySource) == 0x000150, "Wrong size on UMetaDataRegistrySource");
...
static_assert(offsetof(UMetaDataRegistrySource, SearchRules) == 0x000050, "Member 'UMetaDataRegistrySource::SearchRules' has a wrong offset!");
static_assert(offsetof(UMetaDataRegistrySource, RuntimeChildren) == 0x0000D0, "Member 'UMetaDataRegistrySource::RuntimeChildren' has a wrong offset!");
...
{
public:
	TSubclassOf<class UDataRegistrySource_CurveTable> CreatedSource;                                 // 0x0148(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDataRegistrySource_DataTableRules     TableRules;                                        // 0x0150(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(UMetaDataRegistrySource_CurveTable) == 0x000010, "Wrong alignment on UMetaDataRegistrySource_CurveTable");
static_assert(sizeof(UMetaDataRegistrySource_CurveTable) == 0x000160, "Wrong size on UMetaDataRegistrySource_CurveTable");
static_assert(offsetof(UMetaDataRegistrySource_CurveTable, CreatedSource) == 0x000148, "Member 'UMetaDataRegistrySource_CurveTable::CreatedSource' has a wrong offset!");
static_assert(offsetof(UMetaDataRegistrySource_CurveTable, TableRules) == 0x000150, "Member 'UMetaDataRegistrySource_CurveTable::TableRules' has a wrong offset!");
...
{
public:
	TSubclassOf<class UDataRegistrySource_DataTable> CreatedSource;                                  // 0x0148(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDataRegistrySource_DataTableRules     TableRules;                                        // 0x0150(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_158[0x8];                                      // 0x0158(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UMetaDataRegistrySource_DataTable) == 0x000010, "Wrong alignment on UMetaDataRegistrySource_DataTable");
static_assert(sizeof(UMetaDataRegistrySource_DataTable) == 0x000160, "Wrong size on UMetaDataRegistrySource_DataTable");
static_assert(offsetof(UMetaDataRegistrySource_DataTable, CreatedSource) == 0x000148, "Member 'UMetaDataRegistrySource_DataTable::CreatedSource' has a wrong offset!");
static_assert(offsetof(UMetaDataRegistrySource_DataTable, TableRules) == 0x000150, "Member 'UMetaDataRegistrySource_DataTable::TableRules' has a wrong offset!");
