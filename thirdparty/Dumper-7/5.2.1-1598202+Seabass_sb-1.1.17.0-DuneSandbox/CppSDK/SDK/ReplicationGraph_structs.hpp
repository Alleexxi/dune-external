...
public:
	...
	bool                                          bIsPriorityReplicated;                             // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D[0x1];                                        // 0x000D(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint16                                        ReplicationPeriodFrame;                            // 0x000E(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        FastPath_ReplicationPeriodFrame;                   // 0x0010(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        ActorChannelFrameTimeout;                          // 0x0012(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FClassReplicationInfo, bIsPriorityReplicated) == 0x00000C, "Member 'FClassReplicationInfo::bIsPriorityReplicated' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, ReplicationPeriodFrame) == 0x00000E, "Member 'FClassReplicationInfo::ReplicationPeriodFrame' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, FastPath_ReplicationPeriodFrame) == 0x000010, "Member 'FClassReplicationInfo::FastPath_ReplicationPeriodFrame' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, ActorChannelFrameTimeout) == 0x000012, "Member 'FClassReplicationInfo::ActorChannelFrameTimeout' has a wrong offset!");
