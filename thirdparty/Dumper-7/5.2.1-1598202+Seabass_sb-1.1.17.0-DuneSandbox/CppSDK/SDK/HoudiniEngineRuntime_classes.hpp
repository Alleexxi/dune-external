...
static_assert(sizeof(UHoudiniLandscapeTargetLayerOutput) == 0x0000D8, "Wrong size on UHoudiniLandscapeTargetLayerOutput");
...
static_assert(offsetof(UHoudiniLandscapeTargetLayerOutput, BakeFolder) == 0x0000A8, "Member 'UHoudiniLandscapeTargetLayerOutput::BakeFolder' has a wrong offset!");
...
static_assert(offsetof(UHoudiniLandscapeTargetLayerOutput, bWriteLockedLayers) == 0x0000C0, "Member 'UHoudiniLandscapeTargetLayerOutput::bWriteLockedLayers' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeTargetLayerOutput, bLockLayer) == 0x0000C1, "Member 'UHoudiniLandscapeTargetLayerOutput::bLockLayer' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeTargetLayerOutput, PropertyAttributes) == 0x0000C8, "Member 'UHoudiniLandscapeTargetLayerOutput::PropertyAttributes' has a wrong offset!");
...
{
public:
	class FName                                   AfterEditLayer;                                    // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class ULandscapeSplineSegment*>        Segments;                                          // 0x00E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniLandscapeSplineTargetLayerOutput) == 0x0000F0, "Wrong size on UHoudiniLandscapeSplineTargetLayerOutput");
static_assert(offsetof(UHoudiniLandscapeSplineTargetLayerOutput, AfterEditLayer) == 0x0000D8, "Member 'UHoudiniLandscapeSplineTargetLayerOutput::AfterEditLayer' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplineTargetLayerOutput, Segments) == 0x0000E0, "Member 'UHoudiniLandscapeSplineTargetLayerOutput::Segments' has a wrong offset!");
...
{
public:
	class UHoudiniAssetComponent*                 HoudiniAssetComponent;                             // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AHoudiniAssetActor) == 0x000358, "Wrong size on AHoudiniAssetActor");
static_assert(offsetof(AHoudiniAssetActor, HoudiniAssetComponent) == 0x000350, "Member 'AHoudiniAssetActor::HoudiniAssetComponent' has a wrong offset!");

// Class HoudiniEngineRuntime.HoudiniAssetComponent
// 0x0540 (0x0B70 - 0x0630)
...
public:
	...
	class UHoudiniAsset*                          HoudiniAsset;                                      // 0x0638(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnParameterChange;                            // 0x0640(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUploadTransformsToHoudiniEngine;                  // 0x0641(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnTransformChange;                            // 0x0642(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnAssetInputCook;                             // 0x0643(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOutputless;                                       // 0x0644(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOutputTemplateGeos;                               // 0x0645(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseOutputNodes;                                   // 0x0646(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_647[0x1];                                      // 0x0647(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDirectoryPath                         TemporaryCookFolder;                               // 0x0648(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDirectoryPath                         BakeFolder;                                        // 0x0658(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniStaticMeshMethod                      StaticMeshMethod;                                  // 0x0668(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_669[0x7];                                      // 0x0669(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHoudiniStaticMeshGenerationProperties StaticMeshGenerationProperties;                    // 0x0670(0x01E0)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FMeshBuildSettings                     StaticMeshBuildSettings;                           // 0x0850(0x0048)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bLandscapeUseTempLayers;                           // 0x08A2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<int32>                                 NodeIdsToCook;                                     // 0x08A8(0x0010)(ZeroConstructor, Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	...
	uint32                                        SubAssetIndex;                                     // 0x09F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         AssetCookCount;                                    // 0x09F4(0x0004)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TMap<class UObject*, int32>                   InputPresets;                                      // 0x0AA0(0x0050)(Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	bool                                          bBakeAfterNextCook;                                // 0x0AF0(0x0001)(ZeroConstructor, DuplicateTransient, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EHoudiniBakeAfterNextCook                     BakeAfterNextCook;                                 // 0x0AF1(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_AF2[0x4E];                                     // 0x0AF2(0x004E)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UHoudiniAssetComponent, HoudiniAsset) == 0x000638, "Member 'UHoudiniAssetComponent::HoudiniAsset' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnParameterChange) == 0x000640, "Member 'UHoudiniAssetComponent::bCookOnParameterChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUploadTransformsToHoudiniEngine) == 0x000641, "Member 'UHoudiniAssetComponent::bUploadTransformsToHoudiniEngine' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnTransformChange) == 0x000642, "Member 'UHoudiniAssetComponent::bCookOnTransformChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnAssetInputCook) == 0x000643, "Member 'UHoudiniAssetComponent::bCookOnAssetInputCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputless) == 0x000644, "Member 'UHoudiniAssetComponent::bOutputless' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputTemplateGeos) == 0x000645, "Member 'UHoudiniAssetComponent::bOutputTemplateGeos' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUseOutputNodes) == 0x000646, "Member 'UHoudiniAssetComponent::bUseOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, TemporaryCookFolder) == 0x000648, "Member 'UHoudiniAssetComponent::TemporaryCookFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakeFolder) == 0x000658, "Member 'UHoudiniAssetComponent::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshMethod) == 0x000668, "Member 'UHoudiniAssetComponent::StaticMeshMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshGenerationProperties) == 0x000670, "Member 'UHoudiniAssetComponent::StaticMeshGenerationProperties' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshBuildSettings) == 0x000850, "Member 'UHoudiniAssetComponent::StaticMeshBuildSettings' has a wrong offset!");
...
static_assert(offsetof(UHoudiniAssetComponent, bLandscapeUseTempLayers) == 0x0008A2, "Member 'UHoudiniAssetComponent::bLandscapeUseTempLayers' has a wrong offset!");
...
static_assert(offsetof(UHoudiniAssetComponent, SubAssetIndex) == 0x0009F0, "Member 'UHoudiniAssetComponent::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetCookCount) == 0x0009F4, "Member 'UHoudiniAssetComponent::AssetCookCount' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenLoaded) == 0x0009F8, "Member 'UHoudiniAssetComponent::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenDuplicated) == 0x0009F9, "Member 'UHoudiniAssetComponent::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bPendingDelete) == 0x0009FA, "Member 'UHoudiniAssetComponent::bPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRecookRequested) == 0x0009FB, "Member 'UHoudiniAssetComponent::bRecookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRebuildRequested) == 0x0009FC, "Member 'UHoudiniAssetComponent::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableCooking) == 0x0009FD, "Member 'UHoudiniAssetComponent::bEnableCooking' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bForceNeedUpdate) == 0x0009FE, "Member 'UHoudiniAssetComponent::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLastCookSuccess) == 0x0009FF, "Member 'UHoudiniAssetComponent::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bParameterDefinitionUpdateNeeded) == 0x000A00, "Member 'UHoudiniAssetComponent::bParameterDefinitionUpdateNeeded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintStructureModified) == 0x000A01, "Member 'UHoudiniAssetComponent::bBlueprintStructureModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintModified) == 0x000A02, "Member 'UHoudiniAssetComponent::bBlueprintModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Parameters) == 0x000A08, "Member 'UHoudiniAssetComponent::Parameters' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Inputs) == 0x000A18, "Member 'UHoudiniAssetComponent::Inputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Outputs) == 0x000A28, "Member 'UHoudiniAssetComponent::Outputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakedOutputs) == 0x000A38, "Member 'UHoudiniAssetComponent::BakedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, UntrackedOutputs) == 0x000A48, "Member 'UHoudiniAssetComponent::UntrackedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HandleComponents) == 0x000A58, "Member 'UHoudiniAssetComponent::HandleComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasComponentTransformChanged) == 0x000A68, "Member 'UHoudiniAssetComponent::bHasComponentTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bFullyLoaded) == 0x000A69, "Member 'UHoudiniAssetComponent::bFullyLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, PDGAssetLink) == 0x000A70, "Member 'UHoudiniAssetComponent::PDGAssetLink' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, RefineMeshesTimer) == 0x000A78, "Member 'UHoudiniAssetComponent::RefineMeshesTimer' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bNoProxyMeshNextCookRequested) == 0x000A98, "Member 'UHoudiniAssetComponent::bNoProxyMeshNextCookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, InputPresets) == 0x000AA0, "Member 'UHoudiniAssetComponent::InputPresets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBakeAfterNextCook) == 0x000AF0, "Member 'UHoudiniAssetComponent::bBakeAfterNextCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakeAfterNextCook) == 0x000AF1, "Member 'UHoudiniAssetComponent::BakeAfterNextCook' has a wrong offset!");
...
static_assert(sizeof(UHoudiniHandleComponent_V1) == 0x0003F0, "Wrong size on UHoudiniHandleComponent_V1");
...
static_assert(sizeof(UHoudiniSplineComponent_V1) == 0x000480, "Wrong size on UHoudiniSplineComponent_V1");
...
// 0x0550 (0x0B80 - 0x0630)
class UHoudiniAssetComponent_V1 final : public UPrimitiveComponent
{
public:
	uint8                                         bGeneratedDoubleSidedGeometry : 1;                 // 0x0630(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_631[0x7];                                      // 0x0631(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicalMaterial*                      GeneratedPhysMaterial;                             // 0x0638(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBodyInstance                          DefaultBodyInstance;                               // 0x0640(0x0190)(Edit, NativeAccessSpecifierPublic)
	ECollisionTraceFlag                           GeneratedCollisionTraceFlag;                       // 0x07D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7D1[0x3];                                      // 0x07D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         GeneratedLightMapResolution;                       // 0x07D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GeneratedDistanceFieldResolutionScale;             // 0x07D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWalkableSlopeOverride                 GeneratedWalkableSlopeOverride;                    // 0x07DC(0x0010)(Edit, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	int32                                         GeneratedLightMapCoordinateIndex;                  // 0x07EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGeneratedUseMaximumStreamingTexelRatio : 1;       // 0x07F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_7F1[0x3];                                      // 0x07F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GeneratedStreamingDistanceMultiplier;              // 0x07F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFoliageType_InstancedStaticMesh*       GeneratedFoliageDefaultSettings;                   // 0x07F8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, AdvancedDisplay, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UAssetUserData*>                 GeneratedAssetUserData;                            // 0x0800(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	class FText                                   BakeFolder;                                        // 0x0810(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   TempCookFolder;                                    // 0x0828(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_840[0x340];                                    // 0x0840(0x0340)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoudiniAssetComponent_V1) == 0x000B80, "Wrong size on UHoudiniAssetComponent_V1");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedPhysMaterial) == 0x000638, "Member 'UHoudiniAssetComponent_V1::GeneratedPhysMaterial' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, DefaultBodyInstance) == 0x000640, "Member 'UHoudiniAssetComponent_V1::DefaultBodyInstance' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedCollisionTraceFlag) == 0x0007D0, "Member 'UHoudiniAssetComponent_V1::GeneratedCollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapResolution) == 0x0007D4, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedDistanceFieldResolutionScale) == 0x0007D8, "Member 'UHoudiniAssetComponent_V1::GeneratedDistanceFieldResolutionScale' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedWalkableSlopeOverride) == 0x0007DC, "Member 'UHoudiniAssetComponent_V1::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapCoordinateIndex) == 0x0007EC, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedStreamingDistanceMultiplier) == 0x0007F4, "Member 'UHoudiniAssetComponent_V1::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedFoliageDefaultSettings) == 0x0007F8, "Member 'UHoudiniAssetComponent_V1::GeneratedFoliageDefaultSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedAssetUserData) == 0x000800, "Member 'UHoudiniAssetComponent_V1::GeneratedAssetUserData' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, BakeFolder) == 0x000810, "Member 'UHoudiniAssetComponent_V1::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, TempCookFolder) == 0x000828, "Member 'UHoudiniAssetComponent_V1::TempCookFolder' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInstancedActorComponent_V1) == 0x000380, "Wrong size on UHoudiniInstancedActorComponent_V1");
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent_V1) == 0x000380, "Wrong size on UHoudiniMeshSplitInstancerComponent_V1");
...
{
public:
	TArray<class UHoudiniHandleParameter*>        XformParms;                                        // 0x0360(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class UHoudiniHandleParameter*                RSTParm;                                           // 0x0370(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UHoudiniHandleParameter*                RotOrderParm;                                      // 0x0378(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniHandleType                            HandleType;                                        // 0x0380(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_381[0x7];                                      // 0x0381(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 HandleName;                                        // 0x0388(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniHandleComponent) == 0x0003A0, "Wrong size on UHoudiniHandleComponent");
static_assert(offsetof(UHoudiniHandleComponent, XformParms) == 0x000360, "Member 'UHoudiniHandleComponent::XformParms' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RSTParm) == 0x000370, "Member 'UHoudiniHandleComponent::RSTParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RotOrderParm) == 0x000378, "Member 'UHoudiniHandleComponent::RotOrderParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleType) == 0x000380, "Member 'UHoudiniHandleComponent::HandleType' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleName) == 0x000388, "Member 'UHoudiniHandleComponent::HandleName' has a wrong offset!");
...
public:
	...
	bool                                          bLandscapeAutoSelectSplines;                       // 0x024A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	bool                                          bLandscapeSplinesExportControlPoints;              // 0x024C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bLandscapeSplinesExportLeftRightCurves;            // 0x024D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bLandscapeSplinesExportSplineMeshComponents;       // 0x024E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bMergeSplineMeshComponents;                        // 0x024F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	EHoudiniInputObjectType                       Type;                                              // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  Guid;                                              // 0x0064(0x0010)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0xA4];                                      // 0x0074(0x00A4)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bHasChanged;                                       // 0x0118(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bNeedsToTriggerUpdate;                             // 0x0119(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bTransformChanged;                                 // 0x011A(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_11B[0x5];                                      // 0x011B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         MaterialReferences;                                // 0x0120(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FHoudiniInputObjectSettings            CachedInputSettings;                               // 0x0130(0x0020)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bCanDeleteHoudiniNodes;                            // 0x0150(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bInputNodeHandleOverridesNodeIds;                  // 0x0151(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_152[0xE];                                      // 0x0152(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x0160(0x0060)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         InputNodeId;                                       // 0x01C0(0x0004)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         InputObjectNodeId;                                 // 0x01C4(0x0004)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UHoudiniInputObject, Type) == 0x000060, "Member 'UHoudiniInputObject::Type' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, Guid) == 0x000064, "Member 'UHoudiniInputObject::Guid' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bHasChanged) == 0x000118, "Member 'UHoudiniInputObject::bHasChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bNeedsToTriggerUpdate) == 0x000119, "Member 'UHoudiniInputObject::bNeedsToTriggerUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bTransformChanged) == 0x00011A, "Member 'UHoudiniInputObject::bTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, MaterialReferences) == 0x000120, "Member 'UHoudiniInputObject::MaterialReferences' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, CachedInputSettings) == 0x000130, "Member 'UHoudiniInputObject::CachedInputSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bCanDeleteHoudiniNodes) == 0x000150, "Member 'UHoudiniInputObject::bCanDeleteHoudiniNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bInputNodeHandleOverridesNodeIds) == 0x000151, "Member 'UHoudiniInputObject::bInputNodeHandleOverridesNodeIds' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, Transform) == 0x000160, "Member 'UHoudiniInputObject::Transform' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, InputNodeId) == 0x0001C0, "Member 'UHoudiniInputObject::InputNodeId' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, InputObjectNodeId) == 0x0001C4, "Member 'UHoudiniInputObject::InputObjectNodeId' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UStaticMesh>             StaticMesh;                                        // 0x0238(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputMeshComponent) == 0x000270, "Wrong size on UHoudiniInputMeshComponent");
...
{
public:
	TArray<struct FTransform>                     InstanceTransforms;                                // 0x0268(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputInstancedMeshComponent) == 0x000280, "Wrong size on UHoudiniInputInstancedMeshComponent");
static_assert(offsetof(UHoudiniInputInstancedMeshComponent, InstanceTransforms) == 0x000268, "Member 'UHoudiniInputInstancedMeshComponent::InstanceTransforms' has a wrong offset!");
...
{
public:
	EHoudiniCurveType                             CurveType;                                         // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveMethod                           CurveMethod;                                       // 0x01C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Reversed;                                          // 0x01CA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1CB[0x5];                                      // 0x01CB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UHoudiniSplineComponent*                CachedComponent;                                   // 0x01D0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveType) == 0x0001C8, "Member 'UHoudiniInputHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveMethod) == 0x0001C9, "Member 'UHoudiniInputHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, Reversed) == 0x0001CA, "Member 'UHoudiniInputHoudiniSplineComponent::Reversed' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CachedComponent) == 0x0001D0, "Member 'UHoudiniInputHoudiniSplineComponent::CachedComponent' has a wrong offset!");
...
{
public:
	int32                                         AssetOutputIndex;                                  // 0x01C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AssetId;                                           // 0x01CC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputHoudiniAsset) == 0x0001D0, "Wrong size on UHoudiniInputHoudiniAsset");
static_assert(offsetof(UHoudiniInputHoudiniAsset, AssetOutputIndex) == 0x0001C8, "Member 'UHoudiniInputHoudiniAsset::AssetOutputIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniAsset, AssetId) == 0x0001CC, "Member 'UHoudiniInputHoudiniAsset::AssetId' has a wrong offset!");
...
{
public:
	int32                                         SplinesMeshObjectNodeId;                           // 0x01C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SplinesMeshNodeId;                                 // 0x01CC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D0[0xA0];                                     // 0x01D0(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UHoudiniInputSceneComponent*>    ActorComponents;                                   // 0x0270(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TSet<TSoftObjectPtr<class UObject>>           ActorSceneComponents;                              // 0x0280(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsAdded;                      // 0x02D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsRemoved;                    // 0x02D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumSplineMeshComponents;                           // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGuid                                  GeneratedSplinesMeshPackageGuid;                   // 0x02DC(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2EC[0x4];                                      // 0x02EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMesh*                            GeneratedSplinesMesh;                              // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUsedMergeSplinesMeshAtLastTranslate;              // 0x02F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputActor) == 0x000300, "Wrong size on UHoudiniInputActor");
static_assert(offsetof(UHoudiniInputActor, SplinesMeshObjectNodeId) == 0x0001C8, "Member 'UHoudiniInputActor::SplinesMeshObjectNodeId' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, SplinesMeshNodeId) == 0x0001CC, "Member 'UHoudiniInputActor::SplinesMeshNodeId' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, ActorComponents) == 0x000270, "Member 'UHoudiniInputActor::ActorComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, ActorSceneComponents) == 0x000280, "Member 'UHoudiniInputActor::ActorSceneComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsAdded) == 0x0002D0, "Member 'UHoudiniInputActor::LastUpdateNumComponentsAdded' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsRemoved) == 0x0002D4, "Member 'UHoudiniInputActor::LastUpdateNumComponentsRemoved' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, NumSplineMeshComponents) == 0x0002D8, "Member 'UHoudiniInputActor::NumSplineMeshComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, GeneratedSplinesMeshPackageGuid) == 0x0002DC, "Member 'UHoudiniInputActor::GeneratedSplinesMeshPackageGuid' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, GeneratedSplinesMesh) == 0x0002F0, "Member 'UHoudiniInputActor::GeneratedSplinesMesh' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, bUsedMergeSplinesMeshAtLastTranslate) == 0x0002F8, "Member 'UHoudiniInputActor::bUsedMergeSplinesMeshAtLastTranslate' has a wrong offset!");
...
{
public:
	TMap<TSoftObjectPtr<class AActor>, class UHoudiniInputObject*> TrackedActorObjects;              // 0x0300(0x0050)(NativeAccessSpecifierPrivate)
	int32                                         NumActorsAddedLastUpdate;                          // 0x0350(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NumActorsRemovedLastUpdate;                        // 0x0354(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UHoudiniInputLevelInstance, TrackedActorObjects) == 0x000300, "Member 'UHoudiniInputLevelInstance::TrackedActorObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInputLevelInstance, NumActorsAddedLastUpdate) == 0x000350, "Member 'UHoudiniInputLevelInstance::NumActorsAddedLastUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniInputLevelInstance, NumActorsRemovedLastUpdate) == 0x000354, "Member 'UHoudiniInputLevelInstance::NumActorsRemovedLastUpdate' has a wrong offset!");
...
{
public:
	int32                                         CachedNumLandscapeComponents;                      // 0x0300(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UHoudiniInputLandscape, CachedNumLandscapeComponents) == 0x000300, "Member 'UHoudiniInputLandscape::CachedNumLandscapeComponents' has a wrong offset!");
...
{
public:
	TArray<struct FHoudiniBrushInfo>              BrushesInfo;                                       // 0x0300(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UModel*                                 CombinedModel;                                     // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIgnoreInputObject;                                // 0x0318(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EBrushType                                    CachedInputBrushType;                              // 0x0319(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputBrush) == 0x000320, "Wrong size on UHoudiniInputBrush");
static_assert(offsetof(UHoudiniInputBrush, BrushesInfo) == 0x000300, "Member 'UHoudiniInputBrush::BrushesInfo' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CombinedModel) == 0x000310, "Member 'UHoudiniInputBrush::CombinedModel' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, bIgnoreInputObject) == 0x000318, "Member 'UHoudiniInputBrush::bIgnoreInputObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CachedInputBrushType) == 0x000319, "Member 'UHoudiniInputBrush::CachedInputBrushType' has a wrong offset!");
...
{
public:
	TArray<class UHoudiniInputSceneComponent*>    BPComponents;                                      // 0x01C8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TSet<TSoftObjectPtr<class UObject>>           BPSceneComponents;                                 // 0x01D8(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsAdded;                      // 0x0228(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsRemoved;                    // 0x022C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputBlueprint) == 0x000230, "Wrong size on UHoudiniInputBlueprint");
static_assert(offsetof(UHoudiniInputBlueprint, BPComponents) == 0x0001C8, "Member 'UHoudiniInputBlueprint::BPComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, BPSceneComponents) == 0x0001D8, "Member 'UHoudiniInputBlueprint::BPSceneComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, LastUpdateNumComponentsAdded) == 0x000228, "Member 'UHoudiniInputBlueprint::LastUpdateNumComponentsAdded' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, LastUpdateNumComponentsRemoved) == 0x00022C, "Member 'UHoudiniInputBlueprint::LastUpdateNumComponentsRemoved' has a wrong offset!");
...
{
public:
	class UHoudiniInputBlueprint*                 BlueprintInputObject;                              // 0x0300(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UHoudiniInputPackedLevelActor, BlueprintInputObject) == 0x000300, "Member 'UHoudiniInputPackedLevelActor::BlueprintInputObject' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputLandscapeSplineActor) == 0x000300, "Wrong size on UHoudiniInputLandscapeSplineActor");
...
{
public:
	struct FGuid                                  MeshPackageGuid;                                   // 0x0268(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UStaticMesh*                            GeneratedMesh;                                     // 0x0278(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ESplineMeshAxis                               CachedForwardAxis;                                 // 0x0280(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSplineMeshParams                      CachedSplineParams;                                // 0x0288(0x00B0)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FVector                                CachedSplineUpDir;                                 // 0x0338(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CachedSplineBoundaryMax;                           // 0x0350(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CachedSplineBoundaryMin;                           // 0x0354(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         CachedbSmoothInterpRollScale : 1;                  // 0x0358(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(offsetof(UHoudiniInputSplineMeshComponent, MeshPackageGuid) == 0x000268, "Member 'UHoudiniInputSplineMeshComponent::MeshPackageGuid' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, GeneratedMesh) == 0x000278, "Member 'UHoudiniInputSplineMeshComponent::GeneratedMesh' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, CachedForwardAxis) == 0x000280, "Member 'UHoudiniInputSplineMeshComponent::CachedForwardAxis' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, CachedSplineParams) == 0x000288, "Member 'UHoudiniInputSplineMeshComponent::CachedSplineParams' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, CachedSplineUpDir) == 0x000338, "Member 'UHoudiniInputSplineMeshComponent::CachedSplineUpDir' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, CachedSplineBoundaryMax) == 0x000350, "Member 'UHoudiniInputSplineMeshComponent::CachedSplineBoundaryMax' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineMeshComponent, CachedSplineBoundaryMin) == 0x000354, "Member 'UHoudiniInputSplineMeshComponent::CachedSplineBoundaryMin' has a wrong offset!");
...
{
public:
	class UObject*                                InstancedObject;                                   // 0x0360(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class AActor*>                         InstancedActors;                                   // 0x0368(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniInstancedActorComponent) == 0x000380, "Wrong size on UHoudiniInstancedActorComponent");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedObject) == 0x000360, "Member 'UHoudiniInstancedActorComponent::InstancedObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedActors) == 0x000368, "Member 'UHoudiniInstancedActorComponent::InstancedActors' has a wrong offset!");
...
{
public:
	TArray<class UStaticMeshComponent*>           Instances;                                         // 0x0360(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UMaterialInterface*>             OverrideMaterials;                                 // 0x0370(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
	class UStaticMesh*                            InstancedMesh;                                     // 0x0380(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent) == 0x000390, "Wrong size on UHoudiniMeshSplitInstancerComponent");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, Instances) == 0x000360, "Member 'UHoudiniMeshSplitInstancerComponent::Instances' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, OverrideMaterials) == 0x000370, "Member 'UHoudiniMeshSplitInstancerComponent::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, InstancedMesh) == 0x000380, "Member 'UHoudiniMeshSplitInstancerComponent::InstancedMesh' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   EditLayerName;                                     // 0x0064(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniLandscapeSplinesOutput) == 0x0000C0, "Wrong size on UHoudiniLandscapeSplinesOutput");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, Landscape) == 0x000030, "Member 'UHoudiniLandscapeSplinesOutput::Landscape' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, LandscapeProxy) == 0x000038, "Member 'UHoudiniLandscapeSplinesOutput::LandscapeProxy' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, LandscapeSplineActor) == 0x000040, "Member 'UHoudiniLandscapeSplinesOutput::LandscapeSplineActor' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, LandscapeSplinesComponent) == 0x000048, "Member 'UHoudiniLandscapeSplinesOutput::LandscapeSplinesComponent' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, LayerOutputs) == 0x000050, "Member 'UHoudiniLandscapeSplinesOutput::LayerOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, Segments) == 0x0000A0, "Member 'UHoudiniLandscapeSplinesOutput::Segments' has a wrong offset!");
static_assert(offsetof(UHoudiniLandscapeSplinesOutput, ControlPoints) == 0x0000B0, "Member 'UHoudiniLandscapeSplinesOutput::ControlPoints' has a wrong offset!");
...
public:
	...
	TMap<class FString, class UMaterialInterface*> AssignementMaterials;                             // 0x00E8(0x0050)(Deprecated, Protected, NativeAccessSpecifierProtected)
	TMap<struct FHoudiniMaterialIdentifier, class UMaterialInterface*> AssignmentMaterialsById;      // 0x0138(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<class FString, class UMaterialInterface*> ReplacementMaterials;                             // 0x0188(0x0050)(Deprecated, Protected, NativeAccessSpecifierProtected)
	TMap<struct FHoudiniMaterialIdentifier, class UMaterialInterface*> ReplacementMaterialsById;     // 0x01D8(0x0050)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_228[0x4];                                      // 0x0228(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLandscapeWorldComposition;                        // 0x022C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_22D[0x3];                                      // 0x022D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         HoudiniCreatedSocketActors;                        // 0x0230(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class AActor*>                         HoudiniAttachedSocketActors;                       // 0x0240(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bIsEditableNode;                                   // 0x0250(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHasEditableNodeBuilt;                             // 0x0251(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsUpdating;                                       // 0x0252(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanDeleteHoudiniNodes;                            // 0x0253(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniOutput) == 0x000258, "Wrong size on UHoudiniOutput");
...
static_assert(offsetof(UHoudiniOutput, AssignmentMaterialsById) == 0x000138, "Member 'UHoudiniOutput::AssignmentMaterialsById' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, ReplacementMaterials) == 0x000188, "Member 'UHoudiniOutput::ReplacementMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, ReplacementMaterialsById) == 0x0001D8, "Member 'UHoudiniOutput::ReplacementMaterialsById' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, bLandscapeWorldComposition) == 0x00022C, "Member 'UHoudiniOutput::bLandscapeWorldComposition' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, HoudiniCreatedSocketActors) == 0x000230, "Member 'UHoudiniOutput::HoudiniCreatedSocketActors' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, HoudiniAttachedSocketActors) == 0x000240, "Member 'UHoudiniOutput::HoudiniAttachedSocketActors' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, bIsEditableNode) == 0x000250, "Member 'UHoudiniOutput::bIsEditableNode' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, bHasEditableNodeBuilt) == 0x000251, "Member 'UHoudiniOutput::bHasEditableNodeBuilt' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, bIsUpdating) == 0x000252, "Member 'UHoudiniOutput::bIsUpdating' has a wrong offset!");
static_assert(offsetof(UHoudiniOutput, bCanDeleteHoudiniNodes) == 0x000253, "Member 'UHoudiniOutput::bCanDeleteHoudiniNodes' has a wrong offset!");
...
public:
	...
	TSet<class FString>                           ClearedLandscapeLayers;                            // 0x0088(0x0050)(Deprecated, NativeAccessSpecifierPublic)
	struct FHoudiniClearedEditLayers              ClearedLayers;                                     // 0x00D8(0x0050)(NativeAccessSpecifierPublic)
	bool                                          bShow;                                             // 0x0128(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_129[0x7];                                      // 0x0129(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FString, struct FHoudiniPDGWorkResultObjectBakedOutput> BakedWorkResultObjectOutputs; // 0x0130(0x0050)(Protected, NativeAccessSpecifierProtected)
	struct FWorkItemTally                         WorkItemTally;                                     // 0x0180(0x0238)(Transient, NonTransactional, Protected, NativeAccessSpecifierProtected)
	struct FAggregatedWorkItemTally               AggregatedWorkItemTally;                           // 0x03B8(0x0028)(Transient, NonTransactional, Protected, NativeAccessSpecifierProtected)
	bool                                          bHasReceivedCookCompleteEvent;                     // 0x03E0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NonTransactional, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3E1[0x7];                                      // 0x03E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOutputActorOwner                      OutputActorOwner;                                  // 0x03E8(0x0010)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTOPNode) == 0x0003F8, "Wrong size on UTOPNode");
...
static_assert(offsetof(UTOPNode, ClearedLayers) == 0x0000D8, "Member 'UTOPNode::ClearedLayers' has a wrong offset!");
static_assert(offsetof(UTOPNode, bShow) == 0x000128, "Member 'UTOPNode::bShow' has a wrong offset!");
static_assert(offsetof(UTOPNode, BakedWorkResultObjectOutputs) == 0x000130, "Member 'UTOPNode::BakedWorkResultObjectOutputs' has a wrong offset!");
static_assert(offsetof(UTOPNode, WorkItemTally) == 0x000180, "Member 'UTOPNode::WorkItemTally' has a wrong offset!");
static_assert(offsetof(UTOPNode, AggregatedWorkItemTally) == 0x0003B8, "Member 'UTOPNode::AggregatedWorkItemTally' has a wrong offset!");
static_assert(offsetof(UTOPNode, bHasReceivedCookCompleteEvent) == 0x0003E0, "Member 'UTOPNode::bHasReceivedCookCompleteEvent' has a wrong offset!");
static_assert(offsetof(UTOPNode, OutputActorOwner) == 0x0003E8, "Member 'UTOPNode::OutputActorOwner' has a wrong offset!");
...
static_assert(sizeof(UHoudiniPDGAssetLink) == 0x000140, "Wrong size on UHoudiniPDGAssetLink");
...
static_assert(offsetof(UHoudiniPDGAssetLink, NumAttemptedNodeAutoBakes) == 0x000138, "Member 'UHoudiniPDGAssetLink::NumAttemptedNodeAutoBakes' has a wrong offset!");
static_assert(offsetof(UHoudiniPDGAssetLink, NumSuccessfulNodeAutoBakes) == 0x00013C, "Member 'UHoudiniPDGAssetLink::NumSuccessfulNodeAutoBakes' has a wrong offset!");
...
public:
	...
	struct FBodyInstance                          DefaultBodyInstance;                               // 0x00C8(0x0190)(Edit, Config, GlobalConfig, NativeAccessSpecifierPublic)
	...
	bool                                          bEnableBackwardCompatibility;                      // 0x02BE(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutomaticLegacyHDARebuild;                        // 0x02BF(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FDirectoryPath                         CustomHoudiniLocation;                             // 0x02C8(0x0010)(Edit, ZeroConstructor, Config, EditConst, GlobalConfig, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniRuntimeSettings) == 0x000348, "Wrong size on UHoudiniRuntimeSettings");
...
static_assert(offsetof(UHoudiniRuntimeSettings, bEnableBackwardCompatibility) == 0x0002BE, "Member 'UHoudiniRuntimeSettings::bEnableBackwardCompatibility' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, bAutomaticLegacyHDARebuild) == 0x0002BF, "Member 'UHoudiniRuntimeSettings::bAutomaticLegacyHDARebuild' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, bUseCustomHoudiniLocation) == 0x0002C0, "Member 'UHoudiniRuntimeSettings::bUseCustomHoudiniLocation' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, CustomHoudiniLocation) == 0x0002C8, "Member 'UHoudiniRuntimeSettings::CustomHoudiniLocation' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, HoudiniExecutable) == 0x0002D8, "Member 'UHoudiniRuntimeSettings::HoudiniExecutable' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, CustomHoudiniHomeLocation) == 0x0002E0, "Member 'UHoudiniRuntimeSettings::CustomHoudiniHomeLocation' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, CookingThreadStackSize) == 0x0002F0, "Member 'UHoudiniRuntimeSettings::CookingThreadStackSize' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, HoudiniEnvironmentFiles) == 0x0002F8, "Member 'UHoudiniRuntimeSettings::HoudiniEnvironmentFiles' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, OtlSearchPath) == 0x000308, "Member 'UHoudiniRuntimeSettings::OtlSearchPath' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, DsoSearchPath) == 0x000318, "Member 'UHoudiniRuntimeSettings::DsoSearchPath' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, ImageDsoSearchPath) == 0x000328, "Member 'UHoudiniRuntimeSettings::ImageDsoSearchPath' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, AudioDsoSearchPath) == 0x000338, "Member 'UHoudiniRuntimeSettings::AudioDsoSearchPath' has a wrong offset!");
...
public:
	...
	TArray<struct FTransform>                     CurvePoints;                                       // 0x0368(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVector3d>                      DisplayPoints;                                     // 0x0378(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 DisplayPointIndexDivider;                          // 0x0388(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 HoudiniSplineName;                                 // 0x0398(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClosed;                                           // 0x03A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bReversed;                                         // 0x03A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3AA[0x2];                                      // 0x03AA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CurveOrder;                                        // 0x03AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsHoudiniSplineVisible;                           // 0x03B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveType                             CurveType;                                         // 0x03B1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveMethod                           CurveMethod;                                       // 0x03B2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveBreakpointParameterization       CurveBreakpointParameterization;                   // 0x03B3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsOutputCurve;                                    // 0x03B4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnCurveChanged;                               // 0x03B5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLegacyInputCurve;                               // 0x03B6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B7[0x2B9];                                    // 0x03B7(0x02B9)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bHasChanged;                                       // 0x0670(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bNeedsToTriggerUpdate;                             // 0x0671(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsInputCurve;                                     // 0x0672(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsEditableOutputCurve;                            // 0x0673(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NodeID;                                            // 0x0674(0x0004)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 PartName;                                          // 0x0678(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniSplineComponent) == 0x000690, "Wrong size on UHoudiniSplineComponent");
static_assert(offsetof(UHoudiniSplineComponent, CurvePoints) == 0x000368, "Member 'UHoudiniSplineComponent::CurvePoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPoints) == 0x000378, "Member 'UHoudiniSplineComponent::DisplayPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPointIndexDivider) == 0x000388, "Member 'UHoudiniSplineComponent::DisplayPointIndexDivider' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, HoudiniSplineName) == 0x000398, "Member 'UHoudiniSplineComponent::HoudiniSplineName' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bClosed) == 0x0003A8, "Member 'UHoudiniSplineComponent::bClosed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bReversed) == 0x0003A9, "Member 'UHoudiniSplineComponent::bReversed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveOrder) == 0x0003AC, "Member 'UHoudiniSplineComponent::CurveOrder' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsHoudiniSplineVisible) == 0x0003B0, "Member 'UHoudiniSplineComponent::bIsHoudiniSplineVisible' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveType) == 0x0003B1, "Member 'UHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveMethod) == 0x0003B2, "Member 'UHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveBreakpointParameterization) == 0x0003B3, "Member 'UHoudiniSplineComponent::CurveBreakpointParameterization' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsOutputCurve) == 0x0003B4, "Member 'UHoudiniSplineComponent::bIsOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bCookOnCurveChanged) == 0x0003B5, "Member 'UHoudiniSplineComponent::bCookOnCurveChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsLegacyInputCurve) == 0x0003B6, "Member 'UHoudiniSplineComponent::bIsLegacyInputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bHasChanged) == 0x000670, "Member 'UHoudiniSplineComponent::bHasChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bNeedsToTriggerUpdate) == 0x000671, "Member 'UHoudiniSplineComponent::bNeedsToTriggerUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsInputCurve) == 0x000672, "Member 'UHoudiniSplineComponent::bIsInputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsEditableOutputCurve) == 0x000673, "Member 'UHoudiniSplineComponent::bIsEditableOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, NodeID) == 0x000674, "Member 'UHoudiniSplineComponent::NodeID' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, PartName) == 0x000678, "Member 'UHoudiniSplineComponent::PartName' has a wrong offset!");
...
{
public:
	class UHoudiniStaticMesh*                     Mesh;                                              // 0x0668(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FBox                                   LocalBounds;                                       // 0x0670(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bHoudiniIconVisible;                               // 0x06A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniStaticMeshComponent) == 0x0006B0, "Wrong size on UHoudiniStaticMeshComponent");
static_assert(offsetof(UHoudiniStaticMeshComponent, Mesh) == 0x000668, "Member 'UHoudiniStaticMeshComponent::Mesh' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, LocalBounds) == 0x000670, "Member 'UHoudiniStaticMeshComponent::LocalBounds' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, bHoudiniIconVisible) == 0x0006A8, "Member 'UHoudiniStaticMeshComponent::bHoudiniIconVisible' has a wrong offset!");
