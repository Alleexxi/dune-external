...
{
public:
	uint8                                         Pad_30[0x2F8];                                     // 0x0030(0x02F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshDescriptionBase) == 0x000328, "Wrong size on UMeshDescriptionBase");
