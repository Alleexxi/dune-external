...
{
public:
	uint8                                         Pad_0[0x5C];                                       // 0x0000(0x005C)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ArrayReplicationKey;                               // 0x005C(0x0004)(ZeroConstructor, SubobjectReference, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0xAC];                                      // 0x0060(0x00AC)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FFastArraySerializer) == 0x000128, "Wrong size on FFastArraySerializer");
static_assert(offsetof(FFastArraySerializer, ArrayReplicationKey) == 0x00005C, "Member 'FFastArraySerializer::ArrayReplicationKey' has a wrong offset!");
