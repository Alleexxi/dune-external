...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0BE2DA20;
	constexpr int32 AppendString      = 0x052F24A0;
	constexpr int32 GNames            = 0x0BD62700;
	constexpr int32 GWorld            = 0x0BCB2CE0;
	constexpr int32 ProcessEvent      = 0x054CA9B0;
