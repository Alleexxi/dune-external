...
public:
	...
	struct FSoftObjectPath                        ServerInitialMap;                                  // 0x00C8(0x0020)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FSoftClassPath                         GlobalEditorDefaultGameMode;                       // 0x0108(0x0020)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultServerGameMode;                       // 0x0128(0x0020)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FGameModeName>                  GameModeMapPrefixes;                               // 0x0148(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<struct FGameModeName>                  GameModeClassAliases;                              // 0x0158(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameMapsSettings) == 0x000168, "Wrong size on UGameMapsSettings");
...
static_assert(offsetof(UGameMapsSettings, ServerInitialMap) == 0x0000C8, "Member 'UGameMapsSettings::ServerInitialMap' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, GlobalEditorDefaultGameMode) == 0x000108, "Member 'UGameMapsSettings::GlobalEditorDefaultGameMode' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GlobalDefaultServerGameMode) == 0x000128, "Member 'UGameMapsSettings::GlobalDefaultServerGameMode' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x000148, "Member 'UGameMapsSettings::GameModeMapPrefixes' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x000158, "Member 'UGameMapsSettings::GameModeClassAliases' has a wrong offset!");
