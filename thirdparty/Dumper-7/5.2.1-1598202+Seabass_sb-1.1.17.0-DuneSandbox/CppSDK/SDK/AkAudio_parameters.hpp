...
// Function AkAudio.AkAudioEvent.IsDebugEnabled
// 0x0001 (0x0001 - 0x0000)
struct AkAudioEvent_IsDebugEnabled final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkAudioEvent_IsDebugEnabled) == 0x000001, "Wrong alignment on AkAudioEvent_IsDebugEnabled");
static_assert(sizeof(AkAudioEvent_IsDebugEnabled) == 0x000001, "Wrong size on AkAudioEvent_IsDebugEnabled");
static_assert(offsetof(AkAudioEvent_IsDebugEnabled, ReturnValue) == 0x000000, "Member 'AkAudioEvent_IsDebugEnabled::ReturnValue' has a wrong offset!");
