...
{
public:
	struct FCreateMeshObjectParams                CreateMeshParams;                                  // 0x0000(0x0630)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FCreateMeshObjectResult                ReturnValue;                                       // 0x0630(0x0020)(Parm, OutParm, ReturnParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(ModelingObjectsCreationAPI_CreateMeshObject) == 0x000650, "Wrong size on ModelingObjectsCreationAPI_CreateMeshObject");
...
static_assert(offsetof(ModelingObjectsCreationAPI_CreateMeshObject, ReturnValue) == 0x000630, "Member 'ModelingObjectsCreationAPI_CreateMeshObject::ReturnValue' has a wrong offset!");
