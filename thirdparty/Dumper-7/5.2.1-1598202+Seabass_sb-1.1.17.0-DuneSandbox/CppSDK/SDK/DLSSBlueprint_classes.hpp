...
public:
	...
	static float GetDLSSDefaultModePercentage(EUDLSSMode DLSSMode);
	...
	static void UpdateResolutionMetrics(EUDLSSMode QualityMode, float TargetPercentage, const struct FIntPoint& Resolution);
