...
void ALandscapeProxy::SetLandscapeMaterialRuntimeVirtualTextureParameterValue(class FName ParameterName, class URuntimeVirtualTexture* Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "SetLandscapeMaterialRuntimeVirtualTextureParameterValue");

	Params::LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   InRuntimeVirtualTextureRenderPriority                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ALandscapeProxy::SetRuntimeVirtualTextureRenderPriority(int32 InRuntimeVirtualTextureRenderPriority)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "SetRuntimeVirtualTextureRenderPriority");

	Params::LandscapeProxy_SetRuntimeVirtualTextureRenderPriority Parms{};

	Parms.InRuntimeVirtualTextureRenderPriority = InRuntimeVirtualTextureRenderPriority;
...
int32 ALandscapeProxy::GetRuntimeVirtualTextureRenderPriority() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "GetRuntimeVirtualTextureRenderPriority");

	Params::LandscapeProxy_GetRuntimeVirtualTextureRenderPriority Parms{};
