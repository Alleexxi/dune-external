...
{
public:
	struct FGroomCacheImportSettings              ImportSettings;                                    // 0x0030(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGroomCacheImportOptions) == 0x000098, "Wrong size on UGroomCacheImportOptions");
...
{
public:
	struct FGroomCacheImportSettings              Settings;                                          // 0x0030(0x0068)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGroomCacheImportData) == 0x000098, "Wrong size on UGroomCacheImportData");
...
{
public:
	class UGroomComponent*                        GroomComponent;                                    // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGroomActor) == 0x000358, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x000350, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
...
public:
	...
	class USkeletalMesh*                          RiggedSkeletalMesh;                                // 0x00D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 DeformedGroupSections;                             // 0x00D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        MinLOD;                                            // 0x00E8(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformBool                       DisableBelowMinLodStripping;                       // 0x00EC(0x0001)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	uint8                                         Pad_ED[0x3];                                       // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 EffectiveLODBias;                                  // 0x00F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGroomAsset, RiggedSkeletalMesh) == 0x0000D0, "Member 'UGroomAsset::RiggedSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UGroomAsset, DeformedGroupSections) == 0x0000D8, "Member 'UGroomAsset::DeformedGroupSections' has a wrong offset!");
static_assert(offsetof(UGroomAsset, MinLOD) == 0x0000E8, "Member 'UGroomAsset::MinLOD' has a wrong offset!");
static_assert(offsetof(UGroomAsset, DisableBelowMinLodStripping) == 0x0000EC, "Member 'UGroomAsset::DisableBelowMinLodStripping' has a wrong offset!");
static_assert(offsetof(UGroomAsset, EffectiveLODBias) == 0x0000F0, "Member 'UGroomAsset::EffectiveLODBias' has a wrong offset!");
...
public:
	...
	class UGroomAsset*                            Groom;                                             // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, AssetRegistrySearchable, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SourceSkeletalMesh;                                // 0x0040(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UGeometryCache*                         SourceGeometryCache;                               // 0x0050(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGeometryCache*                         TargetGeometryCache;                               // 0x0058(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FGroomCacheInfo                        GroomCacheInfo;                                    // 0x0044(0x0028)(Edit, EditConst, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGroomCache) == 0x000080, "Wrong size on UGroomCache");
static_assert(offsetof(UGroomCache, GroomCacheInfo) == 0x000044, "Member 'UGroomCache::GroomCacheInfo' has a wrong offset!");

// Class HairStrandsCore.GroomComponent
// 0x0250 (0x08C0 - 0x0670)
...
public:
	...
	class UGroomAsset*                            GroomAsset;                                        // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomCache*                            GroomCache;                                        // 0x0680(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UNiagaraComponent*>              NiagaraComponents;                                 // 0x0688(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SourceSkeletalMesh;                                // 0x0698(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomBindingAsset*                     BindingAsset;                                      // 0x06A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPhysicsAsset*                          PhysicsAsset;                                      // 0x06A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6B0[0x10];                                     // 0x06B0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHairSimulationSettings                SimulationSettings;                                // 0x06C0(0x0090)(Edit, BlueprintVisible, Interp, NativeAccessSpecifierPublic)
	class UMeshDeformer*                          MeshDeformer;                                      // 0x0750(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstance*                  MeshDeformerInstance;                              // 0x0758(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstanceSettings*          MeshDeformerInstanceSettings;                      // 0x0760(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DebugMaterial;                             // 0x0768(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DefaultMaterial;                           // 0x0770(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Cards_DefaultMaterial;                             // 0x0778(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Meshes_DefaultMaterial;                            // 0x0780(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         AngularSpringsSystem;                              // 0x0788(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         CosseratRodsSystem;                                // 0x0790(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttachmentName;                                    // 0x0798(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7A8[0x88];                                     // 0x07A8(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FHairGroupDesc>                 GroomGroupsDesc;                                   // 0x0830(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bUseCards;                                         // 0x0840(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRunning;                                          // 0x0841(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x0842(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bManualTick;                                       // 0x0843(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ElapsedTime;                                       // 0x0844(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGroomComponent) == 0x0008C0, "Wrong size on UGroomComponent");
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x000678, "Member 'UGroomComponent::GroomAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomCache) == 0x000680, "Member 'UGroomComponent::GroomCache' has a wrong offset!");
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x000688, "Member 'UGroomComponent::NiagaraComponents' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x000698, "Member 'UGroomComponent::SourceSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x0006A0, "Member 'UGroomComponent::BindingAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x0006A8, "Member 'UGroomComponent::PhysicsAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SimulationSettings) == 0x0006C0, "Member 'UGroomComponent::SimulationSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformer) == 0x000750, "Member 'UGroomComponent::MeshDeformer' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstance) == 0x000758, "Member 'UGroomComponent::MeshDeformerInstance' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstanceSettings) == 0x000760, "Member 'UGroomComponent::MeshDeformerInstanceSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x000768, "Member 'UGroomComponent::Strands_DebugMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x000770, "Member 'UGroomComponent::Strands_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x000778, "Member 'UGroomComponent::Cards_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x000780, "Member 'UGroomComponent::Meshes_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x000788, "Member 'UGroomComponent::AngularSpringsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x000790, "Member 'UGroomComponent::CosseratRodsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x000798, "Member 'UGroomComponent::AttachmentName' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x000830, "Member 'UGroomComponent::GroomGroupsDesc' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bUseCards) == 0x000840, "Member 'UGroomComponent::bUseCards' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bRunning) == 0x000841, "Member 'UGroomComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bLooping) == 0x000842, "Member 'UGroomComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bManualTick) == 0x000843, "Member 'UGroomComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGroomComponent, ElapsedTime) == 0x000844, "Member 'UGroomComponent::ElapsedTime' has a wrong offset!");
