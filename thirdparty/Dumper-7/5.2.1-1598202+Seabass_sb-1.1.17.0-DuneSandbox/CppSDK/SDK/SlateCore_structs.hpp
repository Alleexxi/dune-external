...
// ScriptStruct SlateCore.AsyncSlateBrush
// 0x00B0 (0x00B0 - 0x0000)
struct FAsyncSlateBrush final
{
public:
	TSoftObjectPtr<class UObject>                 ResourceAsset;                                     // 0x0000(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2f                              ImageSize;                                         // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            TintColor;                                         // 0x0038(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	ESlateBrushDrawType                           DrawAs;                                            // 0x004C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                Margin;                                            // 0x0050(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateBrushOutlineSettings             OutlineSettings;                                   // 0x0060(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	ESlateBrushTileType                           tiling;                                            // 0x00A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          m_bOverrideImageSize;                              // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0xE];                                       // 0x00A2(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAsyncSlateBrush) == 0x000010, "Wrong alignment on FAsyncSlateBrush");
static_assert(sizeof(FAsyncSlateBrush) == 0x0000B0, "Wrong size on FAsyncSlateBrush");
static_assert(offsetof(FAsyncSlateBrush, ResourceAsset) == 0x000000, "Member 'FAsyncSlateBrush::ResourceAsset' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, ImageSize) == 0x000030, "Member 'FAsyncSlateBrush::ImageSize' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, TintColor) == 0x000038, "Member 'FAsyncSlateBrush::TintColor' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, DrawAs) == 0x00004C, "Member 'FAsyncSlateBrush::DrawAs' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, Margin) == 0x000050, "Member 'FAsyncSlateBrush::Margin' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, OutlineSettings) == 0x000060, "Member 'FAsyncSlateBrush::OutlineSettings' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, tiling) == 0x0000A0, "Member 'FAsyncSlateBrush::tiling' has a wrong offset!");
static_assert(offsetof(FAsyncSlateBrush, m_bOverrideImageSize) == 0x0000A1, "Member 'FAsyncSlateBrush::m_bOverrideImageSize' has a wrong offset!");
