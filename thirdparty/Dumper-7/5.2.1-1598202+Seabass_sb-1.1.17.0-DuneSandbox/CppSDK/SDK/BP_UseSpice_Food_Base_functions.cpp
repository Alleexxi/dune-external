...
#include "BP_UseSpice_Food_Base_parameters.hpp"
...
ECanUse UBP_UseSpice_Food_Base_C::BP_CanUse(const class AController* Instigator, const class AActor* Target) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_UseSpice_Food_Base_C", "BP_CanUse");

	Params::BP_UseSpice_Food_Base_C_BP_CanUse Parms{};
...
void UBP_UseSpice_Food_Base_C::GetSpicePerStack(double* SpicePerStack) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_UseSpice_Food_Base_C", "GetSpicePerStack");

	Params::BP_UseSpice_Food_Base_C_GetSpicePerStack Parms{};
