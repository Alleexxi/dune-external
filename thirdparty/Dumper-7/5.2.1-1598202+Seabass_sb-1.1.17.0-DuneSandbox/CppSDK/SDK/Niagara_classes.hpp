...
{
public:
	class FName                                   CompressionType;                                   // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNDIRenderTargetVolumeSimCacheFrame> Frames;                                       // 0x0038(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNDIRenderTargetVolumeSimCacheData) == 0x000048, "Wrong size on UNDIRenderTargetVolumeSimCacheData");
...
static_assert(offsetof(UNDIRenderTargetVolumeSimCacheData, Frames) == 0x000038, "Member 'UNDIRenderTargetVolumeSimCacheData::Frames' has a wrong offset!");
...
static_assert(sizeof(UNiagaraRendererProperties) == 0x0000E8, "Wrong size on UNiagaraRendererProperties");
...
static_assert(offsetof(UNiagaraRendererProperties, RendererEnabledBinding) == 0x000068, "Member 'UNiagaraRendererProperties::RendererEnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bIsEnabled) == 0x0000C0, "Member 'UNiagaraRendererProperties::bIsEnabled' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bAllowInCullProxies) == 0x0000C1, "Member 'UNiagaraRendererProperties::bAllowInCullProxies' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, OuterEmitterVersion) == 0x0000C4, "Member 'UNiagaraRendererProperties::OuterEmitterVersion' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bMotionBlurEnabled) == 0x0000D4, "Member 'UNiagaraRendererProperties::bMotionBlurEnabled' has a wrong offset!");
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x0009A0, "Wrong size on UNiagaraMeshRendererProperties");
static_assert(offsetof(UNiagaraMeshRendererProperties, Meshes) == 0x0000E8, "Member 'UNiagaraMeshRendererProperties::Meshes' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SourceMode) == 0x0000F8, "Member 'UNiagaraMeshRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SortMode) == 0x0000F9, "Member 'UNiagaraMeshRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SortPrecision) == 0x000100, "Member 'UNiagaraMeshRendererProperties::SortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, GpuTranslucentLatency) == 0x000101, "Member 'UNiagaraMeshRendererProperties::GpuTranslucentLatency' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, OverrideMaterials) == 0x000108, "Member 'UNiagaraMeshRendererProperties::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MICOverrideMaterials) == 0x000118, "Member 'UNiagaraMeshRendererProperties::MICOverrideMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageSize) == 0x000128, "Member 'UNiagaraMeshRendererProperties::SubImageSize' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x000140, "Member 'UNiagaraMeshRendererProperties::LockedAxis' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x000158, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshBoundsScale) == 0x000160, "Member 'UNiagaraMeshRendererProperties::MeshBoundsScale' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x000178, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x00017C, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x000180, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x000188, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, VelocityBinding) == 0x000238, "Member 'UNiagaraMeshRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshOrientationBinding) == 0x000290, "Member 'UNiagaraMeshRendererProperties::MeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x0002E8, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageIndexBinding) == 0x000340, "Member 'UNiagaraMeshRendererProperties::SubImageIndexBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial1Binding) == 0x0003F0, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x0004A0, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x0004F8, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x000550, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x0005A8, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x000600, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x000658, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x0006B0, "Member 'UNiagaraMeshRendererProperties::MeshIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameters) == 0x000708, "Member 'UNiagaraMeshRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevPositionBinding) == 0x000758, "Member 'UNiagaraMeshRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevScaleBinding) == 0x0007B0, "Member 'UNiagaraMeshRendererProperties::PrevScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevMeshOrientationBinding) == 0x000808, "Member 'UNiagaraMeshRendererProperties::PrevMeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevCameraOffsetBinding) == 0x000860, "Member 'UNiagaraMeshRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevVelocityBinding) == 0x0008B8, "Member 'UNiagaraMeshRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x000978, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x000980, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x000998, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
static_assert(sizeof(UNiagaraEmitter) == 0x0000C0, "Wrong size on UNiagaraEmitter");
...
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000078, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x000088, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x000098, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x0000A8, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x0000B0, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataChannelDefinitions) == 0x000040, "Wrong size on UNiagaraDataChannelDefinitions");
static_assert(offsetof(UNiagaraDataChannelDefinitions, DataChannels) == 0x000030, "Member 'UNiagaraDataChannelDefinitions::DataChannels' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataChannelHandler) == 0x000070, "Wrong size on UNiagaraDataChannelHandler");
...
static_assert(offsetof(UNiagaraDataChannelHandler, Writer) == 0x000060, "Member 'UNiagaraDataChannelHandler::Writer' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannelHandler, Reader) == 0x000068, "Member 'UNiagaraDataChannelHandler::Reader' has a wrong offset!");
...
{
public:
	class FName                                   ChannelName;                                       // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraVariable>               Variables;                                         // 0x0038(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	bool                                          bKeepPreviousFrameData;                            // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraDataSetCompiledData            CompiledData;                                      // 0x0050(0x0048)(NativeAccessSpecifierPrivate)
	struct FNiagaraDataSetCompiledData            CompiledDataGPU;                                   // 0x0098(0x0048)(NativeAccessSpecifierPrivate)
	struct FNiagaraDataChannelGameDataLayout      GameDataLayout;                                    // 0x00E0(0x0060)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraDataChannel) == 0x000140, "Wrong size on UNiagaraDataChannel");
static_assert(offsetof(UNiagaraDataChannel, ChannelName) == 0x000030, "Member 'UNiagaraDataChannel::ChannelName' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, Variables) == 0x000038, "Member 'UNiagaraDataChannel::Variables' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, bKeepPreviousFrameData) == 0x000048, "Member 'UNiagaraDataChannel::bKeepPreviousFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, CompiledData) == 0x000050, "Member 'UNiagaraDataChannel::CompiledData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, CompiledDataGPU) == 0x000098, "Member 'UNiagaraDataChannel::CompiledDataGPU' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, GameDataLayout) == 0x0000E0, "Member 'UNiagaraDataChannel::GameDataLayout' has a wrong offset!");
...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bDestroyOnSystemFinish : 1;                        // 0x0358(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(ANiagaraActor) == 0x000360, "Wrong size on ANiagaraActor");
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x000350, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
public:
	...
	struct FTransform                             DesiredRelativeTransform;                          // 0x0370(0x0060)(Edit, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BaseAuthoredFOV;                                   // 0x03D0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bAllowMultipleInstances : 1;                       // 0x03D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bResetWhenRetriggered : 1;                         // 0x03D4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_3D5[0x3];                                      // 0x03D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class AActor>>             EmittersToTreatAsSame;                             // 0x03D8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class APlayerCameraManager*                   OwningCameraManager;                               // 0x03E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANiagaraLensEffectBase) == 0x0003F0, "Wrong size on ANiagaraLensEffectBase");
static_assert(offsetof(ANiagaraLensEffectBase, DesiredRelativeTransform) == 0x000370, "Member 'ANiagaraLensEffectBase::DesiredRelativeTransform' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, BaseAuthoredFOV) == 0x0003D0, "Member 'ANiagaraLensEffectBase::BaseAuthoredFOV' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, EmittersToTreatAsSame) == 0x0003D8, "Member 'ANiagaraLensEffectBase::EmittersToTreatAsSame' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, OwningCameraManager) == 0x0003E8, "Member 'ANiagaraLensEffectBase::OwningCameraManager' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataChannel_Global) == 0x000140, "Wrong size on UNiagaraDataChannel_Global");
...
{
public:
	struct FNiagaraDataChannelReference           Channel;                                           // 0x0040(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bReadCurrentFrame;                                 // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraDataInterfaceDataChannelRead, bReadCurrentFrame) == 0x000048, "Member 'UNiagaraDataInterfaceDataChannelRead::bReadCurrentFrame' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceDataChannelRead, CompiledData) == 0x000050, "Member 'UNiagaraDataInterfaceDataChannelRead::CompiledData' has a wrong offset!");
...
{
public:
	class FName                                   Namespace;                                         // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FNiagaraVariable>               Parameters;                                        // 0x0038(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UMaterialParameterCollection*           SourceMaterialCollection;                          // 0x0048(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNiagaraParameterCollectionInstance*    DefaultInstance;                                   // 0x0050(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UNiagaraParameterCollection, Parameters) == 0x000038, "Member 'UNiagaraParameterCollection::Parameters' has a wrong offset!");
static_assert(offsetof(UNiagaraParameterCollection, SourceMaterialCollection) == 0x000048, "Member 'UNiagaraParameterCollection::SourceMaterialCollection' has a wrong offset!");
...
{
public:
	struct FNiagaraDataInterfaceEmitterBinding    EmitterBinding;                                    // 0x00B8(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bOverrideSpawnGroupToDataChannelIndex;             // 0x00C4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceDataChannelSpawn) == 0x0000C8, "Wrong size on UNiagaraDataInterfaceDataChannelSpawn");
static_assert(offsetof(UNiagaraDataInterfaceDataChannelSpawn, EmitterBinding) == 0x0000B8, "Member 'UNiagaraDataInterfaceDataChannelSpawn::EmitterBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceDataChannelSpawn, bOverrideSpawnGroupToDataChannelIndex) == 0x0000C4, "Member 'UNiagaraDataInterfaceDataChannelSpawn::bOverrideSpawnGroupToDataChannelIndex' has a wrong offset!");
...
public:
	...
	struct FNiagaraDataChannelReference           Channel;                                           // 0x004C(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceDataChannelWrite, Channel) == 0x00004C, "Member 'UNiagaraDataInterfaceDataChannelWrite::Channel' has a wrong offset!");
...
{
public:
	bool                                          bSystemsSupportLargeWorldCoordinates;              // 0x0040(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnforceStrictStackTypes;                          // 0x0041(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExperimentalVMEnabled;                            // 0x0042(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraSettings) == 0x000128, "Wrong size on UNiagaraSettings");
static_assert(offsetof(UNiagaraSettings, bSystemsSupportLargeWorldCoordinates) == 0x000040, "Member 'UNiagaraSettings::bSystemsSupportLargeWorldCoordinates' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, bEnforceStrictStackTypes) == 0x000041, "Member 'UNiagaraSettings::bEnforceStrictStackTypes' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, bExperimentalVMEnabled) == 0x000042, "Member 'UNiagaraSettings::bExperimentalVMEnabled' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, SimCacheAuxiliaryFileBasePath) == 0x000100, "Member 'UNiagaraSettings::SimCacheAuxiliaryFileBasePath' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, SimCacheMaxCPUMemoryVolumetrics) == 0x000110, "Member 'UNiagaraSettings::SimCacheMaxCPUMemoryVolumetrics' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, PlatformSetRedirects) == 0x000118, "Member 'UNiagaraSettings::PlatformSetRedirects' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceActorComponent, bRequireCurrentFrameData) == 0x000040, "Member 'UNiagaraDataInterfaceActorComponent::bRequireCurrentFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceActorComponent, SourceMode) == 0x000041, "Member 'UNiagaraDataInterfaceActorComponent::SourceMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceActorComponent, ActorOrComponentParameter) == 0x000068, "Member 'UNiagaraDataInterfaceActorComponent::ActorOrComponentParameter' has a wrong offset!");
...
{
public:
	class FName                                   Param;                                             // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAsyncNiagaraCaptureSimCache) == 0x000110, "Wrong size on UAsyncNiagaraCaptureSimCache");
...
{
public:
	struct FNiagaraDataInterfaceEmitterBinding    EmitterBinding;                                    // 0x0040(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   EmitterBinding;                                    // 0x0068(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceSimCacheReader) == 0x000070, "Wrong size on UNiagaraDataInterfaceSimCacheReader");
...
public:
	...
	bool                                          bUsePhysicsBodyVelocity;                           // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowSamplingFromStreamingLODs;                   // 0x0099(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, bUsePhysicsBodyVelocity) == 0x000098, "Member 'UNiagaraDataInterfaceStaticMesh::bUsePhysicsBodyVelocity' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, bAllowSamplingFromStreamingLODs) == 0x000099, "Member 'UNiagaraDataInterfaceStaticMesh::bAllowSamplingFromStreamingLODs' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class AActor>                  SourceActor;                                       // 0x0070(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UObject>                    SourceActorComponentClass;                         // 0x00A0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceUObjectPropertyReader) == 0x0000B0, "Wrong size on UNiagaraDataInterfaceUObjectPropertyReader");
...
static_assert(offsetof(UNiagaraDataInterfaceUObjectPropertyReader, SourceActorComponentClass) == 0x0000A0, "Member 'UNiagaraDataInterfaceUObjectPropertyReader::SourceActorComponentClass' has a wrong offset!");
...
public:
	...
	class FName                                   SimulationStageName;                               // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnabled : 1;                                      // 0x0040(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(UNiagaraSystem, CustomDepthStencilWriteMask) == 0x00007A, "Member 'UNiagaraSystem::CustomDepthStencilWriteMask' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, CustomDepthStencilValue) == 0x00007C, "Member 'UNiagaraSystem::CustomDepthStencilValue' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, TranslucencySortPriority) == 0x000080, "Member 'UNiagaraSystem::TranslucencySortPriority' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, TranslucencySortDistanceOffset) == 0x000084, "Member 'UNiagaraSystem::TranslucencySortDistanceOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDumpDebugSystemInfo) == 0x000088, "Member 'UNiagaraSystem::bDumpDebugSystemInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDumpDebugEmitterInfo) == 0x000089, "Member 'UNiagaraSystem::bDumpDebugEmitterInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bRequireCurrentFrameData) == 0x00008B, "Member 'UNiagaraSystem::bRequireCurrentFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EffectType) == 0x000090, "Member 'UNiagaraSystem::EffectType' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bOverrideScalabilitySettings) == 0x000098, "Member 'UNiagaraSystem::bOverrideScalabilitySettings' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ScalabilityOverrides) == 0x0000A0, "Member 'UNiagaraSystem::ScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemScalabilityOverrides) == 0x0000B0, "Member 'UNiagaraSystem::SystemScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EmitterHandles) == 0x0000C0, "Member 'UNiagaraSystem::EmitterHandles' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ParameterCollectionOverrides) == 0x0000D0, "Member 'UNiagaraSystem::ParameterCollectionOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemSpawnScript) == 0x0000E0, "Member 'UNiagaraSystem::SystemSpawnScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemUpdateScript) == 0x0000E8, "Member 'UNiagaraSystem::SystemUpdateScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemCompiledData) == 0x000100, "Member 'UNiagaraSystem::SystemCompiledData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x000340, "Member 'UNiagaraSystem::ExposedParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedBounds) == 0x000418, "Member 'UNiagaraSystem::FixedBounds' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bAutoDeactivate) == 0x000450, "Member 'UNiagaraSystem::bAutoDeactivate' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDeterminism) == 0x000451, "Member 'UNiagaraSystem::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, RandomSeed) == 0x000454, "Member 'UNiagaraSystem::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x000458, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x00045C, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickDelta) == 0x000460, "Member 'UNiagaraSystem::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bFixedTickDelta) == 0x000464, "Member 'UNiagaraSystem::bFixedTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedTickDeltaTime) == 0x000468, "Member 'UNiagaraSystem::FixedTickDeltaTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x00046C, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedsGPUContextInitForDataInterfaces) == 0x00046D, "Member 'UNiagaraSystem::bNeedsGPUContextInitForDataInterfaces' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x000470, "Member 'UNiagaraSystem::UserDINamesReadInSystemScripts' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ReferencedDataChannelDefinitions) == 0x000480, "Member 'UNiagaraSystem::ReferencedDataChannelDefinitions' has a wrong offset!");
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x000B80, "Wrong size on UNiagaraSpriteRendererProperties");
static_assert(offsetof(UNiagaraSpriteRendererProperties, Material) == 0x0000E8, "Member 'UNiagaraSpriteRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SourceMode) == 0x0000F0, "Member 'UNiagaraSpriteRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialUserParamBinding) == 0x0000F8, "Member 'UNiagaraSpriteRendererProperties::MaterialUserParamBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, Alignment) == 0x000118, "Member 'UNiagaraSpriteRendererProperties::Alignment' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, FacingMode) == 0x000119, "Member 'UNiagaraSpriteRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotInUVSpace) == 0x000120, "Member 'UNiagaraSpriteRendererProperties::PivotInUVSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MacroUVRadius) == 0x000130, "Member 'UNiagaraSpriteRendererProperties::MacroUVRadius' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortMode) == 0x000134, "Member 'UNiagaraSpriteRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageSize) == 0x000138, "Member 'UNiagaraSpriteRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortPrecision) == 0x00014C, "Member 'UNiagaraSpriteRendererProperties::SortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, GpuTranslucentLatency) == 0x00014D, "Member 'UNiagaraSpriteRendererProperties::GpuTranslucentLatency' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PixelCoverageMode) == 0x00014E, "Member 'UNiagaraSpriteRendererProperties::PixelCoverageMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PixelCoverageBlend) == 0x000150, "Member 'UNiagaraSpriteRendererProperties::PixelCoverageBlend' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinFacingCameraBlendDistance) == 0x000154, "Member 'UNiagaraSpriteRendererProperties::MinFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxFacingCameraBlendDistance) == 0x000158, "Member 'UNiagaraSpriteRendererProperties::MaxFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinCameraDistance) == 0x000160, "Member 'UNiagaraSpriteRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxCameraDistance) == 0x000164, "Member 'UNiagaraSpriteRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibility) == 0x000168, "Member 'UNiagaraSpriteRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PositionBinding) == 0x000170, "Member 'UNiagaraSpriteRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, ColorBinding) == 0x0001C8, "Member 'UNiagaraSpriteRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, VelocityBinding) == 0x000220, "Member 'UNiagaraSpriteRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteRotationBinding) == 0x000278, "Member 'UNiagaraSpriteRendererProperties::SpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteSizeBinding) == 0x0002D0, "Member 'UNiagaraSpriteRendererProperties::SpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteFacingBinding) == 0x000328, "Member 'UNiagaraSpriteRendererProperties::SpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteAlignmentBinding) == 0x000380, "Member 'UNiagaraSpriteRendererProperties::SpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageIndexBinding) == 0x0003D8, "Member 'UNiagaraSpriteRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterialBinding) == 0x000430, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial1Binding) == 0x000488, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial2Binding) == 0x0004E0, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial3Binding) == 0x000538, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CameraOffsetBinding) == 0x000590, "Member 'UNiagaraSpriteRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, UVScaleBinding) == 0x0005E8, "Member 'UNiagaraSpriteRendererProperties::UVScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x000640, "Member 'UNiagaraSpriteRendererProperties::PivotOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x000698, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x0006F0, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x000748, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x0007A0, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameters) == 0x0007F8, "Member 'UNiagaraSpriteRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x000848, "Member 'UNiagaraSpriteRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x0008A0, "Member 'UNiagaraSpriteRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x0008F8, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x000950, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x0009A8, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x000A00, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x000A58, "Member 'UNiagaraSpriteRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x000AB0, "Member 'UNiagaraSpriteRendererProperties::PrevPivotOffsetBinding' has a wrong offset!");
...
{
public:
	struct FNiagaraBakerTextureSource             SourceBinding;                                     // 0x0040(0x0018)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bGenerateAtlas : 1;                                // 0x0058(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bGenerateFrames : 1;                               // 0x0058(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bExportFrames : 1;                                 // 0x0058(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetTextureAddressX : 1;                           // 0x0058(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetTextureAddressY : 1;                           // 0x0058(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              FrameSize;                                         // 0x005C(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FIntPoint                              AtlasTextureSize;                                  // 0x0064(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x8];                                       // 0x006C(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	ETextureAddress                               TextureAddressX;                                   // 0x0074(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               TextureAddressY;                                   // 0x0075(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_76[0x2];                                       // 0x0076(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AtlasAssetPathFormat;                              // 0x0078(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FramesAssetPathFormat;                             // 0x0088(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FramesExportPathFormat;                            // 0x0098(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraBakerOutputTexture2D) == 0x0000A8, "Wrong size on UNiagaraBakerOutputTexture2D");
...
static_assert(offsetof(UNiagaraBakerOutputTexture2D, FrameSize) == 0x00005C, "Member 'UNiagaraBakerOutputTexture2D::FrameSize' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, AtlasTextureSize) == 0x000064, "Member 'UNiagaraBakerOutputTexture2D::AtlasTextureSize' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, TextureAddressX) == 0x000074, "Member 'UNiagaraBakerOutputTexture2D::TextureAddressX' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, TextureAddressY) == 0x000075, "Member 'UNiagaraBakerOutputTexture2D::TextureAddressY' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, AtlasAssetPathFormat) == 0x000078, "Member 'UNiagaraBakerOutputTexture2D::AtlasAssetPathFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, FramesAssetPathFormat) == 0x000088, "Member 'UNiagaraBakerOutputTexture2D::FramesAssetPathFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputTexture2D, FramesExportPathFormat) == 0x000098, "Member 'UNiagaraBakerOutputTexture2D::FramesExportPathFormat' has a wrong offset!");
...
public:
	...
	class FString                                 AtlasAssetPathFormat;                              // 0x0060(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FramesAssetPathFormat;                             // 0x0070(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FramesExportPathFormat;                            // 0x0080(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraBakerOutputVolumeTexture) == 0x000090, "Wrong size on UNiagaraBakerOutputVolumeTexture");
...
static_assert(offsetof(UNiagaraBakerOutputVolumeTexture, AtlasAssetPathFormat) == 0x000060, "Member 'UNiagaraBakerOutputVolumeTexture::AtlasAssetPathFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputVolumeTexture, FramesAssetPathFormat) == 0x000070, "Member 'UNiagaraBakerOutputVolumeTexture::FramesAssetPathFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerOutputVolumeTexture, FramesExportPathFormat) == 0x000080, "Member 'UNiagaraBakerOutputVolumeTexture::FramesExportPathFormat' has a wrong offset!");
...
public:
	...
	class FName                                   BakeQualityLevel;                                  // 0x006C(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bRenderComponentOnly : 1;                          // 0x0074(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraBakerTextureSettings>   OutputTextures;                                    // 0x0078(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	ENiagaraBakerViewMode                         CameraViewportMode;                                // 0x0088(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CameraViewportLocation[0x7];                       // 0x0090(0x0018)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               CameraViewportRotation[0x7];                       // 0x0138(0x0018)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         CameraOrbitDistance;                               // 0x01E0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CameraFOV;                                         // 0x01E4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CameraOrthoWidth;                                  // 0x01E8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bUseCameraAspectRatio : 1;                         // 0x01EC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1ED[0x3];                                      // 0x01ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CameraAspectRatio;                                 // 0x01F0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraBakerSettings) == 0x0001F8, "Wrong size on UNiagaraBakerSettings");
...
static_assert(offsetof(UNiagaraBakerSettings, OutputTextures) == 0x000078, "Member 'UNiagaraBakerSettings::OutputTextures' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportMode) == 0x000088, "Member 'UNiagaraBakerSettings::CameraViewportMode' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportLocation) == 0x000090, "Member 'UNiagaraBakerSettings::CameraViewportLocation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportRotation) == 0x000138, "Member 'UNiagaraBakerSettings::CameraViewportRotation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrbitDistance) == 0x0001E0, "Member 'UNiagaraBakerSettings::CameraOrbitDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraFOV) == 0x0001E4, "Member 'UNiagaraBakerSettings::CameraFOV' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrthoWidth) == 0x0001E8, "Member 'UNiagaraBakerSettings::CameraOrthoWidth' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraAspectRatio) == 0x0001F0, "Member 'UNiagaraBakerSettings::CameraAspectRatio' has a wrong offset!");
...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0630(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraTickBehavior                          TickBehavior;                                      // 0x0638(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_639[0x3];                                      // 0x0639(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeedOffset;                                  // 0x063C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0640(0x00D8)(NativeAccessSpecifierPrivate)
	uint8                                         bForceSolo : 1;                                    // 0x0718(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bEnableGpuComputeDebug : 1;                        // 0x0718(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bOverrideWarmupSettings : 1;                       // 0x0718(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_719[0x3];                                      // 0x0719(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WarmupTickCount;                                   // 0x071C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         WarmupTickDelta;                                   // 0x0720(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_724[0x34];                                     // 0x0724(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoDestroy : 1;                                  // 0x0758(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bRenderingEnabled : 1;                             // 0x0758(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoManageAttachment : 1;                         // 0x0758(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0758(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_759[0x3];                                      // 0x0759(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x075C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_760[0x8];                                      // 0x0760(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x0768(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x0778(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AutoAttachSocketName;                              // 0x0780(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0788(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0789(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x078A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_78B[0x9];                                      // 0x078B(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_794_0 : 4;                                  // 0x0794(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x0794(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_795[0x12B];                                    // 0x0795(0x012B)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x08C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x08C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x0008D0, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000630, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000638, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x00063C, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000640, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x00071C, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x000720, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x00075C, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000768, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000778, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000780, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000788, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000789, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x00078A, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x0008C0, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0008C8, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTargetCube) == 0x0000B8, "Wrong size on UNiagaraDataInterfaceRenderTargetCube");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetCube, ManagedRenderTargets) == 0x000068, "Member 'UNiagaraDataInterfaceRenderTargetCube::ManagedRenderTargets' has a wrong offset!");
...
static_assert(sizeof(UNiagaraComponentRendererProperties) == 0x000238, "Wrong size on UNiagaraComponentRendererProperties");
static_assert(offsetof(UNiagaraComponentRendererProperties, ComponentType) == 0x0000E8, "Member 'UNiagaraComponentRendererProperties::ComponentType' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, ComponentCountLimit) == 0x0000F0, "Member 'UNiagaraComponentRendererProperties::ComponentCountLimit' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, EnabledBinding) == 0x0000F8, "Member 'UNiagaraComponentRendererProperties::EnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibilityTagBinding) == 0x000150, "Member 'UNiagaraComponentRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bAssignComponentsOnParticleID) == 0x0001A8, "Member 'UNiagaraComponentRendererProperties::bAssignComponentsOnParticleID' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bCreateComponentFirstParticleFrame) == 0x0001A9, "Member 'UNiagaraComponentRendererProperties::bCreateComponentFirstParticleFrame' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bOnlyActivateNewlyAquiredComponents) == 0x0001AA, "Member 'UNiagaraComponentRendererProperties::bOnlyActivateNewlyAquiredComponents' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibility) == 0x0001AC, "Member 'UNiagaraComponentRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, TemplateComponent) == 0x0001B0, "Member 'UNiagaraComponentRendererProperties::TemplateComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, PropertyBindings) == 0x0001B8, "Member 'UNiagaraComponentRendererProperties::PropertyBindings' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x08D0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x0008E0, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0008D0, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
public:
	...
	class FName                                   ExposedName;                                       // 0x0068(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             ExposedTexture;                                    // 0x0070(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceIntRenderTarget2D) == 0x0000B8, "Wrong size on UNiagaraDataInterfaceIntRenderTarget2D");
...
static_assert(offsetof(UNiagaraDataInterfaceIntRenderTarget2D, ManagedRenderTargets) == 0x000068, "Member 'UNiagaraDataInterfaceIntRenderTarget2D::ManagedRenderTargets' has a wrong offset!");
...
public:
	...
	bool                                          bDisableVirtualTexturing;                          // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class URuntimeVirtualTexture*>         RuntimeVirtualTextures;                            // 0x0068(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceLandscape) == 0x000080, "Wrong size on UNiagaraDataInterfaceLandscape");
...
static_assert(offsetof(UNiagaraDataInterfaceLandscape, bDisableVirtualTexturing) == 0x000060, "Member 'UNiagaraDataInterfaceLandscape::bDisableVirtualTexturing' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceLandscape, RuntimeVirtualTextures) == 0x000068, "Member 'UNiagaraDataInterfaceLandscape::RuntimeVirtualTextures' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTarget2D) == 0x000110, "Wrong size on UNiagaraDataInterfaceRenderTarget2D");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, ManagedRenderTargets) == 0x0000C0, "Member 'UNiagaraDataInterfaceRenderTarget2D::ManagedRenderTargets' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTarget2DArray) == 0x0000C0, "Wrong size on UNiagaraDataInterfaceRenderTarget2DArray");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2DArray, ManagedRenderTargets) == 0x000070, "Member 'UNiagaraDataInterfaceRenderTarget2DArray::ManagedRenderTargets' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTargetVolume) == 0x0000C8, "Wrong size on UNiagaraDataInterfaceRenderTargetVolume");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, ManagedRenderTargets) == 0x000078, "Member 'UNiagaraDataInterfaceRenderTargetVolume::ManagedRenderTargets' has a wrong offset!");
...
public:
	...
	TArray<class FName>                           SamplingRegions;                                   // 0x00B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         WholeMeshLOD;                                      // 0x00C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FName                                   ExcludeBoneName;                                   // 0x00F0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bExcludeBone : 1;                                  // 0x00F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_F9[0x3];                                       // 0x00F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         UvSetIndex;                                        // 0x00FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRequireCurrentFrameData;                          // 0x0100(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceSkeletalMesh) == 0x000108, "Wrong size on UNiagaraDataInterfaceSkeletalMesh");
...
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, UvSetIndex) == 0x0000FC, "Member 'UNiagaraDataInterfaceSkeletalMesh::UvSetIndex' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, bRequireCurrentFrameData) == 0x000100, "Member 'UNiagaraDataInterfaceSkeletalMesh::bRequireCurrentFrameData' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceSpline, bUseLUT) == 0x000068, "Member 'UNiagaraDataInterfaceSpline::bUseLUT' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSpline, NumLUTSteps) == 0x00006C, "Member 'UNiagaraDataInterfaceSpline::NumLUTSteps' has a wrong offset!");
...
public:
	class UMaterialInterface*                     Material;                                          // 0x00E8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraParameterBinding               MaterialParameterBinding;                          // 0x00F0(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x00FC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_FD[0x3];                                       // 0x00FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         DecalScreenSizeFade;                               // 0x0104(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraVariableAttributeBinding       DecalSortOrderBinding;                             // 0x0268(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DecalColorBinding;                                 // 0x02C0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DecalVisibleBinding;                               // 0x0318(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0370(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x03C8(0x0050)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDecalRendererProperties) == 0x000450, "Wrong size on UNiagaraDecalRendererProperties");
static_assert(offsetof(UNiagaraDecalRendererProperties, Material) == 0x0000E8, "Member 'UNiagaraDecalRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameterBinding) == 0x0000F0, "Member 'UNiagaraDecalRendererProperties::MaterialParameterBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, SourceMode) == 0x0000FC, "Member 'UNiagaraDecalRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibility) == 0x000100, "Member 'UNiagaraDecalRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalScreenSizeFade) == 0x000104, "Member 'UNiagaraDecalRendererProperties::DecalScreenSizeFade' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalSortOrderBinding) == 0x000268, "Member 'UNiagaraDecalRendererProperties::DecalSortOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalColorBinding) == 0x0002C0, "Member 'UNiagaraDecalRendererProperties::DecalColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalVisibleBinding) == 0x000318, "Member 'UNiagaraDecalRendererProperties::DecalVisibleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibilityTagBinding) == 0x000370, "Member 'UNiagaraDecalRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameters) == 0x0003C8, "Member 'UNiagaraDecalRendererProperties::MaterialParameters' has a wrong offset!");
...
static_assert(offsetof(UNiagaraLightRendererProperties, SourceMode) == 0x0000E8, "Member 'UNiagaraLightRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusScale) == 0x0000F0, "Member 'UNiagaraLightRendererProperties::RadiusScale' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, DefaultExponent) == 0x0000F4, "Member 'UNiagaraLightRendererProperties::DefaultExponent' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x0000F8, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, InverseExposureBlend) == 0x000104, "Member 'UNiagaraLightRendererProperties::InverseExposureBlend' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibility) == 0x000108, "Member 'UNiagaraLightRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, LightRenderingEnabledBinding) == 0x000110, "Member 'UNiagaraLightRendererProperties::LightRenderingEnabledBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, LightExponentBinding) == 0x000168, "Member 'UNiagaraLightRendererProperties::LightExponentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, PositionBinding) == 0x0001C0, "Member 'UNiagaraLightRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorBinding) == 0x000218, "Member 'UNiagaraLightRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusBinding) == 0x000270, "Member 'UNiagaraLightRendererProperties::RadiusBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricScatteringBinding) == 0x0002C8, "Member 'UNiagaraLightRendererProperties::VolumetricScatteringBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x000320, "Member 'UNiagaraLightRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x0350(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextRenderComponent*                   Label;                                             // 0x0358(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x000360, "Wrong size on ANiagaraPerfBaselineActor");
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x000350, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x000358, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPreviewBase) == 0x000350, "Wrong size on ANiagaraPreviewBase");
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x0350(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraPreviewGridResetMode                  ResetMode;                                         // 0x0358(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_359[0x7];                                      // 0x0359(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x0360(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x0368(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ANiagaraPreviewBase>        PreviewClass;                                      // 0x0370(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingX;                                          // 0x0378(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingY;                                          // 0x037C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumX;                                              // 0x0380(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NumY;                                              // 0x0384(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x0388(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ANiagaraPreviewGrid) == 0x0003A0, "Wrong size on ANiagaraPreviewGrid");
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x000350, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x000358, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x000360, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x000368, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x000370, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x000378, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x00037C, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x000380, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x000384, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x000388, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x000AA8, "Wrong size on UNiagaraRibbonRendererProperties");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Material) == 0x0000E8, "Member 'UNiagaraRibbonRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialUserParamBinding) == 0x0000F0, "Member 'UNiagaraRibbonRendererProperties::MaterialUserParamBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, FacingMode) == 0x000110, "Member 'UNiagaraRibbonRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV0Settings) == 0x000118, "Member 'UNiagaraRibbonRendererProperties::UV0Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV1Settings) == 0x000150, "Member 'UNiagaraRibbonRendererProperties::UV1Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaxNumRibbons) == 0x000188, "Member 'UNiagaraRibbonRendererProperties::MaxNumRibbons' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseGPUInit) == 0x00018C, "Member 'UNiagaraRibbonRendererProperties::bUseGPUInit' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DrawDirection) == 0x00018D, "Member 'UNiagaraRibbonRendererProperties::DrawDirection' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x00018E, "Member 'UNiagaraRibbonRendererProperties::Shape' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bEnableAccurateGeometry) == 0x00018F, "Member 'UNiagaraRibbonRendererProperties::bEnableAccurateGeometry' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, WidthSegmentationCount) == 0x000190, "Member 'UNiagaraRibbonRendererProperties::WidthSegmentationCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MultiPlaneCount) == 0x000194, "Member 'UNiagaraRibbonRendererProperties::MultiPlaneCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TubeSubdivisions) == 0x000198, "Member 'UNiagaraRibbonRendererProperties::TubeSubdivisions' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CustomVertices) == 0x0001A0, "Member 'UNiagaraRibbonRendererProperties::CustomVertices' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x0001B0, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x0001B4, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x0001B8, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x0001BC, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x0001C0, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x0001C4, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x0001C8, "Member 'UNiagaraRibbonRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x000220, "Member 'UNiagaraRibbonRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, VelocityBinding) == 0x000278, "Member 'UNiagaraRibbonRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, NormalizedAgeBinding) == 0x0002D0, "Member 'UNiagaraRibbonRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x000328, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonWidthBinding) == 0x000380, "Member 'UNiagaraRibbonRendererProperties::RibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x0003D8, "Member 'UNiagaraRibbonRendererProperties::RibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x000430, "Member 'UNiagaraRibbonRendererProperties::RibbonIdBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x000488, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x0004E0, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x000538, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x000590, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x0005E8, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x000640, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonUVDistance) == 0x000698, "Member 'UNiagaraRibbonRendererProperties::RibbonUVDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x0006F0, "Member 'UNiagaraRibbonRendererProperties::U0OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x000748, "Member 'UNiagaraRibbonRendererProperties::V0RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x0007A0, "Member 'UNiagaraRibbonRendererProperties::U1OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x0007F8, "Member 'UNiagaraRibbonRendererProperties::V1RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameters) == 0x000850, "Member 'UNiagaraRibbonRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevPositionBinding) == 0x0008A0, "Member 'UNiagaraRibbonRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonWidthBinding) == 0x0008F8, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonFacingBinding) == 0x000950, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonTwistBinding) == 0x0009A8, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonTwistBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraScript, ScriptExecutionParamStore) == 0x0000D8, "Member 'UNiagaraScript::ScriptExecutionParamStore' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, ScriptExecutionBoundParameters) == 0x000180, "Member 'UNiagaraScript::ScriptExecutionBoundParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedScriptVMId) == 0x000190, "Member 'UNiagaraScript::CachedScriptVMId' has a wrong offset!");
...
static_assert(sizeof(UNiagaraSimulationStageGeneric) == 0x0002B0, "Wrong size on UNiagaraSimulationStageGeneric");
...
static_assert(offsetof(UNiagaraSimulationStageGeneric, IterationSource) == 0x0000A0, "Member 'UNiagaraSimulationStageGeneric::IterationSource' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, Iterations) == 0x0000A4, "Member 'UNiagaraSimulationStageGeneric::Iterations' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, NumIterationsBinding) == 0x0000A8, "Member 'UNiagaraSimulationStageGeneric::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ExecuteBehavior) == 0x000100, "Member 'UNiagaraSimulationStageGeneric::ExecuteBehavior' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSimulationStageGeneric, DirectDispatchType) == 0x0001A0, "Member 'UNiagaraSimulationStageGeneric::DirectDispatchType' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DirectDispatchElementType) == 0x0001A1, "Member 'UNiagaraSimulationStageGeneric::DirectDispatchElementType' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountXBinding) == 0x0001A8, "Member 'UNiagaraSimulationStageGeneric::ElementCountXBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountYBinding) == 0x000200, "Member 'UNiagaraSimulationStageGeneric::ElementCountYBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountZBinding) == 0x000258, "Member 'UNiagaraSimulationStageGeneric::ElementCountZBinding' has a wrong offset!");
