...
// ScriptStruct CoreUObject.EntityId
// 0x0008 (0x0008 - 0x0000)
struct FEntityId final
{
public:
	uint64                                        m_Id;                                              // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEntityId) == 0x000008, "Wrong alignment on FEntityId");
static_assert(sizeof(FEntityId) == 0x000008, "Wrong size on FEntityId");
static_assert(offsetof(FEntityId, m_Id) == 0x000000, "Member 'FEntityId::m_Id' has a wrong offset!");
