...
// Function NinjaLive.NinjaLive_C.ClearTraceMeshSizeOverride
// (BlueprintCallable, BlueprintEvent)

void ANinjaLive_C::ClearTraceMeshSizeOverride()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NinjaLive_C", "ClearTraceMeshSizeOverride");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   TraceMeshSize_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ANinjaLive_C::OverrideTraceMeshSize(const struct FVector& TraceMeshSize_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NinjaLive_C", "OverrideTraceMeshSize");

	Params::NinjaLive_C_OverrideTraceMeshSize Parms{};

	Parms.TraceMeshSize_0 = std::move(TraceMeshSize_0);
