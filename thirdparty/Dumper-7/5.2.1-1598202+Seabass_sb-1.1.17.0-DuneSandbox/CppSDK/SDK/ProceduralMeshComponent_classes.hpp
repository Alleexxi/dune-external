...
public:
	...
	bool                                          bUseComplexAsSimpleCollision;                      // 0x0670(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAsyncCooking;                                  // 0x0671(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_672[0x6];                                      // 0x0672(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0678(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FProcMeshSection>               ProcMeshSections;                                  // 0x0680(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FKConvexElem>                   CollisionConvexElems;                              // 0x0690(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x06D8(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UProceduralMeshComponent, bUseComplexAsSimpleCollision) == 0x000670, "Member 'UProceduralMeshComponent::bUseComplexAsSimpleCollision' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, bUseAsyncCooking) == 0x000671, "Member 'UProceduralMeshComponent::bUseAsyncCooking' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, ProcMeshBodySetup) == 0x000678, "Member 'UProceduralMeshComponent::ProcMeshBodySetup' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, ProcMeshSections) == 0x000680, "Member 'UProceduralMeshComponent::ProcMeshSections' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, CollisionConvexElems) == 0x000690, "Member 'UProceduralMeshComponent::CollisionConvexElems' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, LocalBounds) == 0x0006A0, "Member 'UProceduralMeshComponent::LocalBounds' has a wrong offset!");
static_assert(offsetof(UProceduralMeshComponent, AsyncBodySetupQueue) == 0x0006D8, "Member 'UProceduralMeshComponent::AsyncBodySetupQueue' has a wrong offset!");

// Class ProceduralMeshComponent.NetAddressableProceduralMeshComponent
// 0x0000 (0x06F0 - 0x06F0)
class UNetAddressableProceduralMeshComponent final : public UProceduralMeshComponent
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"NetAddressableProceduralMeshComponent">();
	}
	static class UNetAddressableProceduralMeshComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNetAddressableProceduralMeshComponent>();
	}
};
static_assert(alignof(UNetAddressableProceduralMeshComponent) == 0x000010, "Wrong alignment on UNetAddressableProceduralMeshComponent");
static_assert(sizeof(UNetAddressableProceduralMeshComponent) == 0x0006F0, "Wrong size on UNetAddressableProceduralMeshComponent");
