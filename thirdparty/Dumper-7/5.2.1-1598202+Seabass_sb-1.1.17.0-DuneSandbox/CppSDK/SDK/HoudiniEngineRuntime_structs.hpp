...
enum class EHoudiniInputObjectType : uint8
{
	...
	LevelInstance                            = 25,
	PackedLevelActor                         = 26,
	EHoudiniInputObjectType_MAX              = 27,
};
...
public:
	...
	bool                                          bExportLevelInstanceContent;                       // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FHoudiniInputObjectSettings, bExportLevelInstanceContent) == 0x00001D, "Member 'FHoudiniInputObjectSettings::bExportLevelInstanceContent' has a wrong offset!");
