...
public:
	...
	uint8                                         Pad_138[0x128];                                    // 0x0138(0x0128)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UClass) == 0x000260, "Wrong size on UClass");
static_assert(offsetof(UClass, CastFlags) == 0x0000E0, "Member 'UClass::CastFlags' has a wrong offset!");
...
static_assert(sizeof(UGCObjectReferencer) == 0x000048, "Wrong size on UGCObjectReferencer");
...
static_assert(sizeof(USparseDelegateFunction) == 0x0000F8, "Wrong size on USparseDelegateFunction");
...
static_assert(sizeof(UDynamicClass) == 0x0002E0, "Wrong size on UDynamicClass");
...
{
public:
	uint8                                         Pad_260[0x1C0];                                    // 0x0260(0x01C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderClass) == 0x000420, "Wrong size on ULinkerPlaceholderClass");
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x0002A8, "Wrong size on ULinkerPlaceholderFunction");
...
static_assert(sizeof(UMapProperty) == 0x0000A0, "Wrong size on UMapProperty");
...
static_assert(sizeof(UMulticastInlineDelegateProperty) == 0x000080, "Wrong size on UMulticastInlineDelegateProperty");
...
static_assert(sizeof(UMulticastSparseDelegateProperty) == 0x000080, "Wrong size on UMulticastSparseDelegateProperty");
...
static_assert(sizeof(USoftObjectProperty) == 0x000080, "Wrong size on USoftObjectProperty");
...
static_assert(sizeof(USoftClassProperty) == 0x000088, "Wrong size on USoftClassProperty");
