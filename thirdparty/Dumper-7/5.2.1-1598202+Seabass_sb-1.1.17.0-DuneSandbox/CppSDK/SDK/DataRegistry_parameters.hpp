...
public:
	...
	struct FTableRowBase                          OutItem;                                           // 0x0018(0x0010)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	struct FDataRegistryId                        ItemId;                                            // 0x0000(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTableRowBase                          OutItem;                                           // 0x0010(0x0010)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0020(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTableRowBase                          OutItem;                                           // 0x0030(0x0010)(Parm, OutParm, NativeAccessSpecifierPublic)
