...
struct alignas(0x10) FRigUnit_FullbodyIK_WorkData final
{
public:
	uint8                                         Pad_0[0x230];                                      // 0x0000(0x0230)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_FullbodyIK_WorkData) == 0x000010, "Wrong alignment on FRigUnit_FullbodyIK_WorkData");
static_assert(sizeof(FRigUnit_FullbodyIK_WorkData) == 0x000230, "Wrong size on FRigUnit_FullbodyIK_WorkData");
...
public:
	...
	struct FRigUnit_FullbodyIK_WorkData           WorkData;                                          // 0x0210(0x0230)(Transient, NativeAccessSpecifierPublic)
};
