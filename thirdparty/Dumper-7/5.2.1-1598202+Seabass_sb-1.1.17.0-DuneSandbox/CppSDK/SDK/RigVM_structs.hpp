...
// 0x00A0 (0x00A0 - 0x0000)
struct alignas(0x10) FRigVMUserWorkflow final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Title;                                             // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 Tooltip;                                           // 0x0020(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ERigVMUserWorkflowType                        Type;                                              // 0x0030(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_31[0x4F];                                      // 0x0031(0x004F)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const class URigVMUserWorkflowOptions* InOptions, class UObject* InController)> PerformDynamicDelegate; // 0x0080(0x0010)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UObject>                    OptionsClass;                                      // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigVMUserWorkflow) == 0x000010, "Wrong alignment on FRigVMUserWorkflow");
static_assert(sizeof(FRigVMUserWorkflow) == 0x0000A0, "Wrong size on FRigVMUserWorkflow");
static_assert(offsetof(FRigVMUserWorkflow, Title) == 0x000010, "Member 'FRigVMUserWorkflow::Title' has a wrong offset!");
static_assert(offsetof(FRigVMUserWorkflow, Tooltip) == 0x000020, "Member 'FRigVMUserWorkflow::Tooltip' has a wrong offset!");
static_assert(offsetof(FRigVMUserWorkflow, Type) == 0x000030, "Member 'FRigVMUserWorkflow::Type' has a wrong offset!");
static_assert(offsetof(FRigVMUserWorkflow, PerformDynamicDelegate) == 0x000080, "Member 'FRigVMUserWorkflow::PerformDynamicDelegate' has a wrong offset!");
static_assert(offsetof(FRigVMUserWorkflow, OptionsClass) == 0x000090, "Member 'FRigVMUserWorkflow::OptionsClass' has a wrong offset!");
