...
static_assert(alignof(StriderMath_AngleBetween) == 0x000008, "Wrong alignment on StriderMath_AngleBetween");
static_assert(sizeof(StriderMath_AngleBetween) == 0x000038, "Wrong size on StriderMath_AngleBetween");
static_assert(offsetof(StriderMath_AngleBetween, A) == 0x000000, "Member 'StriderMath_AngleBetween::A' has a wrong offset!");
static_assert(offsetof(StriderMath_AngleBetween, B) == 0x000018, "Member 'StriderMath_AngleBetween::B' has a wrong offset!");
static_assert(offsetof(StriderMath_AngleBetween, ReturnValue) == 0x000030, "Member 'StriderMath_AngleBetween::ReturnValue' has a wrong offset!");
...
{
public:
	struct FVector                                InStart;                                           // 0x0000(0x0018)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         MaxDelta;                                          // 0x0030(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(StriderMath_MoveComponentsToward) == 0x000008, "Wrong alignment on StriderMath_MoveComponentsToward");
static_assert(sizeof(StriderMath_MoveComponentsToward) == 0x000038, "Wrong size on StriderMath_MoveComponentsToward");
...
static_assert(offsetof(StriderMath_MoveComponentsToward, End) == 0x000018, "Member 'StriderMath_MoveComponentsToward::End' has a wrong offset!");
static_assert(offsetof(StriderMath_MoveComponentsToward, MaxDelta) == 0x000030, "Member 'StriderMath_MoveComponentsToward::MaxDelta' has a wrong offset!");
...
static_assert(alignof(StriderMath_MoveTowardVector) == 0x000008, "Wrong alignment on StriderMath_MoveTowardVector");
static_assert(sizeof(StriderMath_MoveTowardVector) == 0x000038, "Wrong size on StriderMath_MoveTowardVector");
...
static_assert(offsetof(StriderMath_MoveTowardVector, End) == 0x000018, "Member 'StriderMath_MoveTowardVector::End' has a wrong offset!");
static_assert(offsetof(StriderMath_MoveTowardVector, MaxDelta) == 0x000030, "Member 'StriderMath_MoveTowardVector::MaxDelta' has a wrong offset!");
