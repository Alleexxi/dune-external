...
// ScriptStruct Foliage.oliageRespawnParams
// 0x0028 (0x0028 - 0x0000)
struct FoliageRespawnParams final
{
public:
	bool                                          bIsInitialReceived;                                // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<int32>                                 ComponentEndIndex;                                 // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint16>                                Indices;                                           // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FoliageRespawnParams) == 0x000008, "Wrong alignment on FoliageRespawnParams");
static_assert(sizeof(FoliageRespawnParams) == 0x000028, "Wrong size on FoliageRespawnParams");
static_assert(offsetof(FoliageRespawnParams, bIsInitialReceived) == 0x000000, "Member 'FoliageRespawnParams::bIsInitialReceived' has a wrong offset!");
static_assert(offsetof(FoliageRespawnParams, ComponentEndIndex) == 0x000008, "Member 'FoliageRespawnParams::ComponentEndIndex' has a wrong offset!");
static_assert(offsetof(FoliageRespawnParams, Indices) == 0x000018, "Member 'FoliageRespawnParams::Indices' has a wrong offset!");
