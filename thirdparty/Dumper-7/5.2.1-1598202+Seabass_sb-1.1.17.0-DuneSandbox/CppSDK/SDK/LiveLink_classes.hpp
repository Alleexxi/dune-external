...
static_assert(sizeof(ULiveLinkComponent) == 0x000148, "Wrong size on ULiveLinkComponent");
static_assert(offsetof(ULiveLinkComponent, OnLiveLinkUpdated) == 0x000128, "Member 'ULiveLinkComponent::OnLiveLinkUpdated' has a wrong offset!");
...
static_assert(sizeof(ULiveLinkDrivenComponent) == 0x000140, "Wrong size on ULiveLinkDrivenComponent");
static_assert(offsetof(ULiveLinkDrivenComponent, SubjectName) == 0x000128, "Member 'ULiveLinkDrivenComponent::SubjectName' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, ActorTransformBone) == 0x000130, "Member 'ULiveLinkDrivenComponent::ActorTransformBone' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bModifyActorTransform) == 0x000138, "Member 'ULiveLinkDrivenComponent::bModifyActorTransform' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bSetRelativeLocation) == 0x000139, "Member 'ULiveLinkDrivenComponent::bSetRelativeLocation' has a wrong offset!");
...
{
public:
	struct FLiveLinkSubjectKey                    SubjectKey;                                        // 0x0038(0x0018)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ELiveLinkTimecodeProviderEvaluationType       Evaluation;                                        // 0x0050(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideFrameRate;                                // 0x0054(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_55[0x3];                                       // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFrameRate                             OverrideFrameRate;                                 // 0x0058(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         BufferSize;                                        // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_64[0x64];                                      // 0x0064(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULiveLinkTimecodeProvider) == 0x0000C8, "Wrong size on ULiveLinkTimecodeProvider");
...
static_assert(offsetof(ULiveLinkTimecodeProvider, Evaluation) == 0x000050, "Member 'ULiveLinkTimecodeProvider::Evaluation' has a wrong offset!");
static_assert(offsetof(ULiveLinkTimecodeProvider, bOverrideFrameRate) == 0x000054, "Member 'ULiveLinkTimecodeProvider::bOverrideFrameRate' has a wrong offset!");
static_assert(offsetof(ULiveLinkTimecodeProvider, OverrideFrameRate) == 0x000058, "Member 'ULiveLinkTimecodeProvider::OverrideFrameRate' has a wrong offset!");
static_assert(offsetof(ULiveLinkTimecodeProvider, BufferSize) == 0x000060, "Member 'ULiveLinkTimecodeProvider::BufferSize' has a wrong offset!");
...
{
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0038(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkTimeSynchronizationSource) == 0x000088, "Wrong size on ULiveLinkTimeSynchronizationSource");
...
{
public:
	class FName                                   BoneName;                                          // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULiveLinkAnimationRoleToTransform) == 0x000048, "Wrong size on ULiveLinkAnimationRoleToTransform");
