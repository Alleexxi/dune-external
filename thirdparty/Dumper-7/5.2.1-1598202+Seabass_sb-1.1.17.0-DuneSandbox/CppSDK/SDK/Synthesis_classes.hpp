...
// 0x06D0 (0x0F20 - 0x0850)
class UModularSynthComponent final : public USynthComponent
{
public:
	int32                                         VoiceCount;                                        // 0x0850(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_854[0x6CC];                                    // 0x0854(0x06CC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularSynthComponent) == 0x000F20, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x000850, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
static_assert(sizeof(USourceEffectBitCrusherPreset) == 0x000238, "Wrong size on USourceEffectBitCrusherPreset");
static_assert(offsetof(USourceEffectBitCrusherPreset, Settings) == 0x000168, "Member 'USourceEffectBitCrusherPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectChorusPreset) == 0x000548, "Wrong size on USourceEffectChorusPreset");
static_assert(offsetof(USourceEffectChorusPreset, Settings) == 0x0002F0, "Member 'USourceEffectChorusPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(UEnvelopeFollowerListener) == 0x000148, "Wrong size on UEnvelopeFollowerListener");
...
// 0x03E0 (0x0C30 - 0x0850)
class UGranularSynth final : public USynthComponent
{
public:
	class USoundWave*                             GranulatedSoundWave;                               // 0x0850(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_858[0x3D8];                                    // 0x0858(0x03D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGranularSynth) == 0x000C30, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x000850, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
// 0x0750 (0x0FA0 - 0x0850)
class USynthComponentMonoWaveTable final : public USynthComponent
{
public:
	TMulticastInlineDelegate<void(int32 TableIndex)> OnTableAltered;                                 // 0x0850(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnNumTablesChanged;                                // 0x0860(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UMonoWaveTableSynthPreset*              CurrentPreset;                                     // 0x0870(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_878[0x728];                                    // 0x0878(0x0728)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000FA0, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x000850, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x000860, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x000870, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");

// Class Synthesis.SynthComponentToneGenerator
// 0x00F0 (0x0940 - 0x0850)
class USynthComponentToneGenerator final : public USynthComponent
{
public:
	float                                         Frequency;                                         // 0x0850(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Volume;                                            // 0x0854(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     DistanceAttenuationCurve;                          // 0x0858(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector2D                              DistanceRange;                                     // 0x08E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AttenuationDbAtMaxRange;                           // 0x08F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8F4[0x4C];                                     // 0x08F4(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentToneGenerator) == 0x000940, "Wrong size on USynthComponentToneGenerator");
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x000850, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x000854, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceAttenuationCurve) == 0x000858, "Member 'USynthComponentToneGenerator::DistanceAttenuationCurve' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceRange) == 0x0008E0, "Member 'USynthComponentToneGenerator::DistanceRange' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, AttenuationDbAtMaxRange) == 0x0008F0, "Member 'USynthComponentToneGenerator::AttenuationDbAtMaxRange' has a wrong offset!");
...
{
public:
	class USoundWave*                             SoundWave;                                         // 0x0850(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnSampleLoaded;                                    // 0x0858(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float ProgressPercent, float ProgressTimeSeconds)> OnSamplePlaybackProgress; // 0x0868(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_878[0x108];                                    // 0x0878(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthSamplePlayer) == 0x000980, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x000850, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x000858, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x000868, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
...
// 0x04E8 (0x0640 - 0x0158)
class USynth2DSlider final : public UWidget
{
public:
	float                                         ValueX;                                            // 0x0158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ValueY;                                            // 0x015C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             ValueXDelegate;                                    // 0x0160(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             ValueYDelegate;                                    // 0x0170(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USynth2DSlider, ValueX) == 0x000158, "Member 'USynth2DSlider::ValueX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueY) == 0x00015C, "Member 'USynth2DSlider::ValueY' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueXDelegate) == 0x000160, "Member 'USynth2DSlider::ValueXDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueYDelegate) == 0x000170, "Member 'USynth2DSlider::ValueYDelegate' has a wrong offset!");
...
public:
	...
	float                                         StepSize;                                          // 0x015C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MouseSpeed;                                        // 0x0160(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MouseFineTuneSpeed;                                // 0x0164(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         ShowTooltipInfo : 1;                               // 0x0168(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_169[0x7];                                      // 0x0169(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ParameterName;                                     // 0x0170(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   ParameterUnits;                                    // 0x0188(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USynthKnob, Value) == 0x000158, "Member 'USynthKnob::Value' has a wrong offset!");
static_assert(offsetof(USynthKnob, StepSize) == 0x00015C, "Member 'USynthKnob::StepSize' has a wrong offset!");
static_assert(offsetof(USynthKnob, MouseSpeed) == 0x000160, "Member 'USynthKnob::MouseSpeed' has a wrong offset!");
static_assert(offsetof(USynthKnob, MouseFineTuneSpeed) == 0x000164, "Member 'USynthKnob::MouseFineTuneSpeed' has a wrong offset!");
static_assert(offsetof(USynthKnob, ParameterName) == 0x000170, "Member 'USynthKnob::ParameterName' has a wrong offset!");
static_assert(offsetof(USynthKnob, ParameterUnits) == 0x000188, "Member 'USynthKnob::ParameterUnits' has a wrong offset!");
