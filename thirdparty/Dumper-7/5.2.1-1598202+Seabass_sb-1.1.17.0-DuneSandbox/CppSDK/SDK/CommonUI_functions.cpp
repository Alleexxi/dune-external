...
// Parameters:
// const struct FVector2D&                 NewContentAnchor                                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonVisualAttachment::SetContentAnchor(const struct FVector2D& NewContentAnchor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonVisualAttachment", "SetContentAnchor");

	Params::CommonVisualAttachment_SetContentAnchor Parms{};

	Parms.NewContentAnchor = std::move(NewContentAnchor);
...
struct FVector2D UCommonVisualAttachment::GetContentAnchor() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonVisualAttachment", "GetContentAnchor");

	Params::CommonVisualAttachment_GetContentAnchor Parms{};
