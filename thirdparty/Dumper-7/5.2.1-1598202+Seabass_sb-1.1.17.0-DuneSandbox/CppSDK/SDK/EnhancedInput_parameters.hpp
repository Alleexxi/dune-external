...
public:
	...
	struct FModifyContextOptions                  Options;                                           // 0x000C(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(EnhancedInputSubsystemInterface_AddMappingContext) == 0x000020, "Wrong size on EnhancedInputSubsystemInterface_AddMappingContext");
...
public:
	...
	struct FModifyContextOptions                  Options;                                           // 0x0008(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EnhancedInputSubsystemInterface_AddPlayerMappableConfig) == 0x000018, "Wrong size on EnhancedInputSubsystemInterface_AddPlayerMappableConfig");
...
public:
	...
	struct FModifyContextOptions                  Options;                                           // 0x0030(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_AddPlayerMappedKeyInSlot, ReturnValue) == 0x000040, "Member 'EnhancedInputSubsystemInterface_K2_AddPlayerMappedKeyInSlot::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FModifyContextOptions                  Options;                                           // 0x0018(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot) == 0x000030, "Wrong size on EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot");
...
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot, ReturnValue) == 0x000028, "Member 'EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot::ReturnValue' has a wrong offset!");
...
{
public:
	struct FModifyContextOptions                  Options;                                           // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeys) == 0x000004, "Wrong alignment on EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeys");
static_assert(sizeof(EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeys) == 0x000010, "Wrong size on EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeys");
...
static_assert(sizeof(EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeysForMapping) == 0x00001C, "Wrong size on EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeysForMapping");
...
static_assert(offsetof(EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeysForMapping, ReturnValue) == 0x000018, "Member 'EnhancedInputSubsystemInterface_RemoveAllPlayerMappedKeysForMapping::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(EnhancedInputSubsystemInterface_RemovePlayerMappableConfig) == 0x000018, "Wrong size on EnhancedInputSubsystemInterface_RemovePlayerMappableConfig");
...
public:
	struct FModifyContextOptions                  Options;                                           // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	EInputMappingRebuildType                      RebuildType;                                       // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(EnhancedInputSubsystemInterface_RequestRebuildControlMappings) == 0x000004, "Wrong alignment on EnhancedInputSubsystemInterface_RequestRebuildControlMappings");
static_assert(sizeof(EnhancedInputSubsystemInterface_RequestRebuildControlMappings) == 0x000014, "Wrong size on EnhancedInputSubsystemInterface_RequestRebuildControlMappings");
...
static_assert(offsetof(EnhancedInputSubsystemInterface_RequestRebuildControlMappings, RebuildType) == 0x000010, "Member 'EnhancedInputSubsystemInterface_RequestRebuildControlMappings::RebuildType' has a wrong offset!");
...
// Function EnhancedInput.EnhancedInputSubsystemInterface.IsWaitingForMappingRebuild
// 0x0001 (0x0001 - 0x0000)
struct EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild) == 0x000001, "Wrong alignment on EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild");
static_assert(sizeof(EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild) == 0x000001, "Wrong size on EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild");
static_assert(offsetof(EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild, ReturnValue) == 0x000000, "Member 'EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild::ReturnValue' has a wrong offset!");
