...
public:
	...
	bool                                          bDestroyAtEnd;                                     // 0x0078(0x0001)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bDestroyAtEnd) == 0x000078, "Member 'UAnimNotifyState_TimedNiagaraEffect::bDestroyAtEnd' has a wrong offset!");
...
static_assert(offsetof(UAnimNotify_PlayNiagaraEffect, RotationOffset) == 0x000060, "Member 'UAnimNotify_PlayNiagaraEffect::RotationOffset' has a wrong offset!");
static_assert(offsetof(UAnimNotify_PlayNiagaraEffect, Scale) == 0x000078, "Member 'UAnimNotify_PlayNiagaraEffect::Scale' has a wrong offset!");
