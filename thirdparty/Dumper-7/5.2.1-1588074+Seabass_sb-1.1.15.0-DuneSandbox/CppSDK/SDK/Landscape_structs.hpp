...
// Enum Landscape.EComponentFlags
// NumValues: 0x0003
enum class EComponentFlags : uint8
{
	None                                     = 0,
	HasHoles                                 = 1,
	EComponentFlags_MAX                      = 2,
};
...
// ScriptStruct Landscape.LandscapeRVTPreset
// 0x0038 (0x0038 - 0x0000)
struct FLandscapeRVTPreset final
{
public:
	class FName                                   ConfigurationName;                                 // 0x0000(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class URuntimeVirtualTexture>  VirtualTexture;                                    // 0x0008(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLandscapeRVTPreset) == 0x000008, "Wrong alignment on FLandscapeRVTPreset");
static_assert(sizeof(FLandscapeRVTPreset) == 0x000038, "Wrong size on FLandscapeRVTPreset");
static_assert(offsetof(FLandscapeRVTPreset, ConfigurationName) == 0x000000, "Member 'FLandscapeRVTPreset::ConfigurationName' has a wrong offset!");
static_assert(offsetof(FLandscapeRVTPreset, VirtualTexture) == 0x000008, "Member 'FLandscapeRVTPreset::VirtualTexture' has a wrong offset!");
