...
// const class FString&                    CellName                                               (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AReplicationGraphDebugActor::ClientCellInfo(const struct FVector& CellLocation, float CellSize, const TArray<class AActor*>& Actors, const class FString& CellName)
{
	...
	Parms.CellName = std::move(CellName);
