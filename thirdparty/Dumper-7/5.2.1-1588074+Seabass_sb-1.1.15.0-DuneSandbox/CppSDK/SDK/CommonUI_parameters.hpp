...
// Function CommonUI.CommonVisualAttachment.SetContentAnchor
// 0x0010 (0x0010 - 0x0000)
struct CommonVisualAttachment_SetContentAnchor final
{
public:
	struct FVector2D                              NewContentAnchor;                                  // 0x0000(0x0010)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonVisualAttachment_SetContentAnchor) == 0x000008, "Wrong alignment on CommonVisualAttachment_SetContentAnchor");
static_assert(sizeof(CommonVisualAttachment_SetContentAnchor) == 0x000010, "Wrong size on CommonVisualAttachment_SetContentAnchor");
static_assert(offsetof(CommonVisualAttachment_SetContentAnchor, NewContentAnchor) == 0x000000, "Member 'CommonVisualAttachment_SetContentAnchor::NewContentAnchor' has a wrong offset!");

// Function CommonUI.CommonVisualAttachment.GetContentAnchor
// 0x0010 (0x0010 - 0x0000)
struct CommonVisualAttachment_GetContentAnchor final
{
public:
...
static_assert(alignof(CommonVisualAttachment_GetContentAnchor) == 0x000008, "Wrong alignment on CommonVisualAttachment_GetContentAnchor");
static_assert(sizeof(CommonVisualAttachment_GetContentAnchor) == 0x000010, "Wrong size on CommonVisualAttachment_GetContentAnchor");
static_assert(offsetof(CommonVisualAttachment_GetContentAnchor, ReturnValue) == 0x000000, "Member 'CommonVisualAttachment_GetContentAnchor::ReturnValue' has a wrong offset!");
