...
{
public:
	uint8                                         bUseLegacyProcessor : 1;                           // 0x0040(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUse32fLUT : 1;                                    // 0x0040(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSupportInverseViewTransforms : 1;                 // 0x0040(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UOpenColorIOSettings) == 0x000048, "Wrong size on UOpenColorIOSettings");
...
static_assert(offsetof(UOpenColorIOColorTransform, ConfigurationOwner) == 0x000030, "Member 'UOpenColorIOColorTransform::ConfigurationOwner' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, bIsDisplayViewType) == 0x000038, "Member 'UOpenColorIOColorTransform::bIsDisplayViewType' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, SourceColorSpace) == 0x000040, "Member 'UOpenColorIOColorTransform::SourceColorSpace' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, DestinationColorSpace) == 0x000050, "Member 'UOpenColorIOColorTransform::DestinationColorSpace' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, Display) == 0x000060, "Member 'UOpenColorIOColorTransform::Display' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, View) == 0x000070, "Member 'UOpenColorIOColorTransform::View' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, DisplayViewDirection) == 0x000080, "Member 'UOpenColorIOColorTransform::DisplayViewDirection' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, Textures) == 0x000088, "Member 'UOpenColorIOColorTransform::Textures' has a wrong offset!");
...
static_assert(sizeof(UOpenColorIOConfiguration) == 0x0000A0, "Wrong size on UOpenColorIOConfiguration");
