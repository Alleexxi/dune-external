...
{
public:
	static void EnableXeSS(bool bEnabled);
	...
	static float GetXeSSDefaultModePercentage(EXeSSQualityMode QualityMode);
	...
	static void UpdateResolutionMetrics(EXeSSQualityMode QualityMode, float TargetPercentage);
