...
{
public:
	bool                                          bPhysicsSimulationEnabled;                         // 0x00C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_D8[0x128];                                     // 0x00D8(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicsAsset*                          UsePhysicsAsset;                                   // 0x0200(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FBoneReference                         BaseBoneRef;                                       // 0x02E4(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bForceDisableCollisionBetweenConstraintBodies;     // 0x02F6(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseExternalClothCollision;                        // 0x02F7(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F8[0x1];                                      // 0x02F8(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bEnableWorldGeometry : 1;                          // 0x02F9(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideWorldGravity : 1;                         // 0x02F9(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTransferBoneVelocities : 1;                       // 0x02F9(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFreezeIncomingPoseOnStart : 1;                    // 0x02F9(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bClampLinearTranslationLimitToRefPose : 1;         // 0x02F9(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         Pad_304[0x1];                                      // 0x0304(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	ESimulationTiming                             SimulationTiming;                                  // 0x0305(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_306[0x6BA];                                    // 0x0306(0x06BA)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x0009C0, "Wrong size on FAnimNode_RigidBody");
static_assert(offsetof(FAnimNode_RigidBody, bPhysicsSimulationEnabled) == 0x0000C8, "Member 'FAnimNode_RigidBody::bPhysicsSimulationEnabled' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RigidBody, UsePhysicsAsset) == 0x000200, "Member 'FAnimNode_RigidBody::UsePhysicsAsset' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0002F4, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0002F5, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x0002F6, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bUseExternalClothCollision) == 0x0002F7, "Member 'FAnimNode_RigidBody::bUseExternalClothCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceMinimumScale) == 0x0002FC, "Member 'FAnimNode_RigidBody::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, EvaluationResetTime) == 0x000300, "Member 'FAnimNode_RigidBody::EvaluationResetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationTiming) == 0x000305, "Member 'FAnimNode_RigidBody::SimulationTiming' has a wrong offset!");
...
// ScriptStruct AnimGraphRuntime.AnimNode_LayeredBoneBlendSequential
// 0x00D0 (0x00E0 - 0x0010)
struct FAnimNode_LayeredBoneBlendSequential final : public FAnimNode_Base
{
public:
	...
	TArray<struct FPerBoneBlendWeights>           PerBoneBlendWeights;                               // 0x0078(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(alignof(FAnimNode_LayeredBoneBlendSequential) == 0x000008, "Wrong alignment on FAnimNode_LayeredBoneBlendSequential");
static_assert(sizeof(FAnimNode_LayeredBoneBlendSequential) == 0x0000E0, "Wrong size on FAnimNode_LayeredBoneBlendSequential");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, BasePose) == 0x000010, "Member 'FAnimNode_LayeredBoneBlendSequential::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, BlendPoses) == 0x000020, "Member 'FAnimNode_LayeredBoneBlendSequential::BlendPoses' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, BlendMode) == 0x000030, "Member 'FAnimNode_LayeredBoneBlendSequential::BlendMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, BlendMasks) == 0x000038, "Member 'FAnimNode_LayeredBoneBlendSequential::BlendMasks' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, LayerSetup) == 0x000048, "Member 'FAnimNode_LayeredBoneBlendSequential::LayerSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, BlendWeights) == 0x000058, "Member 'FAnimNode_LayeredBoneBlendSequential::BlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, bMeshSpaceRotationBlend) == 0x000068, "Member 'FAnimNode_LayeredBoneBlendSequential::bMeshSpaceRotationBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, bMeshSpaceScaleBlend) == 0x000069, "Member 'FAnimNode_LayeredBoneBlendSequential::bMeshSpaceScaleBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, CurveBlendOption) == 0x00006A, "Member 'FAnimNode_LayeredBoneBlendSequential::CurveBlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, bBlendRootMotionBasedOnRootBone) == 0x00006B, "Member 'FAnimNode_LayeredBoneBlendSequential::bBlendRootMotionBasedOnRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, LODThreshold) == 0x000070, "Member 'FAnimNode_LayeredBoneBlendSequential::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, PerBoneBlendWeights) == 0x000078, "Member 'FAnimNode_LayeredBoneBlendSequential::PerBoneBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, SkeletonGuid) == 0x000088, "Member 'FAnimNode_LayeredBoneBlendSequential::SkeletonGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlendSequential, VirtualBoneGuid) == 0x000098, "Member 'FAnimNode_LayeredBoneBlendSequential::VirtualBoneGuid' has a wrong offset!");
...
{
public:
	int32                                         ResetInternalTimeCounter;                          // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         InternalResetInternalTimeCounter;                  // 0x003C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FAnimNode_BlendSpacePlayerBase, ResetInternalTimeCounter) == 0x000038, "Member 'FAnimNode_BlendSpacePlayerBase::ResetInternalTimeCounter' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayerBase, InternalResetInternalTimeCounter) == 0x00003C, "Member 'FAnimNode_BlendSpacePlayerBase::InternalResetInternalTimeCounter' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayerBase, PreviousBlendSpace) == 0x000068, "Member 'FAnimNode_BlendSpacePlayerBase::PreviousBlendSpace' has a wrong offset!");
...
// 0x0460 (0x0CF0 - 0x0890)
struct FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_888[0x468];                                    // 0x0888(0x0468)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000CF0, "Wrong size on FAnimSequencerInstanceProxy");
