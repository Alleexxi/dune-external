...
{
public:
	class UComputeGraph*                          ComputeGraph;                                      // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FComputeGraphInstance                  ComputeGraphInstance;                              // 0x0130(0x0018)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UComputeGraphComponent) == 0x000148, "Wrong size on UComputeGraphComponent");
static_assert(offsetof(UComputeGraphComponent, ComputeGraph) == 0x000128, "Member 'UComputeGraphComponent::ComputeGraph' has a wrong offset!");
static_assert(offsetof(UComputeGraphComponent, ComputeGraphInstance) == 0x000130, "Member 'UComputeGraphComponent::ComputeGraphInstance' has a wrong offset!");
