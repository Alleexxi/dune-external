...
{
public:
	class UDataflowComponent*                     DataflowComponent;                                 // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADataflowActor) == 0x000358, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x000350, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_630[0x140];                                    // 0x0630(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDataflowComponent) == 0x000770, "Wrong size on UDataflowComponent");
