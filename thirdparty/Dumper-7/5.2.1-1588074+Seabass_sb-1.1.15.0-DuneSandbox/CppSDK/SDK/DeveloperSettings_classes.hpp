...
static_assert(sizeof(UDeveloperSettingsBackedByCVars) == 0x000040, "Wrong size on UDeveloperSettingsBackedByCVars");
...
static_assert(sizeof(UPlatformSettings) == 0x000048, "Wrong size on UPlatformSettings");
...
static_assert(sizeof(UPlatformSettingsManager) == 0x000088, "Wrong size on UPlatformSettingsManager");
