...
float UDLSSLibrary::GetDLSSDefaultModePercentage(EUDLSSMode DLSSMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DLSSLibrary", "GetDLSSDefaultModePercentage");

	Params::DLSSLibrary_GetDLSSDefaultModePercentage Parms{};
...
// Parameters:
// EUDLSSMode                              QualityMode                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UDLSSLibrary::UpdateResolutionMetrics(EUDLSSMode QualityMode, float TargetPercentage, const struct FIntPoint& Resolution)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DLSSLibrary", "UpdateResolutionMetrics");

	Params::DLSSLibrary_UpdateResolutionMetrics Parms{};
