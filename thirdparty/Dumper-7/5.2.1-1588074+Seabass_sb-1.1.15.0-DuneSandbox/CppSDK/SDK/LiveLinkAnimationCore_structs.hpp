...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0888(0x0048)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLiveLinkInstanceProxy) == 0x000010, "Wrong alignment on FLiveLinkInstanceProxy");
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x0008D0, "Wrong size on FLiveLinkInstanceProxy");
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x000888, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
