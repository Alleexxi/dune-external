...
public:
	...
	struct FGameplayTagQuery                      TagQueryExportText_Helper;                         // 0x0058(0x0048)(HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0248(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayTagsManager) == 0x000258, "Wrong size on UGameplayTagsManager");
...
static_assert(offsetof(UGameplayTagsManager, GameplayTagTables) == 0x000248, "Member 'UGameplayTagsManager::GameplayTagTables' has a wrong offset!");
...
public:
	...
	class FName                                   FavoriteTagSource;                                 // 0x0050(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTagsDeveloperSettings) == 0x000058, "Wrong size on UGameplayTagsDeveloperSettings");
...
static_assert(offsetof(UGameplayTagsDeveloperSettings, FavoriteTagSource) == 0x000050, "Member 'UGameplayTagsDeveloperSettings::FavoriteTagSource' has a wrong offset!");
