...
public:
	...
	struct FCommonInputTypeInfo                   KeyboardInputTypeInfo;                             // 0x0050(0x00F0)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   DefaultGamepadInputTypeInfo;                       // 0x0140(0x00F0)(Edit, Protected, NativeAccessSpecifierProtected)
	...
	struct FCommonInputTypeInfo                   TouchInputTypeInfo;                                // 0x0280(0x00F0)(Edit, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FCommonInputActionDataBase) == 0x000010, "Wrong alignment on FCommonInputActionDataBase");
static_assert(sizeof(FCommonInputActionDataBase) == 0x000370, "Wrong size on FCommonInputActionDataBase");
