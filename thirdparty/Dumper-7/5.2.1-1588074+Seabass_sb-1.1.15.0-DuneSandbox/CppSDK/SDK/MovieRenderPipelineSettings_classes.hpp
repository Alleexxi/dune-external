...
static_assert(sizeof(UMoviePipelineBurnInWidget) == 0x000288, "Wrong size on UMoviePipelineBurnInWidget");
...
public:
	...
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x00A0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMoviePipelineBurnInWidget*>     BurnInWidgetInstances;                             // 0x00A8(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineBurnInSetting) == 0x0000B8, "Wrong size on UMoviePipelineBurnInSetting");
...
static_assert(offsetof(UMoviePipelineBurnInSetting, BurnInWidgetInstances) == 0x0000A8, "Member 'UMoviePipelineBurnInSetting::BurnInWidgetInstances' has a wrong offset!");
