...
public:
	...
	float                                         CellSize;                                          // 0x0018(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         Actors;                                            // 0x0020(0x0010)(ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	class FString                                 CellName;                                          // 0x0030(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(ReplicationGraphDebugActor_ClientCellInfo, CellSize) == 0x000018, "Member 'ReplicationGraphDebugActor_ClientCellInfo::CellSize' has a wrong offset!");
static_assert(offsetof(ReplicationGraphDebugActor_ClientCellInfo, Actors) == 0x000020, "Member 'ReplicationGraphDebugActor_ClientCellInfo::Actors' has a wrong offset!");
static_assert(offsetof(ReplicationGraphDebugActor_ClientCellInfo, CellName) == 0x000030, "Member 'ReplicationGraphDebugActor_ClientCellInfo::CellName' has a wrong offset!");
