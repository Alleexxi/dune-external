...
// Function DLSSBlueprint.DLSSLibrary.GetDLSSDefaultModePercentage
// 0x0008 (0x0008 - 0x0000)
struct DLSSLibrary_GetDLSSDefaultModePercentage final
{
public:
...
static_assert(alignof(DLSSLibrary_GetDLSSDefaultModePercentage) == 0x000004, "Wrong alignment on DLSSLibrary_GetDLSSDefaultModePercentage");
static_assert(sizeof(DLSSLibrary_GetDLSSDefaultModePercentage) == 0x000008, "Wrong size on DLSSLibrary_GetDLSSDefaultModePercentage");
static_assert(offsetof(DLSSLibrary_GetDLSSDefaultModePercentage, DLSSMode) == 0x000000, "Member 'DLSSLibrary_GetDLSSDefaultModePercentage::DLSSMode' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSDefaultModePercentage, ReturnValue) == 0x000004, "Member 'DLSSLibrary_GetDLSSDefaultModePercentage::ReturnValue' has a wrong offset!");
...
// Function DLSSBlueprint.DLSSLibrary.UpdateResolutionMetrics
// 0x0010 (0x0010 - 0x0000)
struct DLSSLibrary_UpdateResolutionMetrics final
{
public:
	EUDLSSMode                                    QualityMode;                                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FIntPoint                              Resolution;                                        // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DLSSLibrary_UpdateResolutionMetrics) == 0x000004, "Wrong alignment on DLSSLibrary_UpdateResolutionMetrics");
static_assert(sizeof(DLSSLibrary_UpdateResolutionMetrics) == 0x000010, "Wrong size on DLSSLibrary_UpdateResolutionMetrics");
static_assert(offsetof(DLSSLibrary_UpdateResolutionMetrics, QualityMode) == 0x000000, "Member 'DLSSLibrary_UpdateResolutionMetrics::QualityMode' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_UpdateResolutionMetrics, TargetPercentage) == 0x000004, "Member 'DLSSLibrary_UpdateResolutionMetrics::TargetPercentage' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_UpdateResolutionMetrics, Resolution) == 0x000008, "Member 'DLSSLibrary_UpdateResolutionMetrics::Resolution' has a wrong offset!");
