...
// WidgetBlueprintGeneratedClass W_BuggyMiniPaperdoll.W_BuggyMiniPaperdoll_C
// 0x0080 (0x04E0 - 0x0460)
class UW_BuggyMiniPaperdoll_C final : public UVehicleModuleStatusWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_W_BuggyMiniPaperdoll(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"W_BuggyMiniPaperdoll_C">();
	}
	static class UW_BuggyMiniPaperdoll_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_BuggyMiniPaperdoll_C>();
	}
};
static_assert(alignof(UW_BuggyMiniPaperdoll_C) == 0x000010, "Wrong alignment on UW_BuggyMiniPaperdoll_C");
static_assert(sizeof(UW_BuggyMiniPaperdoll_C) == 0x0004E0, "Wrong size on UW_BuggyMiniPaperdoll_C");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, UberGraphFrame) == 0x000460, "Member 'UW_BuggyMiniPaperdoll_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, Chassi) == 0x000468, "Member 'UW_BuggyMiniPaperdoll_C::Chassi' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, HullFront) == 0x000470, "Member 'UW_BuggyMiniPaperdoll_C::HullFront' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, HullRear) == 0x000478, "Member 'UW_BuggyMiniPaperdoll_C::HullRear' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, LeftRearTread) == 0x000480, "Member 'UW_BuggyMiniPaperdoll_C::LeftRearTread' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, LeftTread) == 0x000488, "Member 'UW_BuggyMiniPaperdoll_C::LeftTread' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, RightRearTread) == 0x000490, "Member 'UW_BuggyMiniPaperdoll_C::RightRearTread' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, RightTread) == 0x000498, "Member 'UW_BuggyMiniPaperdoll_C::RightTread' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, Default_Color) == 0x0004A0, "Member 'UW_BuggyMiniPaperdoll_C::Default_Color' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, ShowText) == 0x0004B4, "Member 'UW_BuggyMiniPaperdoll_C::ShowText' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, VehicleImages) == 0x0004B8, "Member 'UW_BuggyMiniPaperdoll_C::VehicleImages' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, Image_Size) == 0x0004C8, "Member 'UW_BuggyMiniPaperdoll_C::Image_Size' has a wrong offset!");
static_assert(offsetof(UW_BuggyMiniPaperdoll_C, Current_Vehicle_Module) == 0x0004D8, "Member 'UW_BuggyMiniPaperdoll_C::Current_Vehicle_Module' has a wrong offset!");
