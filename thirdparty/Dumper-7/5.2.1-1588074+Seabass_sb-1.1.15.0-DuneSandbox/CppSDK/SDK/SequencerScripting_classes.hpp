...
{
public:
	class FName                                   ChannelName;                                       // 0x0030(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneScriptingChannel) == 0x000038, "Wrong size on UMovieSceneScriptingChannel");
...
static_assert(sizeof(UMovieSceneScriptingActorReferenceChannel) == 0x000068, "Wrong size on UMovieSceneScriptingActorReferenceChannel");
...
static_assert(sizeof(UMovieSceneScriptingBoolChannel) == 0x000068, "Wrong size on UMovieSceneScriptingBoolChannel");
...
static_assert(sizeof(UMovieSceneScriptingByteChannel) == 0x000068, "Wrong size on UMovieSceneScriptingByteChannel");
...
static_assert(sizeof(UMovieSceneScriptingDoubleChannel) == 0x000068, "Wrong size on UMovieSceneScriptingDoubleChannel");
...
static_assert(sizeof(UMovieSceneScriptingEventChannel) == 0x000068, "Wrong size on UMovieSceneScriptingEventChannel");
...
static_assert(sizeof(UMovieSceneScriptingFloatChannel) == 0x000088, "Wrong size on UMovieSceneScriptingFloatChannel");
...
static_assert(sizeof(UMovieSceneScriptingIntegerChannel) == 0x000068, "Wrong size on UMovieSceneScriptingIntegerChannel");
...
static_assert(sizeof(UMovieSceneScriptingObjectPathChannel) == 0x000068, "Wrong size on UMovieSceneScriptingObjectPathChannel");
...
static_assert(sizeof(UMovieSceneScriptingStringChannel) == 0x000068, "Wrong size on UMovieSceneScriptingStringChannel");
