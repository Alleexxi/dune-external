...
static_assert(sizeof(UAnimNotify_PlayMontageNotify) == 0x000048, "Wrong size on UAnimNotify_PlayMontageNotify");
...
static_assert(sizeof(UAnimNotify_PlayMontageNotifyWindow) == 0x000040, "Wrong size on UAnimNotify_PlayMontageNotifyWindow");
...
class alignas(0x10) UPlayMontageCallbackProxy final : public UObject
{
public:
...
static_assert(alignof(UPlayMontageCallbackProxy) == 0x000010, "Wrong alignment on UPlayMontageCallbackProxy");
