...
static_assert(sizeof(UMovieSceneInterrogatedPropertyInstantiatorSystem) == 0x000230, "Wrong size on UMovieSceneInterrogatedPropertyInstantiatorSystem");
...
static_assert(sizeof(UMovieSceneCinematicShotSection) == 0x000168, "Wrong size on UMovieSceneCinematicShotSection");
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x00F8(0x0138)(NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   SlotName;                                          // 0x0270(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                StartLocationOffset;                               // 0x0278(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               StartRotationOffset;                               // 0x0290(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bMatchWithPrevious;                                // 0x02A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A9[0x3];                                      // 0x02A9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   MatchedBoneName;                                   // 0x02AC(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bMatchTranslation;                                 // 0x02E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchIncludeZHeight;                              // 0x02E9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationYaw;                                 // 0x02EA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationPitch;                               // 0x02EB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMatchRotationRoll;                                // 0x02EC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2ED[0x73];                                     // 0x02ED(0x0073)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartLocationOffset) == 0x000278, "Member 'UMovieSceneSkeletalAnimationSection::StartLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartRotationOffset) == 0x000290, "Member 'UMovieSceneSkeletalAnimationSection::StartRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchWithPrevious) == 0x0002A8, "Member 'UMovieSceneSkeletalAnimationSection::bMatchWithPrevious' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedBoneName) == 0x0002AC, "Member 'UMovieSceneSkeletalAnimationSection::MatchedBoneName' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchTranslation) == 0x0002E8, "Member 'UMovieSceneSkeletalAnimationSection::bMatchTranslation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchIncludeZHeight) == 0x0002E9, "Member 'UMovieSceneSkeletalAnimationSection::bMatchIncludeZHeight' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationYaw) == 0x0002EA, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationYaw' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationPitch) == 0x0002EB, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationPitch' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationRoll) == 0x0002EC, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationRoll' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLevelVisibilitySystem) == 0x0001B0, "Wrong size on UMovieSceneLevelVisibilitySystem");
...
{
public:
	uint8                                         Pad_48[0x238];                                     // 0x0048(0x0238)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieScenePropertyInstantiatorSystem) == 0x000280, "Wrong size on UMovieScenePropertyInstantiatorSystem");
...
static_assert(sizeof(UMovieSceneQuaternionBlenderSystem) == 0x0000E0, "Wrong size on UMovieSceneQuaternionBlenderSystem");
...
static_assert(sizeof(UMovieSceneHierarchicalEasingInstantiatorSystem) == 0x000088, "Wrong size on UMovieSceneHierarchicalEasingInstantiatorSystem");
static_assert(offsetof(UMovieSceneHierarchicalEasingInstantiatorSystem, EvaluatorSystem) == 0x000080, "Member 'UMovieSceneHierarchicalEasingInstantiatorSystem::EvaluatorSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneAudioTrack) == 0x0000B8, "Wrong size on UMovieSceneAudioTrack");
static_assert(offsetof(UMovieSceneAudioTrack, AudioSections) == 0x0000A8, "Member 'UMovieSceneAudioTrack::AudioSections' has a wrong offset!");
...
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialIndex) == 0x0000D0, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialIndex' has a wrong offset!");
