...
public:
	...
	struct FVector                                NewCameraLocation;                                 // 0x0008(0x0018)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PreviousCameraLocation;                            // 0x0020(0x0018)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                OriginalCameraLocation;                            // 0x0038(0x0018)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                OutCameraLocation;                                 // 0x0050(0x0018)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDistance;                                       // 0x0068(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AnselFunctionLibrary_ConstrainCameraByDistance) == 0x000070, "Wrong size on AnselFunctionLibrary_ConstrainCameraByDistance");
...
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByDistance, PreviousCameraLocation) == 0x000020, "Member 'AnselFunctionLibrary_ConstrainCameraByDistance::PreviousCameraLocation' has a wrong offset!");
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByDistance, OriginalCameraLocation) == 0x000038, "Member 'AnselFunctionLibrary_ConstrainCameraByDistance::OriginalCameraLocation' has a wrong offset!");
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByDistance, OutCameraLocation) == 0x000050, "Member 'AnselFunctionLibrary_ConstrainCameraByDistance::OutCameraLocation' has a wrong offset!");
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByDistance, MaxDistance) == 0x000068, "Member 'AnselFunctionLibrary_ConstrainCameraByDistance::MaxDistance' has a wrong offset!");
...
static_assert(sizeof(AnselFunctionLibrary_ConstrainCameraByGeometry) == 0x000068, "Wrong size on AnselFunctionLibrary_ConstrainCameraByGeometry");
...
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByGeometry, PreviousCameraLocation) == 0x000020, "Member 'AnselFunctionLibrary_ConstrainCameraByGeometry::PreviousCameraLocation' has a wrong offset!");
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByGeometry, OriginalCameraLocation) == 0x000038, "Member 'AnselFunctionLibrary_ConstrainCameraByGeometry::OriginalCameraLocation' has a wrong offset!");
static_assert(offsetof(AnselFunctionLibrary_ConstrainCameraByGeometry, OutCameraLocation) == 0x000050, "Member 'AnselFunctionLibrary_ConstrainCameraByGeometry::OutCameraLocation' has a wrong offset!");
