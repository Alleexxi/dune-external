...
static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000130, "Wrong size on UAnimationCompressionLibraryDatabase");
...
static_assert(offsetof(UAnimationCompressionLibraryDatabase, MaxStreamRequestSizeKB) == 0x000128, "Member 'UAnimationCompressionLibraryDatabase::MaxStreamRequestSizeKB' has a wrong offset!");
static_assert(offsetof(UAnimationCompressionLibraryDatabase, DefaultVisualFidelity) == 0x00012C, "Member 'UAnimationCompressionLibraryDatabase::DefaultVisualFidelity' has a wrong offset!");
