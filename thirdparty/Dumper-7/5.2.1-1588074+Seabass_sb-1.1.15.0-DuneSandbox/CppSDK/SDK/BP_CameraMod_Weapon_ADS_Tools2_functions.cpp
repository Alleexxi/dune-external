...
#include "BP_CameraMod_Weapon_ADS_Tools2_classes.hpp"
#include "BP_CameraMod_Weapon_ADS_Tools2_parameters.hpp"
...
void UBP_CameraMod_Weapon_ADS_Tools2_C::BlueprintModifyCamera(float DeltaTime, const struct FVector& ViewLocation, const struct FRotator& ViewRotation, float FOV, struct FVector* NewViewLocation, struct FRotator* NewViewRotation, float* NewFOV)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CameraMod_Weapon_ADS_Tools2_C", "BlueprintModifyCamera");

	Params::BP_CameraMod_Weapon_ADS_Tools2_C_BlueprintModifyCamera Parms{};
