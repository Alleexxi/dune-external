...
{
public:
	TArray<TSoftClassPtr<class UClass>>           InputData;                                         // 0x0048(0x0010)(Edit, ZeroConstructor, Config, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<TSubclassOf<class UEnhancedInputPlatformData>> InputDataClasses;                          // 0x0058(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	bool                                          bShouldLogMappingContextRedirects;                 // 0x0068(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnhancedInputPlatformSettings) == 0x000070, "Wrong size on UEnhancedInputPlatformSettings");
static_assert(offsetof(UEnhancedInputPlatformSettings, InputData) == 0x000048, "Member 'UEnhancedInputPlatformSettings::InputData' has a wrong offset!");
static_assert(offsetof(UEnhancedInputPlatformSettings, InputDataClasses) == 0x000058, "Member 'UEnhancedInputPlatformSettings::InputDataClasses' has a wrong offset!");
static_assert(offsetof(UEnhancedInputPlatformSettings, bShouldLogMappingContextRedirects) == 0x000068, "Member 'UEnhancedInputPlatformSettings::bShouldLogMappingContextRedirects' has a wrong offset!");
...
static_assert(sizeof(UEnhancedInputComponent) == 0x0001E8, "Wrong size on UEnhancedInputComponent");
...
{
public:
	TArray<struct FDefaultContextSetting>         DefaultMappingContexts;                            // 0x0040(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<struct FDefaultContextSetting>         DefaultWorldSubsystemMappingContexts;              // 0x0050(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   DefaultWorldInputClass;                            // 0x0060(0x0030)(Edit, Config, NoClear, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPerPlatformSettings                   PlatformSettings;                                  // 0x0090(0x0010)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         bEnableDefaultMappingContexts : 1;                 // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldOnlyTriggerLastActionInChord : 1;           // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableWorldSubsystem : 1;                         // 0x00A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldLogAllWorldSubsystemInputs : 1;             // 0x00A0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UEnhancedInputDeveloperSettings) == 0x0000A8, "Wrong size on UEnhancedInputDeveloperSettings");
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultMappingContexts) == 0x000040, "Member 'UEnhancedInputDeveloperSettings::DefaultMappingContexts' has a wrong offset!");
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultWorldSubsystemMappingContexts) == 0x000050, "Member 'UEnhancedInputDeveloperSettings::DefaultWorldSubsystemMappingContexts' has a wrong offset!");
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultWorldInputClass) == 0x000060, "Member 'UEnhancedInputDeveloperSettings::DefaultWorldInputClass' has a wrong offset!");
static_assert(offsetof(UEnhancedInputDeveloperSettings, PlatformSettings) == 0x000090, "Member 'UEnhancedInputDeveloperSettings::PlatformSettings' has a wrong offset!");
...
public:
	...
	bool IsWaitingForMappingRebuild() const;
...
// 0x0300 (0x07A0 - 0x04A0)
class UEnhancedPlayerInput : public UPlayerInput
{
public:
	TMap<class UInputMappingContext*, int32>      AppliedInputContexts;                              // 0x04A0(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_730[0x70];                                     // 0x0730(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x0007A0, "Wrong size on UEnhancedPlayerInput");
...
public:
	...
	TArray<class UInputAction*>                   ConsumeInputWhitelist;                             // 0x0078(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class UPlayerMappableKeySettings*             PlayerMappableKeySettings;                         // 0x0088(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UInputAction) == 0x000090, "Wrong size on UInputAction");
...
static_assert(offsetof(UInputAction, ConsumeInputWhitelist) == 0x000078, "Member 'UInputAction::ConsumeInputWhitelist' has a wrong offset!");
static_assert(offsetof(UInputAction, PlayerMappableKeySettings) == 0x000088, "Member 'UInputAction::PlayerMappableKeySettings' has a wrong offset!");
...
{
public:
	class FName                                   ConfigName;                                        // 0x0038(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FText                                   ConfigDisplayName;                                 // 0x0040(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	...
	class UObject*                                MetaData;                                          // 0x0060(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPlayerMappableInputConfig) == 0x0000B8, "Wrong size on UPlayerMappableInputConfig");
...
static_assert(offsetof(UPlayerMappableInputConfig, ConfigDisplayName) == 0x000040, "Member 'UPlayerMappableInputConfig::ConfigDisplayName' has a wrong offset!");
static_assert(offsetof(UPlayerMappableInputConfig, bIsDeprecated) == 0x000058, "Member 'UPlayerMappableInputConfig::bIsDeprecated' has a wrong offset!");
static_assert(offsetof(UPlayerMappableInputConfig, MetaData) == 0x000060, "Member 'UPlayerMappableInputConfig::MetaData' has a wrong offset!");
static_assert(offsetof(UPlayerMappableInputConfig, Contexts) == 0x000068, "Member 'UPlayerMappableInputConfig::Contexts' has a wrong offset!");
...
static_assert(sizeof(UPlayerMappableKeySettings) == 0x000070, "Wrong size on UPlayerMappableKeySettings");
...
static_assert(offsetof(UPlayerMappableKeySettings, DisplayName) == 0x000040, "Member 'UPlayerMappableKeySettings::DisplayName' has a wrong offset!");
static_assert(offsetof(UPlayerMappableKeySettings, DisplayCategory) == 0x000058, "Member 'UPlayerMappableKeySettings::DisplayCategory' has a wrong offset!");
