...
// Enum GameplayAbilities.EVelocityChangeState
// NumValues: 0x0004
enum class EVelocityChangeState : uint8
{
	Uninitialized                            = 0,
	Under                                    = 1,
	Over                                     = 2,
	EVelocityChangeState_MAX                 = 3,
};
...
enum class EGameplayEffectStackingExpirationPolicy : uint8
{
	...
	RefreshDuration                          = 2,
	RemoveStackCountBasedOnAttribute         = 3,
...
{
public:
	struct FGameplayAttribute                     AttributeToCapture;                                // 0x0000(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bUseFixedStepPeriod;                               // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ChanceToApplyToTarget;                             // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayEffectSpec, bUseFixedStepPeriod) == 0x000058, "Member 'FGameplayEffectSpec::bUseFixedStepPeriod' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, ChanceToApplyToTarget) == 0x00005C, "Member 'FGameplayEffectSpec::ChanceToApplyToTarget' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectSpec                    Spec;                                              // 0x0020(0x0298)(NativeAccessSpecifierPublic)
	struct FPredictionKey                         PredictionKey;                                     // 0x02B8(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FReplicatedPredictionKeyItem>   PredictionKeys;                                    // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FReplicatedPredictionKeyMap) == 0x000008, "Wrong alignment on FReplicatedPredictionKeyMap");
static_assert(sizeof(FReplicatedPredictionKeyMap) == 0x000138, "Wrong size on FReplicatedPredictionKeyMap");
static_assert(offsetof(FReplicatedPredictionKeyMap, PredictionKeys) == 0x000128, "Member 'FReplicatedPredictionKeyMap::PredictionKeys' has a wrong offset!");
...
public:
	int32                                         Handle;                                            // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int16                                         HandleServerIndex;                                 // 0x0004(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bPassedFiltersAndWasExecuted : 1;                  // 0x0006(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_7[0x1];                                        // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UAbilitySystemComponent> AbilitySystemComponent;                            // 0x0008(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FActiveGameplayEffectHandle) == 0x000004, "Wrong alignment on FActiveGameplayEffectHandle");
static_assert(sizeof(FActiveGameplayEffectHandle) == 0x000010, "Wrong size on FActiveGameplayEffectHandle");
...
static_assert(offsetof(FActiveGameplayEffectHandle, HandleServerIndex) == 0x000004, "Member 'FActiveGameplayEffectHandle::HandleServerIndex' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffectHandle, AbilitySystemComponent) == 0x000008, "Member 'FActiveGameplayEffectHandle::AbilitySystemComponent' has a wrong offset!");
...
public:
	...
	TArray<class UGameplayAbility*>               LocalReplicatedInstances;                          // 0x0090(0x0010)(ZeroConstructor, RepSkip, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FActiveGameplayEffectHandle            GameplayEffectHandle;                              // 0x00A0(0x0010)(RepSkip, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<struct FGameplayTag, float>              SetByCallerTagMagnitudes;                          // 0x00B0(0x0050)(RepSkip, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayAbilitySpec) == 0x000008, "Wrong alignment on FGameplayAbilitySpec");
static_assert(sizeof(FGameplayAbilitySpec) == 0x000100, "Wrong size on FGameplayAbilitySpec");
...
static_assert(offsetof(FGameplayAbilitySpec, LocalReplicatedInstances) == 0x000090, "Member 'FGameplayAbilitySpec::LocalReplicatedInstances' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilitySpec, SetByCallerTagMagnitudes) == 0x0000B0, "Member 'FGameplayAbilitySpec::SetByCallerTagMagnitudes' has a wrong offset!");
...
{
public:
	TArray<struct FGameplayAbilitySpec>           Items;                                             // 0x0128(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class UAbilitySystemComponent*                Owner;                                             // 0x0138(0x0008)(ExportObject, ZeroConstructor, InstancedReference, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayAbilitySpecContainer) == 0x000008, "Wrong alignment on FGameplayAbilitySpecContainer");
static_assert(sizeof(FGameplayAbilitySpecContainer) == 0x000140, "Wrong size on FGameplayAbilitySpecContainer");
static_assert(offsetof(FGameplayAbilitySpecContainer, Items) == 0x000128, "Member 'FGameplayAbilitySpecContainer::Items' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecContainer, Owner) == 0x000138, "Member 'FGameplayAbilitySpecContainer::Owner' has a wrong offset!");
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         BaseValue;                                         // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CurrentValue;                                      // 0x000C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
...
// ScriptStruct GameplayAbilities.ExternalGameplayAttributeData
// 0x0010 (0x0020 - 0x0010)
struct FExternalGameplayAttributeData : public FGameplayAttributeData
{
public:
	uint8                                         Pad_10[0x10];                                      // 0x0010(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FExternalGameplayAttributeData) == 0x000008, "Wrong alignment on FExternalGameplayAttributeData");
static_assert(sizeof(FExternalGameplayAttributeData) == 0x000020, "Wrong size on FExternalGameplayAttributeData");
...
public:
	...
	class UObjectLibrary*                         ActorObjectLibrary;                                // 0x0090(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObjectLibrary*                         StaticObjectLibrary;                               // 0x0098(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameplayCueSet*                        CueSet;                                            // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A8[0x4];                                       // 0x00A8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bShouldSyncScan;                                   // 0x00AC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldAsyncLoad;                                  // 0x00AD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldSyncLoad;                                   // 0x00AE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasBeenInitialized;                               // 0x00AF(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCueObjectLibrary) == 0x000010, "Wrong alignment on FGameplayCueObjectLibrary");
static_assert(sizeof(FGameplayCueObjectLibrary) == 0x0000B0, "Wrong size on FGameplayCueObjectLibrary");
...
static_assert(offsetof(FGameplayCueObjectLibrary, CueSet) == 0x0000A0, "Member 'FGameplayCueObjectLibrary::CueSet' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldSyncScan) == 0x0000AC, "Member 'FGameplayCueObjectLibrary::bShouldSyncScan' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldAsyncLoad) == 0x0000AD, "Member 'FGameplayCueObjectLibrary::bShouldAsyncLoad' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldSyncLoad) == 0x0000AE, "Member 'FGameplayCueObjectLibrary::bShouldSyncLoad' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bHasBeenInitialized) == 0x0000AF, "Member 'FGameplayCueObjectLibrary::bHasBeenInitialized' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FActiveGameplayEffect& Effect, bool* bMatches)> CustomMatchDelegate_BP; // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      OwningTagQuery;                                    // 0x0050(0x0048)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      EffectTagQuery;                                    // 0x0098(0x0048)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      SourceTagQuery;                                    // 0x00E0(0x0048)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayAttribute                     ModifyingAttribute;                                // 0x0128(0x0038)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                EffectSource;                                      // 0x0160(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UGameplayEffect>            EffectDefinition;                                  // 0x0168(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayEffectQuery) == 0x000180, "Wrong size on FGameplayEffectQuery");
...
static_assert(offsetof(FGameplayEffectQuery, EffectSource) == 0x000160, "Member 'FGameplayEffectQuery::EffectSource' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectDefinition) == 0x000168, "Member 'FGameplayEffectQuery::EffectDefinition' has a wrong offset!");
...
{
public:
	TArray<struct FActiveGameplayCue>             GameplayCues;                                      // 0x0128(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0x8];                                      // 0x0138(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                Owner;                                             // 0x0140(0x0008)(ExportObject, ZeroConstructor, InstancedReference, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FActiveGameplayCueContainer) == 0x000008, "Wrong alignment on FActiveGameplayCueContainer");
static_assert(sizeof(FActiveGameplayCueContainer) == 0x000148, "Wrong size on FActiveGameplayCueContainer");
static_assert(offsetof(FActiveGameplayCueContainer, GameplayCues) == 0x000128, "Member 'FActiveGameplayCueContainer::GameplayCues' has a wrong offset!");
static_assert(offsetof(FActiveGameplayCueContainer, Owner) == 0x000140, "Member 'FActiveGameplayCueContainer::Owner' has a wrong offset!");
...
public:
	...
	TArray<struct FActiveGameplayEffect>          GameplayEffects_Internal;                          // 0x0150(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_160[0x310];                                    // 0x0160(0x0310)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayEffect*>                ApplicationImmunityQueryEffects;                   // 0x0470(0x0010)(ZeroConstructor, RepSkip, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x000498, "Wrong size on FActiveGameplayEffectsContainer");
static_assert(offsetof(FActiveGameplayEffectsContainer, GameplayEffects_Internal) == 0x000150, "Member 'FActiveGameplayEffectsContainer::GameplayEffects_Internal' has a wrong offset!");
...
static_assert(sizeof(FActiveGameplayEffectQuery) == 0x0000C0, "Wrong size on FActiveGameplayEffectQuery");
...
public:
	...
	struct FActiveGameplayEffectHandle            Handle;                                            // 0x0040(0x0010)(NoDestructor, ContainsInstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayModifierEvaluatedData) == 0x000058, "Wrong size on FGameplayModifierEvaluatedData");
...
static_assert(offsetof(FGameplayModifierEvaluatedData, IsValid) == 0x000050, "Member 'FGameplayModifierEvaluatedData::IsValid' has a wrong offset!");
...
{
public:
	TArray<struct FGameplayModifierEvaluatedData> OutputModifiers;                                   // 0x0000(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
