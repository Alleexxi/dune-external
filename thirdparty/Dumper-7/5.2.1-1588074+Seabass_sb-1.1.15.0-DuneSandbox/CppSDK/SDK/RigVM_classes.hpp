...
static_assert(sizeof(URigVMHost) == 0x000188, "Wrong size on URigVMHost");
...
static_assert(offsetof(URigVMHost, DrawContainer) == 0x000068, "Member 'URigVMHost::DrawContainer' has a wrong offset!");
static_assert(offsetof(URigVMHost, EventQueue) == 0x000098, "Member 'URigVMHost::EventQueue' has a wrong offset!");
static_assert(offsetof(URigVMHost, AssetUserData) == 0x000138, "Member 'URigVMHost::AssetUserData' has a wrong offset!");
...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x0003E0, "Wrong size on URigVMBlueprintGeneratedClass");
static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x0003B8, "Member 'URigVMBlueprintGeneratedClass::GraphFunctionStore' has a wrong offset!");
...
public:
	...
	struct FRigVMUserWorkflow                     Workflow;                                          // 0x0040(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(alignof(URigVMUserWorkflowOptions) == 0x000010, "Wrong alignment on URigVMUserWorkflowOptions");
static_assert(sizeof(URigVMUserWorkflowOptions) == 0x000120, "Wrong size on URigVMUserWorkflowOptions");
...
static_assert(offsetof(URigVMUserWorkflowOptions, Workflow) == 0x000040, "Member 'URigVMUserWorkflowOptions::Workflow' has a wrong offset!");
...
public:
	...
	class URigVM*                                 DeferredVMToCopy;                                  // 0x03B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URigVM) == 0x0003F8, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, Instructions) == 0x000100, "Member 'URigVM::Instructions' has a wrong offset!");
static_assert(offsetof(URigVM, Context) == 0x000110, "Member 'URigVM::Context' has a wrong offset!");
static_assert(offsetof(URigVM, NumExecutions) == 0x000218, "Member 'URigVM::NumExecutions' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x000220, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Parameters) == 0x000268, "Member 'URigVM::Parameters' has a wrong offset!");
static_assert(offsetof(URigVM, ParametersNameMap) == 0x000278, "Member 'URigVM::ParametersNameMap' has a wrong offset!");
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0003B0, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
...
static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x0002A0, "Wrong size on URigVMMemoryStorageGeneratorClass");
...
static_assert(sizeof(URigVMNativized) == 0x000420, "Wrong size on URigVMNativized");
