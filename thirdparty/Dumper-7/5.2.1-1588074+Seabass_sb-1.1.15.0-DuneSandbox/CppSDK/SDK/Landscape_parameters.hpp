...
// Function Landscape.LandscapeProxy.SetLandscapeMaterialRuntimeVirtualTextureParameterValue
// 0x0010 (0x0010 - 0x0000)
struct LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue final
{
public:
	...
	class URuntimeVirtualTexture*                 Value;                                             // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue) == 0x000008, "Wrong alignment on LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue");
static_assert(sizeof(LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue) == 0x000010, "Wrong size on LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue");
static_assert(offsetof(LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue, ParameterName) == 0x000000, "Member 'LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue::ParameterName' has a wrong offset!");
static_assert(offsetof(LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue, Value) == 0x000008, "Member 'LandscapeProxy_SetLandscapeMaterialRuntimeVirtualTextureParameterValue::Value' has a wrong offset!");
...
// Function Landscape.LandscapeProxy.SetRuntimeVirtualTextureRenderPriority
// 0x0004 (0x0004 - 0x0000)
struct LandscapeProxy_SetRuntimeVirtualTextureRenderPriority final
{
public:
	int32                                         InRuntimeVirtualTextureRenderPriority;             // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(LandscapeProxy_SetRuntimeVirtualTextureRenderPriority) == 0x000004, "Wrong alignment on LandscapeProxy_SetRuntimeVirtualTextureRenderPriority");
static_assert(sizeof(LandscapeProxy_SetRuntimeVirtualTextureRenderPriority) == 0x000004, "Wrong size on LandscapeProxy_SetRuntimeVirtualTextureRenderPriority");
static_assert(offsetof(LandscapeProxy_SetRuntimeVirtualTextureRenderPriority, InRuntimeVirtualTextureRenderPriority) == 0x000000, "Member 'LandscapeProxy_SetRuntimeVirtualTextureRenderPriority::InRuntimeVirtualTextureRenderPriority' has a wrong offset!");
...
// Function Landscape.LandscapeProxy.GetRuntimeVirtualTextureRenderPriority
// 0x0004 (0x0004 - 0x0000)
struct LandscapeProxy_GetRuntimeVirtualTextureRenderPriority final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(LandscapeProxy_GetRuntimeVirtualTextureRenderPriority) == 0x000004, "Wrong alignment on LandscapeProxy_GetRuntimeVirtualTextureRenderPriority");
static_assert(sizeof(LandscapeProxy_GetRuntimeVirtualTextureRenderPriority) == 0x000004, "Wrong size on LandscapeProxy_GetRuntimeVirtualTextureRenderPriority");
static_assert(offsetof(LandscapeProxy_GetRuntimeVirtualTextureRenderPriority, ReturnValue) == 0x000000, "Member 'LandscapeProxy_GetRuntimeVirtualTextureRenderPriority::ReturnValue' has a wrong offset!");
