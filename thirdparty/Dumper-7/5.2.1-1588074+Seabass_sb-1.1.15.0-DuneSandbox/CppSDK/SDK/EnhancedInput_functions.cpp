...
bool IEnhancedInputSubsystemInterface::IsWaitingForMappingRebuild() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "IsWaitingForMappingRebuild");

	Params::EnhancedInputSubsystemInterface_IsWaitingForMappingRebuild Parms{};
