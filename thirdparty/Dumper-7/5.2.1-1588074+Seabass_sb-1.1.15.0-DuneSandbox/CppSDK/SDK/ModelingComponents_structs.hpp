...
public:
	...
	uint8                                         Pad_108[0x528];                                    // 0x0108(0x0528)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCreateMeshObjectParams) == 0x000010, "Wrong alignment on FCreateMeshObjectParams");
static_assert(sizeof(FCreateMeshObjectParams) == 0x000630, "Wrong size on FCreateMeshObjectParams");
