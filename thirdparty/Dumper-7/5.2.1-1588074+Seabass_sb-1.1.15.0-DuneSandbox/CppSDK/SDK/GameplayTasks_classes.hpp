...
public:
	...
	class FName                                   InstanceName;                                      // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_40[0x2];                                       // 0x0040(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	ETaskResourceOverlapPolicy                    ResourceOverlapPolicy;                             // 0x0042(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UGameplayTask, ResourceOverlapPolicy) == 0x000042, "Member 'UGameplayTask::ResourceOverlapPolicy' has a wrong offset!");
...
static_assert(sizeof(UGameplayTask_SpawnActor) == 0x0000C8, "Wrong size on UGameplayTask_SpawnActor");
...
static_assert(offsetof(UGameplayTask_SpawnActor, ClassToSpawn) == 0x0000C0, "Member 'UGameplayTask_SpawnActor::ClassToSpawn' has a wrong offset!");
...
{
public:
	uint8                                         Pad_128[0x14];                                     // 0x0128(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_13C_0 : 1;                                  // 0x013C(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x013C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  TaskPriorityQueue;                                 // 0x0140(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_150[0x10];                                     // 0x0150(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  TickingTasks;                                      // 0x0160(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  KnownTasks;                                        // 0x0170(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const struct FGameplayResourceSet& NewlyClaimed, const struct FGameplayResourceSet& FreshlyReleased)> OnClaimedResourcesChange; // 0x0180(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	TArray<class UGameplayTask*>                  SimulatedTasks;                                    // 0x0190(0x0010)(Net, ZeroConstructor, RepNotify, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x000180, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x000190, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
