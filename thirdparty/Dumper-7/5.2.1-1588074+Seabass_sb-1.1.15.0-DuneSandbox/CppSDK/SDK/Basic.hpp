...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0BE23920;
	constexpr int32 AppendString      = 0x052E8DC0;
	constexpr int32 GNames            = 0x0BD58600;
	constexpr int32 GWorld            = 0x0B9025B8;
	constexpr int32 ProcessEvent      = 0x054C1240;
