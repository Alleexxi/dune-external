...
static_assert(sizeof(UAudioPcmEncoderSettings) == 0x000040, "Wrong size on UAudioPcmEncoderSettings");
static_assert(offsetof(UAudioPcmEncoderSettings, BitDepthConversion) == 0x000038, "Member 'UAudioPcmEncoderSettings::BitDepthConversion' has a wrong offset!");
