...
void UNinjaLiveFunctions_C::CreateRenderTarget(int32 Width, int32 Height, ETextureRenderTargetFormat Format, bool Clamping, ETextureGroup LODGroup, ETextureFilter Filter, const struct FLinearColor& ClearColor, class UObject* __WorldContext, class UTextureRenderTarget2D** RTout)
{
	static class UFunction* Func = nullptr;
...
// ETextureFilter                          Filter                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FLinearColor&              ClearColor                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPixelFormat                            CustomFormat                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UTextureRenderTarget2D**          RTout                                                  (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UNinjaLiveFunctions_C::CreateRenderTargetCustomLinear(int32 Width, int32 Height, ETextureRenderTargetFormat Format, bool Clamping, ETextureGroup LODGroup, ETextureFilter Filter, const struct FLinearColor& ClearColor, EPixelFormat CustomFormat, class UObject* __WorldContext, class UTextureRenderTarget2D** RTout)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NinjaLiveFunctions_C", "CreateRenderTargetCustomLinear");

	Params::NinjaLiveFunctions_C_CreateRenderTargetCustomLinear Parms{};
	...
	Parms.Filter = Filter;
	Parms.ClearColor = std::move(ClearColor);
	Parms.CustomFormat = CustomFormat;
	Parms.__WorldContext = __WorldContext;
