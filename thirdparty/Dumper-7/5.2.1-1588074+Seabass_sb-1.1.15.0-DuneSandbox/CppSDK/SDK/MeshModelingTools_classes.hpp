...
static_assert(sizeof(UEditMeshPolygonsTool) == 0x000870, "Wrong size on UEditMeshPolygonsTool");
static_assert(offsetof(UEditMeshPolygonsTool, Preview) == 0x000138, "Member 'UEditMeshPolygonsTool::Preview' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, CommonProps) == 0x000140, "Member 'UEditMeshPolygonsTool::CommonProps' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditActions) == 0x000148, "Member 'UEditMeshPolygonsTool::EditActions' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditActions_Triangles) == 0x000150, "Member 'UEditMeshPolygonsTool::EditActions_Triangles' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditEdgeActions) == 0x000158, "Member 'UEditMeshPolygonsTool::EditEdgeActions' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditEdgeActions_Triangles) == 0x000160, "Member 'UEditMeshPolygonsTool::EditEdgeActions_Triangles' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditUVActions) == 0x000168, "Member 'UEditMeshPolygonsTool::EditUVActions' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, CancelAction) == 0x000170, "Member 'UEditMeshPolygonsTool::CancelAction' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, AcceptCancelAction) == 0x000178, "Member 'UEditMeshPolygonsTool::AcceptCancelAction' has a wrong offset!");
...
static_assert(offsetof(UEditMeshPolygonsTool, ActivityContext) == 0x0001F8, "Member 'UEditMeshPolygonsTool::ActivityContext' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SelectionMechanic) == 0x000200, "Member 'UEditMeshPolygonsTool::SelectionMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, DragAlignmentMechanic) == 0x000208, "Member 'UEditMeshPolygonsTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformGizmo) == 0x000210, "Member 'UEditMeshPolygonsTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformProxy) == 0x000218, "Member 'UEditMeshPolygonsTool::TransformProxy' has a wrong offset!");
...
static_assert(offsetof(UProceduralRectangleToolProperties, CornerRadius) == 0x0000D4, "Member 'UProceduralRectangleToolProperties::CornerRadius' has a wrong offset!");
static_assert(offsetof(UProceduralRectangleToolProperties, CornerSlices) == 0x0000D8, "Member 'UProceduralRectangleToolProperties::CornerSlices' has a wrong offset!");
...
static_assert(offsetof(UUVProjectionTool, UVChannelProperties) == 0x000118, "Member 'UUVProjectionTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, BasicProperties) == 0x000120, "Member 'UUVProjectionTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, EditActions) == 0x000128, "Member 'UUVProjectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, MaterialSettings) == 0x000130, "Member 'UUVProjectionTool::MaterialSettings' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, Preview) == 0x000138, "Member 'UUVProjectionTool::Preview' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, CheckerMaterial) == 0x000140, "Member 'UUVProjectionTool::CheckerMaterial' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, TransformGizmo) == 0x000148, "Member 'UUVProjectionTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, TransformProxy) == 0x000150, "Member 'UUVProjectionTool::TransformProxy' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, OperatorFactory) == 0x000158, "Member 'UUVProjectionTool::OperatorFactory' has a wrong offset!");
static_assert(offsetof(UUVProjectionTool, EdgeRenderer) == 0x000160, "Member 'UUVProjectionTool::EdgeRenderer' has a wrong offset!");
