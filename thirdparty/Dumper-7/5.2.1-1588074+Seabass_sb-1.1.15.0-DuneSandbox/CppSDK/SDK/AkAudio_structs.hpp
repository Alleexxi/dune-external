...
{
public:
	TSoftObjectPtr<class UAkAcousticTexture>      AcousticTexture;                                   // 0x0010(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FWwiseGeometrySurfacePropertiesRow) == 0x000048, "Wrong size on FWwiseGeometrySurfacePropertiesRow");
static_assert(offsetof(FWwiseGeometrySurfacePropertiesRow, AcousticTexture) == 0x000010, "Member 'FWwiseGeometrySurfacePropertiesRow::AcousticTexture' has a wrong offset!");
static_assert(offsetof(FWwiseGeometrySurfacePropertiesRow, TransmissionLoss) == 0x000040, "Member 'FWwiseGeometrySurfacePropertiesRow::TransmissionLoss' has a wrong offset!");
...
public:
	...
	uint32                                        ThreadStackSizeInMegabytes;                        // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        SamplesPerFrame;                                   // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint16                                        NumberOfRefillsInVoice;                            // 0x0044(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_46[0x2];                                       // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAkSpatialAudioSettings                SpatialAudioSettings;                              // 0x0048(0x002C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAkCommonInitializationSettings) == 0x000078, "Wrong size on FAkCommonInitializationSettings");
...
static_assert(offsetof(FAkCommonInitializationSettings, ThreadStackSizeInMegabytes) == 0x00000C, "Member 'FAkCommonInitializationSettings::ThreadStackSizeInMegabytes' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, SamplesPerFrame) == 0x000010, "Member 'FAkCommonInitializationSettings::SamplesPerFrame' has a wrong offset!");
...
static_assert(offsetof(FAkCommonInitializationSettings, NumberOfRefillsInVoice) == 0x000044, "Member 'FAkCommonInitializationSettings::NumberOfRefillsInVoice' has a wrong offset!");
static_assert(offsetof(FAkCommonInitializationSettings, SpatialAudioSettings) == 0x000048, "Member 'FAkCommonInitializationSettings::SpatialAudioSettings' has a wrong offset!");
...
{
public:
	uint32                                        SampleRate;                                        // 0x0078(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAkCommonInitializationSettingsWithSampleRate) == 0x000080, "Wrong size on FAkCommonInitializationSettingsWithSampleRate");
static_assert(offsetof(FAkCommonInitializationSettingsWithSampleRate, SampleRate) == 0x000078, "Member 'FAkCommonInitializationSettingsWithSampleRate::SampleRate' has a wrong offset!");
...
{
public:
	float                                         Decay;                                             // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UAkAuxBus>               AuxBus;                                            // 0x0018(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWwiseDecayAuxBusRow) == 0x000008, "Wrong alignment on FWwiseDecayAuxBusRow");
static_assert(sizeof(FWwiseDecayAuxBusRow) == 0x000048, "Wrong size on FWwiseDecayAuxBusRow");
static_assert(offsetof(FWwiseDecayAuxBusRow, Decay) == 0x000010, "Member 'FWwiseDecayAuxBusRow::Decay' has a wrong offset!");
static_assert(offsetof(FWwiseDecayAuxBusRow, AuxBus) == 0x000018, "Member 'FWwiseDecayAuxBusRow::AuxBus' has a wrong offset!");
