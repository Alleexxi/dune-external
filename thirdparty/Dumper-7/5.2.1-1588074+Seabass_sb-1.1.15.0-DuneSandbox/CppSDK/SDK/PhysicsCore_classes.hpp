...
public:
	...
	EPhysicsType                                  PhysicsType;                                       // 0x0038(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionTraceFlag                           CollisionTraceFlag;                                // 0x0039(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBodyCollisionResponse                        CollisionReponse;                                  // 0x003A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBodySetupCore, PhysicsType) == 0x000038, "Member 'UBodySetupCore::PhysicsType' has a wrong offset!");
static_assert(offsetof(UBodySetupCore, CollisionTraceFlag) == 0x000039, "Member 'UBodySetupCore::CollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(UBodySetupCore, CollisionReponse) == 0x00003A, "Member 'UBodySetupCore::CollisionReponse' has a wrong offset!");
...
{
public:
	float                                         DefaultGravityZ;                                   // 0x0040(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultTerminalVelocity;                           // 0x0044(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultFluidFriction;                              // 0x0048(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SimulateScratchMemorySize;                         // 0x004C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RagdollAggregateThreshold;                         // 0x0050(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TriangleMeshTriangleMinAreaThreshold;              // 0x0054(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableEnhancedDeterminism;                        // 0x0058(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableShapeSharing;                               // 0x0059(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnablePCM;                                        // 0x005A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableStabilization;                              // 0x005B(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWarnMissingLocks;                                 // 0x005C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnable2DPhysics;                                  // 0x005D(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDefaultHasComplexCollision;                       // 0x005E(0x0001)(ZeroConstructor, Config, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5F[0x1];                                       // 0x005F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         BounceThresholdVelocity;                           // 0x0060(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFrictionCombineMode                          FrictionCombineMode;                               // 0x0064(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFrictionCombineMode                          RestitutionCombineMode;                            // 0x0065(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66[0x2];                                       // 0x0066(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxAngularVelocity;                                // 0x0068(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDepenetrationVelocity;                          // 0x006C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ContactOffsetMultiplier;                           // 0x0070(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinContactOffset;                                  // 0x0074(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxContactOffset;                                  // 0x0078(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSimulateSkeletalMeshOnDedicatedServer;            // 0x007C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionTraceFlag                           DefaultShapeComplexity;                            // 0x007D(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7E[0x2];                                       // 0x007E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FChaosSolverConfiguration              SolverOptions;                                     // 0x0080(0x0068)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPhysicsSettingsCore, DefaultGravityZ) == 0x000040, "Member 'UPhysicsSettingsCore::DefaultGravityZ' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, DefaultTerminalVelocity) == 0x000044, "Member 'UPhysicsSettingsCore::DefaultTerminalVelocity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, DefaultFluidFriction) == 0x000048, "Member 'UPhysicsSettingsCore::DefaultFluidFriction' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, SimulateScratchMemorySize) == 0x00004C, "Member 'UPhysicsSettingsCore::SimulateScratchMemorySize' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, RagdollAggregateThreshold) == 0x000050, "Member 'UPhysicsSettingsCore::RagdollAggregateThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, TriangleMeshTriangleMinAreaThreshold) == 0x000054, "Member 'UPhysicsSettingsCore::TriangleMeshTriangleMinAreaThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnableEnhancedDeterminism) == 0x000058, "Member 'UPhysicsSettingsCore::bEnableEnhancedDeterminism' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnableShapeSharing) == 0x000059, "Member 'UPhysicsSettingsCore::bEnableShapeSharing' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnablePCM) == 0x00005A, "Member 'UPhysicsSettingsCore::bEnablePCM' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnableStabilization) == 0x00005B, "Member 'UPhysicsSettingsCore::bEnableStabilization' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bWarnMissingLocks) == 0x00005C, "Member 'UPhysicsSettingsCore::bWarnMissingLocks' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnable2DPhysics) == 0x00005D, "Member 'UPhysicsSettingsCore::bEnable2DPhysics' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bDefaultHasComplexCollision) == 0x00005E, "Member 'UPhysicsSettingsCore::bDefaultHasComplexCollision' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, BounceThresholdVelocity) == 0x000060, "Member 'UPhysicsSettingsCore::BounceThresholdVelocity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, FrictionCombineMode) == 0x000064, "Member 'UPhysicsSettingsCore::FrictionCombineMode' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, RestitutionCombineMode) == 0x000065, "Member 'UPhysicsSettingsCore::RestitutionCombineMode' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, MaxAngularVelocity) == 0x000068, "Member 'UPhysicsSettingsCore::MaxAngularVelocity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, MaxDepenetrationVelocity) == 0x00006C, "Member 'UPhysicsSettingsCore::MaxDepenetrationVelocity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, ContactOffsetMultiplier) == 0x000070, "Member 'UPhysicsSettingsCore::ContactOffsetMultiplier' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, MinContactOffset) == 0x000074, "Member 'UPhysicsSettingsCore::MinContactOffset' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, MaxContactOffset) == 0x000078, "Member 'UPhysicsSettingsCore::MaxContactOffset' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bSimulateSkeletalMeshOnDedicatedServer) == 0x00007C, "Member 'UPhysicsSettingsCore::bSimulateSkeletalMeshOnDedicatedServer' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, DefaultShapeComplexity) == 0x00007D, "Member 'UPhysicsSettingsCore::DefaultShapeComplexity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, SolverOptions) == 0x000080, "Member 'UPhysicsSettingsCore::SolverOptions' has a wrong offset!");
