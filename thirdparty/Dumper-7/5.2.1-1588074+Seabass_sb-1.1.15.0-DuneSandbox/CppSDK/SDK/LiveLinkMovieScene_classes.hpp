...
{
public:
	struct FLiveLinkSubjectPreset                 SubjectPreset;                                     // 0x00F8(0x0038)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              TrackRole;                                         // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
