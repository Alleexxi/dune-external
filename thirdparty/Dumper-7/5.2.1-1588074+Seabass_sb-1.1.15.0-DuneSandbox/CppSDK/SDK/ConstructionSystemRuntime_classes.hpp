...
public:
	...
	uint8                                         Pad_50[0x120];                                     // 0x0050(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UConstructionSystemBuildTool) == 0x000170, "Wrong size on UConstructionSystemBuildTool");
...
{
public:
	class UMaterialInterface*                     CursorMaterial;                                    // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     CursorInvalidMaterial;                             // 0x0130(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TraceStartDistance;                                // 0x0138(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TraceSweepRadius;                                  // 0x013C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 ConstructionCameraActor;                           // 0x0140(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ConstructionCameraTransitionTime;                  // 0x0148(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ConstructionCameraTransitionExp;                   // 0x014C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UUserWidget>                BuildMenuUI;                                       // 0x0150(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UConstructionSystemUIAsset*             BuildMenuData;                                     // 0x0158(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UUserWidget*                            BuildMenuUIInstance;                               // 0x0160(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EConstructionSystemToolType                   ActiveToolType;                                    // 0x0168(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_169[0x7];                                      // 0x0169(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EConstructionSystemToolType, class UConstructionSystemTool*> Tools;                         // 0x0170(0x0050)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UConstructionSystemComponent) == 0x0001C8, "Wrong size on UConstructionSystemComponent");
static_assert(offsetof(UConstructionSystemComponent, CursorMaterial) == 0x000128, "Member 'UConstructionSystemComponent::CursorMaterial' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, CursorInvalidMaterial) == 0x000130, "Member 'UConstructionSystemComponent::CursorInvalidMaterial' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, TraceStartDistance) == 0x000138, "Member 'UConstructionSystemComponent::TraceStartDistance' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, TraceSweepRadius) == 0x00013C, "Member 'UConstructionSystemComponent::TraceSweepRadius' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, ConstructionCameraActor) == 0x000140, "Member 'UConstructionSystemComponent::ConstructionCameraActor' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, ConstructionCameraTransitionTime) == 0x000148, "Member 'UConstructionSystemComponent::ConstructionCameraTransitionTime' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, ConstructionCameraTransitionExp) == 0x00014C, "Member 'UConstructionSystemComponent::ConstructionCameraTransitionExp' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, BuildMenuUI) == 0x000150, "Member 'UConstructionSystemComponent::BuildMenuUI' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, BuildMenuData) == 0x000158, "Member 'UConstructionSystemComponent::BuildMenuData' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, BuildMenuUIInstance) == 0x000160, "Member 'UConstructionSystemComponent::BuildMenuUIInstance' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, ActiveToolType) == 0x000168, "Member 'UConstructionSystemComponent::ActiveToolType' has a wrong offset!");
static_assert(offsetof(UConstructionSystemComponent, Tools) == 0x000170, "Member 'UConstructionSystemComponent::Tools' has a wrong offset!");
...
static_assert(sizeof(UConstructionSystemRemoveTool) == 0x000098, "Wrong size on UConstructionSystemRemoveTool");
...
static_assert(sizeof(UConstructionSystemSaveGame) == 0x0000F0, "Wrong size on UConstructionSystemSaveGame");
...
static_assert(offsetof(UConstructionSystemSaveGame, ConstructedItems) == 0x0000E0, "Member 'UConstructionSystemSaveGame::ConstructedItems' has a wrong offset!");
...
{
public:
	EPrefabricatorConstructionSnapType            SnapType;                                          // 0x0698(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPCSnapConstraintFloor                 FloorConstraint;                                   // 0x0699(0x0006)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPCSnapConstraintWall                  WallConstraint;                                    // 0x069F(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bAlignToGroundSlope;                               // 0x06A3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseMaxGroundSlopeConstraint;                      // 0x06A4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6A5[0x3];                                      // 0x06A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxGroundPlacementSlope;                           // 0x06A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPrefabricatorConstructionSnapComponent) == 0x0006B0, "Wrong size on UPrefabricatorConstructionSnapComponent");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, SnapType) == 0x000698, "Member 'UPrefabricatorConstructionSnapComponent::SnapType' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, FloorConstraint) == 0x000699, "Member 'UPrefabricatorConstructionSnapComponent::FloorConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, WallConstraint) == 0x00069F, "Member 'UPrefabricatorConstructionSnapComponent::WallConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, bAlignToGroundSlope) == 0x0006A3, "Member 'UPrefabricatorConstructionSnapComponent::bAlignToGroundSlope' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, bUseMaxGroundSlopeConstraint) == 0x0006A4, "Member 'UPrefabricatorConstructionSnapComponent::bUseMaxGroundSlopeConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, MaxGroundPlacementSlope) == 0x0006A8, "Member 'UPrefabricatorConstructionSnapComponent::MaxGroundPlacementSlope' has a wrong offset!");
...
{
public:
	class UPrefabricatorConstructionSnapComponent* ConstructionSnapComponent;                        // 0x0350(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APrefabricatorConstructionSnap) == 0x000358, "Wrong size on APrefabricatorConstructionSnap");
static_assert(offsetof(APrefabricatorConstructionSnap, ConstructionSnapComponent) == 0x000350, "Member 'APrefabricatorConstructionSnap::ConstructionSnapComponent' has a wrong offset!");
