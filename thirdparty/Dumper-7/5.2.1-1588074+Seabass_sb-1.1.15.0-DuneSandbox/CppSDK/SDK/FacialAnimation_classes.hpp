...
public:
	...
	class FName                                   CurveSourceBindingName;                            // 0x0D28(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurveSyncOffset;                                   // 0x0D30(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D34[0x2C];                                     // 0x0D34(0x002C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x000D30, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
