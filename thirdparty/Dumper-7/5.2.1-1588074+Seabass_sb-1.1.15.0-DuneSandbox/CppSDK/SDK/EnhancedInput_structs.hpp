...
public:
	...
	uint8                                         bShouldBeQueued : 1;                               // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	uint8                                         bIgnoreAllAxisInputsUntilRelease : 1;              // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IgnoreAxisInputDeadzoneNormalised;                 // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IgnoreAxisInputDelaySeconds;                       // 0x0008(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bForceImmediately : 1;                             // 0x000C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FModifyContextOptions) == 0x000004, "Wrong alignment on FModifyContextOptions");
static_assert(sizeof(FModifyContextOptions) == 0x000010, "Wrong size on FModifyContextOptions");
static_assert(offsetof(FModifyContextOptions, IgnoreAxisInputDeadzoneNormalised) == 0x000004, "Member 'FModifyContextOptions::IgnoreAxisInputDeadzoneNormalised' has a wrong offset!");
static_assert(offsetof(FModifyContextOptions, IgnoreAxisInputDelaySeconds) == 0x000008, "Member 'FModifyContextOptions::IgnoreAxisInputDelaySeconds' has a wrong offset!");
...
{
public:
	struct FInputActionValue                      RawValue;                                          // 0x0000(0x0020)(Transient, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FInjectedInput, RawValue) == 0x000000, "Member 'FInjectedInput::RawValue' has a wrong offset!");
