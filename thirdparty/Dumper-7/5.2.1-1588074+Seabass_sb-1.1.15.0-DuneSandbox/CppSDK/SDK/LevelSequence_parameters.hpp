...
public:
	...
	bool                                          ActorBypassWorldCheck;                             // 0x0038(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(LevelSequencePlayer_CreateLevelSequencePlayer, ActorBypassWorldCheck) == 0x000038, "Member 'LevelSequencePlayer_CreateLevelSequencePlayer::ActorBypassWorldCheck' has a wrong offset!");
