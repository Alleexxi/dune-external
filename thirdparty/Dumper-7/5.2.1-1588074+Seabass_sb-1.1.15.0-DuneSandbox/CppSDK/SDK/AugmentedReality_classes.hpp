...
static_assert(sizeof(AARActor) == 0x000350, "Wrong size on AARActor");
...
static_assert(sizeof(UARGetCandidateObjectAsyncTaskBlueprintProxy) == 0x0000B8, "Wrong size on UARGetCandidateObjectAsyncTaskBlueprintProxy");
...
{
public:
	struct FGuid                                  NativeID;                                          // 0x0360(0x0010)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_370[0x30];                                     // 0x0370(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseDefaultReplication;                            // 0x03A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3A1[0x7];                                      // 0x03A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInterface*                     DefaultMeshMaterial;                               // 0x03A8(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     DefaultWireframeMeshMaterial;                      // 0x03B0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMRMeshComponent*                       MRMeshComponent;                                   // 0x03B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UARTrackedGeometry*                     MyTrackedGeometry;                                 // 0x03C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARComponent) == 0x0003E0, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x000360, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x0003A0, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x0003A8, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x0003B0, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x0003B8, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x0003C0, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
{
public:
	struct FARPlaneUpdatePayload                  ReplicatedPayload;                                 // 0x03E0(0x00D0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARPlaneComponent) == 0x0004B0, "Wrong size on UARPlaneComponent");
static_assert(offsetof(UARPlaneComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARPlaneComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARPointUpdatePayload                  ReplicatedPayload;                                 // 0x03E0(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARPointComponent) == 0x0003F0, "Wrong size on UARPointComponent");
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	EARFaceTransformMixing                        TransformSetting;                                  // 0x03E0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdateVertexNormal;                               // 0x03E1(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFaceOutOfScreen;                                  // 0x03E2(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3E3[0x5];                                      // 0x03E3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FARFaceUpdatePayload                   ReplicatedPayload;                                 // 0x03E8(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARFaceComponent) == 0x000470, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x0003E0, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x0003E1, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x0003E2, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x0003E8, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARImageUpdatePayload                  ReplicatedPayload;                                 // 0x03E0(0x00A0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARImageComponent) == 0x000480, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARQRCodeUpdatePayload                 ReplicatedPayload;                                 // 0x03E0(0x00B0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARQRCodeComponent) == 0x000490, "Wrong size on UARQRCodeComponent");
static_assert(offsetof(UARQRCodeComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARQRCodeComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARPoseUpdatePayload                   ReplicatedPayload;                                 // 0x03E0(0x0070)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARPoseComponent) == 0x000450, "Wrong size on UARPoseComponent");
static_assert(offsetof(UARPoseComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARPoseComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FAREnvironmentProbeUpdatePayload       ReplicatedPayload;                                 // 0x03E0(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x000440, "Wrong size on UAREnvironmentProbeComponent");
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x0003E0, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARObjectUpdatePayload                 ReplicatedPayload;                                 // 0x03E0(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARObjectComponent) == 0x000440, "Wrong size on UARObjectComponent");
static_assert(offsetof(UARObjectComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARObjectComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARMeshUpdatePayload                   ReplicatedPayload;                                 // 0x03E0(0x0090)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARMeshComponent) == 0x000470, "Wrong size on UARMeshComponent");
static_assert(offsetof(UARMeshComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARMeshComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARGeoAnchorUpdatePayload              ReplicatedPayload;                                 // 0x03E0(0x00A0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARGeoAnchorComponent) == 0x000480, "Wrong size on UARGeoAnchorComponent");
static_assert(offsetof(UARGeoAnchorComponent, ReplicatedPayload) == 0x0003E0, "Member 'UARGeoAnchorComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UGetGeoLocationAsyncTaskBlueprintProxy) == 0x0000B0, "Wrong size on UGetGeoLocationAsyncTaskBlueprintProxy");
...
{
public:
	TMulticastInlineDelegate<void(class UClass* ComponentClass, const struct FGuid& NativeID, class AARActor* SpawnedActor)> OnARActorSpawnedDelegate; // 0x0360(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AARActor* Actor)> OnARActorToBeDestroyedDelegate;            // 0x0370(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARLifeCycleComponent) == 0x000390, "Wrong size on UARLifeCycleComponent");
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x000360, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x000370, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
...
static_assert(sizeof(AAROriginActor) == 0x000350, "Wrong size on AAROriginActor");
...
static_assert(alignof(AARSharedWorldGameMode) == 0x000010, "Wrong alignment on AARSharedWorldGameMode");
static_assert(sizeof(AARSharedWorldGameMode) == 0x000500, "Wrong size on AARSharedWorldGameMode");
...
{
public:
	TArray<uint8>                                 PreviewImageData;                                  // 0x0400(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ARWorldData;                                       // 0x0410(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesTotal;                            // 0x0420(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesTotal;                                 // 0x0424(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesDelivered;                        // 0x0428(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesDelivered;                             // 0x042C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AARSharedWorldGameState) == 0x000438, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000400, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000410, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x000420, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x000424, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x000428, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x00042C, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
static_assert(alignof(AARSharedWorldPlayerController) == 0x000010, "Wrong alignment on AARSharedWorldPlayerController");
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000970, "Wrong size on AARSharedWorldPlayerController");
...
{
public:
	class UAREnvironmentCaptureProbe*             CaptureProbe;                                      // 0x0360(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AARSkyLight) == 0x000370, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x000360, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
static_assert(sizeof(UARTexture) == 0x000200, "Wrong size on UARTexture");
static_assert(offsetof(UARTexture, TextureType) == 0x0001D8, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, timestamp) == 0x0001DC, "Member 'UARTexture::timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x0001E0, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x0001F0, "Member 'UARTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTextureCameraImage) == 0x000200, "Wrong size on UARTextureCameraImage");
...
static_assert(sizeof(UARTextureCameraDepth) == 0x000210, "Wrong size on UARTextureCameraDepth");
static_assert(offsetof(UARTextureCameraDepth, DepthQuality) == 0x000200, "Member 'UARTextureCameraDepth::DepthQuality' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, DepthAccuracy) == 0x000201, "Member 'UARTextureCameraDepth::DepthAccuracy' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, bIsTemporallySmoothed) == 0x000202, "Member 'UARTextureCameraDepth::bIsTemporallySmoothed' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x0002A0, "Wrong size on UAREnvironmentCaptureProbeTexture");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000270, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, timestamp) == 0x000274, "Member 'UAREnvironmentCaptureProbeTexture::timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000278, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000288, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTrackableNotifyComponent) == 0x000278, "Wrong size on UARTrackableNotifyComponent");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedGeometry) == 0x000128, "Member 'UARTrackableNotifyComponent::OnAddTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedGeometry) == 0x000138, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedGeometry) == 0x000148, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPlane) == 0x000158, "Member 'UARTrackableNotifyComponent::OnAddTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPlane) == 0x000168, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPlane) == 0x000178, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPoint) == 0x000188, "Member 'UARTrackableNotifyComponent::OnAddTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPoint) == 0x000198, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPoint) == 0x0001A8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedImage) == 0x0001B8, "Member 'UARTrackableNotifyComponent::OnAddTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedImage) == 0x0001C8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedImage) == 0x0001D8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedFace) == 0x0001E8, "Member 'UARTrackableNotifyComponent::OnAddTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedFace) == 0x0001F8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedFace) == 0x000208, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedEnvProbe) == 0x000218, "Member 'UARTrackableNotifyComponent::OnAddTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedEnvProbe) == 0x000228, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedEnvProbe) == 0x000238, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedObject) == 0x000248, "Member 'UARTrackableNotifyComponent::OnAddTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedObject) == 0x000258, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedObject) == 0x000268, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedObject' has a wrong offset!");
...
static_assert(sizeof(UARCandidateObject) == 0x000090, "Wrong size on UARCandidateObject");
