...
static_assert(sizeof(UBTTask_BlackboardBase) == 0x0000A0, "Wrong size on UBTTask_BlackboardBase");
...
public:
	...
	struct FAIDataProviderFloatValue              BellCurveDeviation;                                // 0x01B0(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              BellCurveMean;                                     // 0x01E8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ReferenceValue;                                    // 0x0220(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bDefineReferenceValue;                             // 0x0258(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_259[0xF];                                      // 0x0259(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWorkOnFloatValues : 1;                            // 0x0268(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UEnvQueryTest) == 0x000270, "Wrong size on UEnvQueryTest");
...
static_assert(offsetof(UEnvQueryTest, BellCurveDeviation) == 0x0001B0, "Member 'UEnvQueryTest::BellCurveDeviation' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, BellCurveMean) == 0x0001E8, "Member 'UEnvQueryTest::BellCurveMean' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ReferenceValue) == 0x000220, "Member 'UEnvQueryTest::ReferenceValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, bDefineReferenceValue) == 0x000258, "Member 'UEnvQueryTest::bDefineReferenceValue' has a wrong offset!");
...
{
public:
	EEnvTestPathfinding                           TestMode;                                          // 0x0270(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FAIDataProviderBoolValue               PathFromContext;                                   // 0x0280(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderBoolValue               SkipUnreachable;                                   // 0x02B8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_Pathfinding) == 0x0002F8, "Wrong size on UEnvQueryTest_Pathfinding");
static_assert(offsetof(UEnvQueryTest_Pathfinding, TestMode) == 0x000270, "Member 'UEnvQueryTest_Pathfinding::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, Context) == 0x000278, "Member 'UEnvQueryTest_Pathfinding::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, PathFromContext) == 0x000280, "Member 'UEnvQueryTest_Pathfinding::PathFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, SkipUnreachable) == 0x0002B8, "Member 'UEnvQueryTest_Pathfinding::SkipUnreachable' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, FilterClass) == 0x0002F0, "Member 'UEnvQueryTest_Pathfinding::FilterClass' has a wrong offset!");
...
public:
	...
	uint8                                         bStartAILogicOnPossess : 1;                        // 0x0420(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bStopAILogicOnUnposses : 1;                        // 0x0420(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bLOSflag : 1;                                      // 0x0420(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipExtraLOSChecks : 1;                           // 0x0420(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowStrafe : 1;                                  // 0x0420(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bWantsPlayerState : 1;                             // 0x0420(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetControlRotationFromPawnOrientation : 1;        // 0x0420(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_421[0x7];                                      // 0x0421(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPathFollowingComponent*                PathFollowingComponent;                            // 0x0428(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UBrainComponent*                        BrainComponent;                                    // 0x0430(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAIPerceptionComponent*                 PerceptionComponent;                               // 0x0438(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPawnActionsComponent*                  ActionsComp;                                       // 0x0440(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UBlackboardComponent*                   Blackboard;                                        // 0x0448(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGameplayTasksComponent*                CachedGameplayTasksComponent;                      // 0x0450(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UNavigationQueryFilter>     DefaultNavigationFilterClass;                      // 0x0458(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AAIController) == 0x000478, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x000428, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x000430, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x000438, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x000440, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x000448, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x000450, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x000458, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x000460, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_BlackboardBase) == 0x000098, "Wrong size on UBTDecorator_BlackboardBase");
...
{
public:
	int32                                         IntValue;                                          // 0x0098(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FloatValue;                                        // 0x009C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 StringValue;                                       // 0x00A0(0x0010)(Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         OperationType;                                     // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EBTBlackboardRestart                          NotifyObserver;                                    // 0x00C1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTDecorator_Blackboard) == 0x0000C8, "Wrong size on UBTDecorator_Blackboard");
static_assert(offsetof(UBTDecorator_Blackboard, IntValue) == 0x000098, "Member 'UBTDecorator_Blackboard::IntValue' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Blackboard, FloatValue) == 0x00009C, "Member 'UBTDecorator_Blackboard::FloatValue' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Blackboard, StringValue) == 0x0000A0, "Member 'UBTDecorator_Blackboard::StringValue' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Blackboard, CachedDescription) == 0x0000B0, "Member 'UBTDecorator_Blackboard::CachedDescription' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Blackboard, OperationType) == 0x0000C0, "Member 'UBTDecorator_Blackboard::OperationType' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Blackboard, NotifyObserver) == 0x0000C1, "Member 'UBTDecorator_Blackboard::NotifyObserver' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_ConditionalLoop) == 0x0000C8, "Wrong size on UBTDecorator_ConditionalLoop");
...
class alignas(0x10) UAISense : public UObject
{
public:
...
static_assert(alignof(UAISense) == 0x000010, "Wrong alignment on UAISense");
...
public:
	...
	int32                                         MaxTracesPerTick;                                  // 0x01F8(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         MaxAsyncTracesPerTick;                             // 0x01FC(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         MinQueriesPerTimeSliceCheck;                       // 0x0200(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        MaxTimeSlicePerTick;                               // 0x0208(0x0008)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         HighImportanceQueryDistanceThreshold;              // 0x0210(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxQueryImportance;                                // 0x0218(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         SightLimitQueryImportance;                         // 0x021C(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PendingQueriesBudgetReductionRatio;                // 0x0220(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUseAsynchronousTraceForDefaultSightQueries;       // 0x0224(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_225[0xBB];                                     // 0x0225(0x00BB)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UAISense_Sight) == 0x000010, "Wrong alignment on UAISense_Sight");
static_assert(sizeof(UAISense_Sight) == 0x0002E0, "Wrong size on UAISense_Sight");
static_assert(offsetof(UAISense_Sight, MaxTracesPerTick) == 0x0001F8, "Member 'UAISense_Sight::MaxTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxAsyncTracesPerTick) == 0x0001FC, "Member 'UAISense_Sight::MaxAsyncTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MinQueriesPerTimeSliceCheck) == 0x000200, "Member 'UAISense_Sight::MinQueriesPerTimeSliceCheck' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxTimeSlicePerTick) == 0x000208, "Member 'UAISense_Sight::MaxTimeSlicePerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, HighImportanceQueryDistanceThreshold) == 0x000210, "Member 'UAISense_Sight::HighImportanceQueryDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxQueryImportance) == 0x000218, "Member 'UAISense_Sight::MaxQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, SightLimitQueryImportance) == 0x00021C, "Member 'UAISense_Sight::SightLimitQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, PendingQueriesBudgetReductionRatio) == 0x000220, "Member 'UAISense_Sight::PendingQueriesBudgetReductionRatio' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, bUseAsynchronousTraceForDefaultSightQueries) == 0x000224, "Member 'UAISense_Sight::bUseAsynchronousTraceForDefaultSightQueries' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_SimpleGrid, SpaceBetween) == 0x0000D0, "Member 'UEnvQueryGenerator_SimpleGrid::SpaceBetween' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_CompareBBEntries) == 0x0000C8, "Wrong size on UBTDecorator_CompareBBEntries");
...
static_assert(offsetof(UBTDecorator_CompareBBEntries, BlackboardKeyB) == 0x0000A0, "Member 'UBTDecorator_CompareBBEntries::BlackboardKeyB' has a wrong offset!");
...
public:
	...
	class UBlackboardComponent*                   BlackboardComp;                                    // 0x0130(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBrainComponent) == 0x000180, "Wrong size on UBrainComponent");
...
public:
	...
	TArray<class UBTNode*>                        NodeInstances;                                     // 0x01A0(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B0[0x148];                                    // 0x01B0(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	class UBehaviorTree*                          DefaultBehaviorTreeAsset;                          // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBehaviorTreeComponent) == 0x000318, "Wrong size on UBehaviorTreeComponent");
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x0001A0, "Member 'UBehaviorTreeComponent::NodeInstances' has a wrong offset!");
static_assert(offsetof(UBehaviorTreeComponent, DefaultBehaviorTreeAsset) == 0x0002F8, "Member 'UBehaviorTreeComponent::DefaultBehaviorTreeAsset' has a wrong offset!");
...
public:
	...
	int32                                         IntValue;                                          // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAIDataProvider_QueryParams, FloatValue) == 0x000038, "Member 'UAIDataProvider_QueryParams::FloatValue' has a wrong offset!");
static_assert(offsetof(UAIDataProvider_QueryParams, IntValue) == 0x00003C, "Member 'UAIDataProvider_QueryParams::IntValue' has a wrong offset!");
static_assert(offsetof(UAIDataProvider_QueryParams, BoolValue) == 0x000040, "Member 'UAIDataProvider_QueryParams::BoolValue' has a wrong offset!");
...
static_assert(sizeof(UBTService_BlackboardBase) == 0x0000A0, "Wrong size on UBTService_BlackboardBase");
...
class alignas(0x10) UBTCompositeNode : public UBTNode
{
public:
...
#pragma pack(pop)
static_assert(alignof(UBTCompositeNode) == 0x000010, "Wrong alignment on UBTCompositeNode");
static_assert(sizeof(UBTCompositeNode) == 0x0000D0, "Wrong size on UBTCompositeNode");
...
{
public:
	struct FAIDamageEvent                         Event;                                             // 0x0030(0x0050)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAISenseEvent_Damage) == 0x000080, "Wrong size on UAISenseEvent_Damage");
...
static_assert(alignof(UBTComposite_Selector) == 0x000010, "Wrong alignment on UBTComposite_Selector");
static_assert(sizeof(UBTComposite_Selector) == 0x0000D0, "Wrong size on UBTComposite_Selector");

// Class AIModule.PawnAction
// 0x00A0 (0x00D0 - 0x0030)
#pragma pack(push, 0x1)
class alignas(0x10) UPawnAction : public UObject
{
public:
...
#pragma pack(pop)
static_assert(alignof(UPawnAction) == 0x000010, "Wrong alignment on UPawnAction");
...
{
public:
	class AActor*                                 GoalActor;                                         // 0x00C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                GoalLocation;                                      // 0x00D0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         AcceptableRadius;                                  // 0x00E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_EC[0x4];                                       // 0x00EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x00F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bAllowStrafe : 1;                                  // 0x00F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bFinishOnOverlap : 1;                              // 0x00F8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bUsePathfinding : 1;                               // 0x00F8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bAllowPartialPath : 1;                             // 0x00F8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bProjectGoalToNavigation : 1;                      // 0x00F8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bUpdatePathToGoal : 1;                             // 0x00F8(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bAbortSubActionOnPathChange : 1;                   // 0x00F8(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(alignof(UPawnAction_Move) == 0x000010, "Wrong alignment on UPawnAction_Move");
static_assert(sizeof(UPawnAction_Move) == 0x000130, "Wrong size on UPawnAction_Move");
static_assert(offsetof(UPawnAction_Move, GoalActor) == 0x0000C8, "Member 'UPawnAction_Move::GoalActor' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, GoalLocation) == 0x0000D0, "Member 'UPawnAction_Move::GoalLocation' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, AcceptableRadius) == 0x0000E8, "Member 'UPawnAction_Move::AcceptableRadius' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, FilterClass) == 0x0000F0, "Member 'UPawnAction_Move::FilterClass' has a wrong offset!");
...
{
public:
	uint8                                         FocusPriority;                                     // 0x00A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTService_DefaultFocus) == 0x0000A8, "Wrong size on UBTService_DefaultFocus");
static_assert(offsetof(UBTService_DefaultFocus, FocusPriority) == 0x0000A0, "Member 'UBTService_DefaultFocus::FocusPriority' has a wrong offset!");
...
{
public:
	float                                         Precision;                                         // 0x00A0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UBTTask_RotateToFaceBBEntry, Precision) == 0x0000A0, "Member 'UBTTask_RotateToFaceBBEntry::Precision' has a wrong offset!");
...
{
public:
	TArray<class UPawnAction*>                    ActionSequence;                                    // 0x00C8(0x0010)(ZeroConstructor, Deprecated, UObjectWrapper, NativeAccessSpecifierPublic)
	EPawnActionFailHandling                       ChildFailureHandlingMode;                          // 0x00D8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPawnAction*                            RecentActionCopy;                                  // 0x00E0(0x0008)(ZeroConstructor, Transient, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UPawnAction_Sequence) == 0x000010, "Wrong alignment on UPawnAction_Sequence");
static_assert(sizeof(UPawnAction_Sequence) == 0x0000F0, "Wrong size on UPawnAction_Sequence");
static_assert(offsetof(UPawnAction_Sequence, ActionSequence) == 0x0000C8, "Member 'UPawnAction_Sequence::ActionSequence' has a wrong offset!");
static_assert(offsetof(UPawnAction_Sequence, ChildFailureHandlingMode) == 0x0000D8, "Member 'UPawnAction_Sequence::ChildFailureHandlingMode' has a wrong offset!");
static_assert(offsetof(UPawnAction_Sequence, RecentActionCopy) == 0x0000E0, "Member 'UPawnAction_Sequence::RecentActionCopy' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           InjectionTag;                                      // 0x0078(0x0008)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBehaviorTree*                          DefaultBehaviorAsset;                              // 0x0080(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBehaviorTree*                          BehaviorAsset;                                     // 0x0088(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTTask_RunBehaviorDynamic) == 0x000090, "Wrong size on UBTTask_RunBehaviorDynamic");
...
static_assert(offsetof(UBTTask_RunBehaviorDynamic, DefaultBehaviorAsset) == 0x000080, "Member 'UBTTask_RunBehaviorDynamic::DefaultBehaviorAsset' has a wrong offset!");
static_assert(offsetof(UBTTask_RunBehaviorDynamic, BehaviorAsset) == 0x000088, "Member 'UBTTask_RunBehaviorDynamic::BehaviorAsset' has a wrong offset!");
...
static_assert(sizeof(UBTTask_SetTagCooldown) == 0x000088, "Wrong size on UBTTask_SetTagCooldown");
...
static_assert(offsetof(UBTTask_SetTagCooldown, bAddToExistingDuration) == 0x000080, "Member 'UBTTask_SetTagCooldown::bAddToExistingDuration' has a wrong offset!");
static_assert(offsetof(UBTTask_SetTagCooldown, CooldownDuration) == 0x000084, "Member 'UBTTask_SetTagCooldown::CooldownDuration' has a wrong offset!");
...
public:
	...
	float                                         VerticalVisionAngleDegrees;                        // 0x0064(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxNpcTargetRadius;                                // 0x0068(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAISenseConfig_Sight, VerticalVisionAngleDegrees) == 0x000064, "Member 'UAISenseConfig_Sight::VerticalVisionAngleDegrees' has a wrong offset!");
static_assert(offsetof(UAISenseConfig_Sight, MaxNpcTargetRadius) == 0x000068, "Member 'UAISenseConfig_Sight::MaxNpcTargetRadius' has a wrong offset!");
...
static_assert(offsetof(UAISenseConfig_Sight, PointOfViewBackwardOffset) == 0x000074, "Member 'UAISenseConfig_Sight::PointOfViewBackwardOffset' has a wrong offset!");
static_assert(offsetof(UAISenseConfig_Sight, NearClippingRadius) == 0x000078, "Member 'UAISenseConfig_Sight::NearClippingRadius' has a wrong offset!");
...
{
public:
	class UBrainComponent*                        BrainComp;                                         // 0x0128(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBlackboardData*                        DefaultBlackboardAsset;                            // 0x0130(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBlackboardData*                        BlackboardAsset;                                   // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_140[0x20];                                     // 0x0140(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBlackboardKeyType*>             KeyInstances;                                      // 0x0160(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBlackboardComponent) == 0x000230, "Wrong size on UBlackboardComponent");
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x000128, "Member 'UBlackboardComponent::BrainComp' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, DefaultBlackboardAsset) == 0x000130, "Member 'UBlackboardComponent::DefaultBlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x000138, "Member 'UBlackboardComponent::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x000160, "Member 'UBlackboardComponent::KeyInstances' has a wrong offset!");
...
{
public:
	TArray<class UAISenseConfig*>                 SensesConfig;                                      // 0x0128(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSubclassOf<class UAISense>                   DominantSense;                                     // 0x0138(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TMulticastInlineDelegate<void(class AActor* Actor)> OnTargetPerceptionForgotten;                 // 0x01E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AActor* Actor, const struct FAIStimulus& Stimulus)> OnTargetPerceptionUpdated; // 0x01F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FActorPerceptionUpdateInfo& UpdateInfo)> OnTargetPerceptionInfoUpdated; // 0x0208(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAIPerceptionComponent) == 0x000220, "Wrong size on UAIPerceptionComponent");
...
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionForgotten) == 0x0001E8, "Member 'UAIPerceptionComponent::OnTargetPerceptionForgotten' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionUpdated) == 0x0001F8, "Member 'UAIPerceptionComponent::OnTargetPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionInfoUpdated) == 0x000208, "Member 'UAIPerceptionComponent::OnTargetPerceptionInfoUpdated' has a wrong offset!");
...
public:
	...
	EPointOnCircleSpacingMethod                   PointOnCircleSpacingMethod;                        // 0x0140(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FAIDataProviderFloatValue              ArcAngle;                                          // 0x0168(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	float                                         AngleRadians;                                      // 0x01A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UEnvQueryContext>           CircleCenter;                                      // 0x01A8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnoreAnyContextActorsWhenGeneratingCircle;       // 0x01B0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B1[0x7];                                      // 0x01B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIDataProviderFloatValue              CircleCenterZOffset;                               // 0x01B8(0x0038)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FEnvTraceData                          TraceData;                                         // 0x01F0(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bDefineArc : 1;                                    // 0x0230(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UEnvQueryGenerator_OnCircle) == 0x000238, "Wrong size on UEnvQueryGenerator_OnCircle");
...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x000140, "Member 'UEnvQueryGenerator_OnCircle::PointOnCircleSpacingMethod' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcDirection) == 0x000148, "Member 'UEnvQueryGenerator_OnCircle::ArcDirection' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcAngle) == 0x000168, "Member 'UEnvQueryGenerator_OnCircle::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, AngleRadians) == 0x0001A0, "Member 'UEnvQueryGenerator_OnCircle::AngleRadians' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenter) == 0x0001A8, "Member 'UEnvQueryGenerator_OnCircle::CircleCenter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, bIgnoreAnyContextActorsWhenGeneratingCircle) == 0x0001B0, "Member 'UEnvQueryGenerator_OnCircle::bIgnoreAnyContextActorsWhenGeneratingCircle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenterZOffset) == 0x0001B8, "Member 'UEnvQueryGenerator_OnCircle::CircleCenterZOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, TraceData) == 0x0001F0, "Member 'UEnvQueryGenerator_OnCircle::TraceData' has a wrong offset!");
...
static_assert(alignof(UAISense_Hearing) == 0x000010, "Wrong alignment on UAISense_Hearing");
...
#pragma pack(push, 0x1)
class alignas(0x10) UPathFollowingComponent : public UActorComponent
{
public:
	uint8                                         Pad_128[0x70];                                     // 0x0128(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	class UNavMovementComponent*                  MovementComp;                                      // 0x0198(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1A0[0x8];                                      // 0x01A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class ANavigationData*                        MyNavData;                                         // 0x01A8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B0[0x1D8];                                    // 0x01B0(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
#pragma pack(pop)
static_assert(alignof(UPathFollowingComponent) == 0x000010, "Wrong alignment on UPathFollowingComponent");
static_assert(sizeof(UPathFollowingComponent) == 0x000390, "Wrong size on UPathFollowingComponent");
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x000198, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x0001A8, "Member 'UPathFollowingComponent::MyNavData' has a wrong offset!");
...
{
public:
	class APawn*                                  ControlledPawn;                                    // 0x0128(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPawnAction*                            CurrentAction;                                     // 0x0150(0x0008)(ZeroConstructor, Transient, Deprecated, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UPawnAction_BlueprintBase) == 0x000010, "Wrong alignment on UPawnAction_BlueprintBase");
...
{
public:
	class UPawnAction*                            ActionToRepeat;                                    // 0x00C8(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPawnAction*                            RecentActionCopy;                                  // 0x00D0(0x0008)(ZeroConstructor, Transient, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPawnActionFailHandling                       ChildFailureHandlingMode;                          // 0x00D8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UPawnAction_Repeat) == 0x000010, "Wrong alignment on UPawnAction_Repeat");
static_assert(sizeof(UPawnAction_Repeat) == 0x0000F0, "Wrong size on UPawnAction_Repeat");
static_assert(offsetof(UPawnAction_Repeat, ActionToRepeat) == 0x0000C8, "Member 'UPawnAction_Repeat::ActionToRepeat' has a wrong offset!");
static_assert(offsetof(UPawnAction_Repeat, RecentActionCopy) == 0x0000D0, "Member 'UPawnAction_Repeat::RecentActionCopy' has a wrong offset!");
static_assert(offsetof(UPawnAction_Repeat, ChildFailureHandlingMode) == 0x0000D8, "Member 'UPawnAction_Repeat::ChildFailureHandlingMode' has a wrong offset!");
...
{
public:
	float                                         TimeToWait;                                        // 0x00C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UPawnAction_Wait) == 0x000010, "Wrong alignment on UPawnAction_Wait");
static_assert(sizeof(UPawnAction_Wait) == 0x0000E0, "Wrong size on UPawnAction_Wait");
static_assert(offsetof(UPawnAction_Wait, TimeToWait) == 0x0000C8, "Member 'UPawnAction_Wait::TimeToWait' has a wrong offset!");
...
static_assert(alignof(UBTComposite_Sequence) == 0x000010, "Wrong alignment on UBTComposite_Sequence");
...
static_assert(alignof(UBTComposite_SimpleParallel) == 0x000010, "Wrong alignment on UBTComposite_SimpleParallel");
...
{
public:
	struct FBlackboardKeySelector                 ActorToCheck;                                      // 0x0070(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	EGameplayContainerMatchType                   TagsToMatch;                                       // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x00A0(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTDecorator_CheckGameplayTagsOnActor) == 0x0000D0, "Wrong size on UBTDecorator_CheckGameplayTagsOnActor");
...
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, TagsToMatch) == 0x000098, "Member 'UBTDecorator_CheckGameplayTagsOnActor::TagsToMatch' has a wrong offset!");
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, GameplayTags) == 0x0000A0, "Member 'UBTDecorator_CheckGameplayTagsOnActor::GameplayTags' has a wrong offset!");
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, CachedDescription) == 0x0000C0, "Member 'UBTDecorator_CheckGameplayTagsOnActor::CachedDescription' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_ConeCheck) == 0x0000F8, "Wrong size on UBTDecorator_ConeCheck");
...
public:
	...
	uint8                                         bUseSelf : 1;                                      // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EPathExistanceQueryType                       PathQueryType;                                     // 0x00C4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x00C8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTDecorator_DoesPathExist) == 0x0000D0, "Wrong size on UBTDecorator_DoesPathExist");
...
static_assert(offsetof(UBTDecorator_DoesPathExist, BlackboardKeyB) == 0x000098, "Member 'UBTDecorator_DoesPathExist::BlackboardKeyB' has a wrong offset!");
static_assert(offsetof(UBTDecorator_DoesPathExist, PathQueryType) == 0x0000C4, "Member 'UBTDecorator_DoesPathExist::PathQueryType' has a wrong offset!");
static_assert(offsetof(UBTDecorator_DoesPathExist, FilterClass) == 0x0000C8, "Member 'UBTDecorator_DoesPathExist::FilterClass' has a wrong offset!");
...
public:
	...
	struct FAIDataProviderFloatValue              ParametrizedAcceptableRadius;                      // 0x00A0(0x0038)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBTDecorator_IsAtLocation, AcceptableRadius) == 0x000098, "Member 'UBTDecorator_IsAtLocation::AcceptableRadius' has a wrong offset!");
static_assert(offsetof(UBTDecorator_IsAtLocation, ParametrizedAcceptableRadius) == 0x0000A0, "Member 'UBTDecorator_IsAtLocation::ParametrizedAcceptableRadius' has a wrong offset!");
...
{
public:
	TSubclassOf<class UObject>                    TestClass;                                         // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTDecorator_IsBBEntryOfClass) == 0x0000A0, "Wrong size on UBTDecorator_IsBBEntryOfClass");
static_assert(offsetof(UBTDecorator_IsBBEntryOfClass, TestClass) == 0x000098, "Member 'UBTDecorator_IsBBEntryOfClass::TestClass' has a wrong offset!");
...
public:
	...
	bool                                          bAddToExistingDuration;                            // 0x007C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTDecorator_SetTagCooldown) == 0x000080, "Wrong size on UBTDecorator_SetTagCooldown");
...
static_assert(offsetof(UBTDecorator_SetTagCooldown, CooldownDuration) == 0x000078, "Member 'UBTDecorator_SetTagCooldown::CooldownDuration' has a wrong offset!");
static_assert(offsetof(UBTDecorator_SetTagCooldown, bAddToExistingDuration) == 0x00007C, "Member 'UBTDecorator_SetTagCooldown::bAddToExistingDuration' has a wrong offset!");
...
public:
	...
	float                                         CooldownDuration;                                  // 0x0078(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAddToExistingDuration;                            // 0x007C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bActivatesCooldown;                                // 0x007D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTDecorator_TagCooldown) == 0x000080, "Wrong size on UBTDecorator_TagCooldown");
...
static_assert(offsetof(UBTDecorator_TagCooldown, CooldownDuration) == 0x000078, "Member 'UBTDecorator_TagCooldown::CooldownDuration' has a wrong offset!");
static_assert(offsetof(UBTDecorator_TagCooldown, bAddToExistingDuration) == 0x00007C, "Member 'UBTDecorator_TagCooldown::bAddToExistingDuration' has a wrong offset!");
static_assert(offsetof(UBTDecorator_TagCooldown, bActivatesCooldown) == 0x00007D, "Member 'UBTDecorator_TagCooldown::bActivatesCooldown' has a wrong offset!");
...
class alignas(0x10) UBTService_RunEQS final : public UBTService_BlackboardBase
{
public:
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x00A0(0x0048)(Edit, Protected, NativeAccessSpecifierProtected)
	bool                                          bUpdateBBOnFail;                                   // 0x00E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UBTService_RunEQS) == 0x000010, "Wrong alignment on UBTService_RunEQS");
static_assert(sizeof(UBTService_RunEQS) == 0x000130, "Wrong size on UBTService_RunEQS");
static_assert(offsetof(UBTService_RunEQS, EQSRequest) == 0x0000A0, "Member 'UBTService_RunEQS::EQSRequest' has a wrong offset!");
static_assert(offsetof(UBTService_RunEQS, bUpdateBBOnFail) == 0x0000E8, "Member 'UBTService_RunEQS::bUpdateBBOnFail' has a wrong offset!");
...
{
public:
	float                                         AcceptableRadius;                                  // 0x00A0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A4[0x4];                                       // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x00A8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ObservedBlackboardValueTolerance;                  // 0x00B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bObserveBlackboardValue : 1;                       // 0x00B4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowStrafe : 1;                                  // 0x00B4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowPartialPath : 1;                             // 0x00B4(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTrackMovingGoal : 1;                              // 0x00B4(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bProjectGoalLocation : 1;                          // 0x00B4(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReachTestIncludesAgentRadius : 1;                 // 0x00B4(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReachTestIncludesGoalRadius : 1;                  // 0x00B4(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopOnOverlap : 1;                                // 0x00B4(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, DisableEditOnTemplate, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopOnOverlapNeedsUpdate : 1;                     // 0x00B5(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UBTTask_MoveTo) == 0x0000B8, "Wrong size on UBTTask_MoveTo");
static_assert(offsetof(UBTTask_MoveTo, AcceptableRadius) == 0x0000A0, "Member 'UBTTask_MoveTo::AcceptableRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, FilterClass) == 0x0000A8, "Member 'UBTTask_MoveTo::FilterClass' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, ObservedBlackboardValueTolerance) == 0x0000B0, "Member 'UBTTask_MoveTo::ObservedBlackboardValueTolerance' has a wrong offset!");
...
{
public:
	uint8                                         bDisablePathUpdateOnGoalLocationChange : 1;        // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bProjectVectorGoalToNavigation : 1;                // 0x00B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUpdatedDeprecatedProperties : 1;                  // 0x00B8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UBTTask_MoveDirectlyToward) == 0x0000C0, "Wrong size on UBTTask_MoveDirectlyToward");
...
class alignas(0x10) UBTTask_PlayAnimation final : public UBTTaskNode
{
public:
...
static_assert(alignof(UBTTask_PlayAnimation) == 0x000010, "Wrong alignment on UBTTask_PlayAnimation");
...
class alignas(0x10) UBTTask_RunEQSQuery final : public UBTTask_BlackboardBase
{
public:
	class UEnvQuery*                              QueryTemplate;                                     // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x00B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	EEnvQueryRunMode                              RunMode;                                           // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBlackboardKeySelector                 EQSQueryBlackboardKey;                             // 0x00D0(0x0028)(NativeAccessSpecifierPublic)
	bool                                          bUseBBKey;                                         // 0x00F8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x0100(0x0048)(Edit, NativeAccessSpecifierPublic)
	bool                                          bUpdateBBOnFail;                                   // 0x0148(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_149[0x47];                                     // 0x0149(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UBTTask_RunEQSQuery) == 0x000010, "Wrong alignment on UBTTask_RunEQSQuery");
static_assert(sizeof(UBTTask_RunEQSQuery) == 0x000190, "Wrong size on UBTTask_RunEQSQuery");
static_assert(offsetof(UBTTask_RunEQSQuery, QueryTemplate) == 0x0000A0, "Member 'UBTTask_RunEQSQuery::QueryTemplate' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, QueryParams) == 0x0000A8, "Member 'UBTTask_RunEQSQuery::QueryParams' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, QueryConfig) == 0x0000B8, "Member 'UBTTask_RunEQSQuery::QueryConfig' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, RunMode) == 0x0000C8, "Member 'UBTTask_RunEQSQuery::RunMode' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, EQSQueryBlackboardKey) == 0x0000D0, "Member 'UBTTask_RunEQSQuery::EQSQueryBlackboardKey' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, bUseBBKey) == 0x0000F8, "Member 'UBTTask_RunEQSQuery::bUseBBKey' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, EQSRequest) == 0x000100, "Member 'UBTTask_RunEQSQuery::EQSRequest' has a wrong offset!");
static_assert(offsetof(UBTTask_RunEQSQuery, bUpdateBBOnFail) == 0x000148, "Member 'UBTTask_RunEQSQuery::bUpdateBBOnFail' has a wrong offset!");
...
static_assert(sizeof(UBTTask_WaitBlackboardTime) == 0x0000A8, "Wrong size on UBTTask_WaitBlackboardTime");
...
static_assert(sizeof(ADetourCrowdAIController) == 0x000478, "Wrong size on ADetourCrowdAIController");
...
{
public:
	class FName                                   QueryName;                                         // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UEnvQueryOption*>                Options;                                           // 0x0040(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQuery) == 0x000050, "Wrong size on UEnvQuery");
static_assert(offsetof(UEnvQuery, QueryName) == 0x000038, "Member 'UEnvQuery::QueryName' has a wrong offset!");
static_assert(offsetof(UEnvQuery, Options) == 0x000040, "Member 'UEnvQuery::Options' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryManager) == 0x000168, "Wrong size on UEnvQueryManager");
...
static_assert(sizeof(UEQSRenderingComponent) == 0x000700, "Wrong size on UEQSRenderingComponent");
...
public:
	...
	class UEnvQuery*                              QueryTemplate;                                     // 0x06F0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x06F8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x0708(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         TimeLimitPerStep;                                  // 0x0718(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StepToDebugDraw;                                   // 0x071C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEnvQueryHightlightMode                       HighlightMode;                                     // 0x0720(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_721[0x3];                                      // 0x0721(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDrawLabels : 1;                                   // 0x0724(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawFailedItems : 1;                              // 0x0724(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReRunQueryOnlyOnFinishedMove : 1;                 // 0x0724(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldBeVisibleInGame : 1;                        // 0x0724(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTickDuringGame : 1;                               // 0x0724(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_725[0x3];                                      // 0x0725(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EEnvQueryRunMode                              QueryingMode;                                      // 0x0728(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_729[0x7];                                      // 0x0729(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNavAgentProperties                    NavAgentProperties;                                // 0x0730(0x0038)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AEQSTestingPawn) == 0x000790, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x0006F0, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x0006F8, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000708, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000718, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x00071C, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000720, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000728, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x000730, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           SearchCenter;                                      // 0x00D0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryGenerator_Cone) == 0x000188, "Wrong size on UEnvQueryGenerator_Cone");
...
static_assert(offsetof(UEnvQueryGenerator_Cone, ConeDegrees) == 0x0000D0, "Member 'UEnvQueryGenerator_Cone::ConeDegrees' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_Cone, Range) == 0x000140, "Member 'UEnvQueryGenerator_Cone::Range' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Cone, CenterActor) == 0x000178, "Member 'UEnvQueryGenerator_Cone::CenterActor' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_Donut) == 0x0001E8, "Wrong size on UEnvQueryGenerator_Donut");
...
static_assert(offsetof(UEnvQueryGenerator_Donut, OuterRadius) == 0x0000D0, "Member 'UEnvQueryGenerator_Donut::OuterRadius' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_Donut, PointsPerRing) == 0x000140, "Member 'UEnvQueryGenerator_Donut::PointsPerRing' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcDirection) == 0x000178, "Member 'UEnvQueryGenerator_Donut::ArcDirection' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcAngle) == 0x000198, "Member 'UEnvQueryGenerator_Donut::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, bUseSpiralPattern) == 0x0001D0, "Member 'UEnvQueryGenerator_Donut::bUseSpiralPattern' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, Center) == 0x0001D8, "Member 'UEnvQueryGenerator_Donut::Center' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_PathingGrid) == 0x000188, "Wrong size on UEnvQueryGenerator_PathingGrid");
...
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, NavigationFilter) == 0x000148, "Member 'UEnvQueryGenerator_PathingGrid::NavigationFilter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, ScanRangeMultiplier) == 0x000150, "Member 'UEnvQueryGenerator_PathingGrid::ScanRangeMultiplier' has a wrong offset!");
...
public:
	...
	struct FAIDataProviderFloatValue              SearchRadius;                                      // 0x0060(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UEnvQueryContext>           ListenerContext;                                   // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UAISense>                   SenseToUse;                                        // 0x00A0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIncludeKnownActors;                               // 0x00A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnvQueryGenerator_PerceivedActors) == 0x0000B0, "Wrong size on UEnvQueryGenerator_PerceivedActors");
...
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, ListenerContext) == 0x000098, "Member 'UEnvQueryGenerator_PerceivedActors::ListenerContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, SenseToUse) == 0x0000A0, "Member 'UEnvQueryGenerator_PerceivedActors::SenseToUse' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PerceivedActors, bIncludeKnownActors) == 0x0000A8, "Member 'UEnvQueryGenerator_PerceivedActors::bIncludeKnownActors' has a wrong offset!");
...
{
public:
	EEnvTestDistance                              TestMode;                                          // 0x0270(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UEnvQueryContext>           DistanceTo;                                        // 0x0278(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_Distance) == 0x000280, "Wrong size on UEnvQueryTest_Distance");
static_assert(offsetof(UEnvQueryTest_Distance, TestMode) == 0x000270, "Member 'UEnvQueryTest_Distance::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Distance, DistanceTo) == 0x000278, "Member 'UEnvQueryTest_Distance::DistanceTo' has a wrong offset!");
...
{
public:
	struct FEnvDirection                          LineA;                                             // 0x0270(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FEnvDirection                          LineB;                                             // 0x0290(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	EEnvTestDot                                   TestMode;                                          // 0x02B0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAbsoluteValue;                                    // 0x02B1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryTest_Dot) == 0x0002B8, "Wrong size on UEnvQueryTest_Dot");
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x000270, "Member 'UEnvQueryTest_Dot::LineA' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x000290, "Member 'UEnvQueryTest_Dot::LineB' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x0002B0, "Member 'UEnvQueryTest_Dot::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, bAbsoluteValue) == 0x0002B1, "Member 'UEnvQueryTest_Dot::bAbsoluteValue' has a wrong offset!");
...
{
public:
	struct FGameplayTagQuery                      TagQueryToMatch;                                   // 0x0270(0x0048)(Edit, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRejectIncompatibleItems;                          // 0x02B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdatedToUseQuery;                                // 0x02B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGameplayContainerMatchType                   TagsToMatch;                                       // 0x02BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2BB[0x5];                                      // 0x02BB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x02C0(0x0020)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryTest_GameplayTags) == 0x0002E0, "Wrong size on UEnvQueryTest_GameplayTags");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagQueryToMatch) == 0x000270, "Member 'UEnvQueryTest_GameplayTags::TagQueryToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bRejectIncompatibleItems) == 0x0002B8, "Member 'UEnvQueryTest_GameplayTags::bRejectIncompatibleItems' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bUpdatedToUseQuery) == 0x0002B9, "Member 'UEnvQueryTest_GameplayTags::bUpdatedToUseQuery' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x0002BA, "Member 'UEnvQueryTest_GameplayTags::TagsToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, GameplayTags) == 0x0002C0, "Member 'UEnvQueryTest_GameplayTags::GameplayTags' has a wrong offset!");
...
{
public:
	struct FEnvOverlapData                        OverlapData;                                       // 0x0270(0x0030)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x0002A0, "Wrong size on UEnvQueryTest_Overlap");
static_assert(offsetof(UEnvQueryTest_Overlap, OverlapData) == 0x000270, "Member 'UEnvQueryTest_Overlap::OverlapData' has a wrong offset!");
...
{
public:
	struct FAIDataProviderFloatValue              ScanRangeMultiplier;                               // 0x02F8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_PathfindingBatch) == 0x000330, "Wrong size on UEnvQueryTest_PathfindingBatch");
static_assert(offsetof(UEnvQueryTest_PathfindingBatch, ScanRangeMultiplier) == 0x0002F8, "Member 'UEnvQueryTest_PathfindingBatch::ScanRangeMultiplier' has a wrong offset!");
...
{
public:
	struct FEnvTraceData                          ProjectionData;                                    // 0x0270(0x0040)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryTest_Project) == 0x0002B0, "Wrong size on UEnvQueryTest_Project");
static_assert(offsetof(UEnvQueryTest_Project, ProjectionData) == 0x000270, "Member 'UEnvQueryTest_Project::ProjectionData' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Random) == 0x000270, "Wrong size on UEnvQueryTest_Random");
...
{
public:
	struct FEnvTraceData                          TraceData;                                         // 0x0270(0x0040)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FAIDataProviderBoolValue               TraceFromContext;                                  // 0x02B0(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ItemHeightOffset;                                  // 0x02E8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ContextHeightOffset;                               // 0x0320(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x0358(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UEnvQueryContext>           IgnoredActorsContext;                              // 0x0360(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryTest_Trace) == 0x000368, "Wrong size on UEnvQueryTest_Trace");
static_assert(offsetof(UEnvQueryTest_Trace, TraceData) == 0x000270, "Member 'UEnvQueryTest_Trace::TraceData' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, TraceFromContext) == 0x0002B0, "Member 'UEnvQueryTest_Trace::TraceFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ItemHeightOffset) == 0x0002E8, "Member 'UEnvQueryTest_Trace::ItemHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ContextHeightOffset) == 0x000320, "Member 'UEnvQueryTest_Trace::ContextHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, Context) == 0x000358, "Member 'UEnvQueryTest_Trace::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, IgnoredActorsContext) == 0x000360, "Member 'UEnvQueryTest_Trace::IgnoredActorsContext' has a wrong offset!");
...
{
public:
	TSubclassOf<class UEnvQueryContext>           VolumeContext;                                     // 0x0270(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class AVolume>                    VolumeClass;                                       // 0x0278(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bDoComplexVolumeTest : 1;                          // 0x0280(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UEnvQueryTest_Volume) == 0x000288, "Wrong size on UEnvQueryTest_Volume");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeContext) == 0x000270, "Member 'UEnvQueryTest_Volume::VolumeContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeClass) == 0x000278, "Member 'UEnvQueryTest_Volume::VolumeClass' has a wrong offset!");
...
static_assert(sizeof(AGridPathAIController) == 0x000478, "Wrong size on AGridPathAIController");
...
public:
	...
	struct FVector                                CrowdAgentMoveDirection;                           // 0x03A0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UCrowdFollowingComponent) == 0x000010, "Wrong alignment on UCrowdFollowingComponent");
static_assert(sizeof(UCrowdFollowingComponent) == 0x0003E0, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x0003A0, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
{
public:
	class UNavLocalGridManager*                   GridManager;                                       // 0x0388(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UGridPathFollowingComponent) == 0x000010, "Wrong alignment on UGridPathFollowingComponent");
static_assert(sizeof(UGridPathFollowingComponent) == 0x0003C0, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x000388, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
...
public:
	...
	TArray<struct FNavigationLink>                PointLinks;                                        // 0x0360(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNavigationSegmentLink>         SegmentLinks;                                      // 0x0370(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class UNavLinkCustomComponent*                SmartLinkComp;                                     // 0x0380(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSmartLinkIsRelevant;                              // 0x0388(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_389[0x7];                                      // 0x0389(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class AActor* MovingActor, const struct FVector& DestinationPoint)> OnSmartLinkReached; // 0x0390(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANavLinkProxy) == 0x0003A0, "Wrong size on ANavLinkProxy");
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x000360, "Member 'ANavLinkProxy::PointLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x000370, "Member 'ANavLinkProxy::SegmentLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x000380, "Member 'ANavLinkProxy::SmartLinkComp' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, bSmartLinkIsRelevant) == 0x000388, "Member 'ANavLinkProxy::bSmartLinkIsRelevant' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, OnSmartLinkReached) == 0x000390, "Member 'ANavLinkProxy::OnSmartLinkReached' has a wrong offset!");
...
{
public:
	TSubclassOf<class UUserDefinedStruct>         ListenerDataType;                                  // 0x0120(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UAIPerceptionComponent*>         ListenerContainer;                                 // 0x0128(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UAISenseEvent*>                  UnprocessedEvents;                                 // 0x0138(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(alignof(UAISense_Blueprint) == 0x000010, "Wrong alignment on UAISense_Blueprint");
...
static_assert(alignof(UAISense_Damage) == 0x000010, "Wrong alignment on UAISense_Damage");
...
static_assert(alignof(UAISense_Prediction) == 0x000010, "Wrong alignment on UAISense_Prediction");
...
static_assert(alignof(UAISense_Team) == 0x000010, "Wrong alignment on UAISense_Team");
...
static_assert(alignof(UAISense_Touch) == 0x000010, "Wrong alignment on UAISense_Touch");
...
{
public:
	TMulticastInlineDelegate<void()>              OnRequestFailed;                                   // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(EPathFollowingResult Result, class AAIController* AIController)> OnMoveFinished; // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_78[0xD8];                                      // 0x0078(0x00D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
