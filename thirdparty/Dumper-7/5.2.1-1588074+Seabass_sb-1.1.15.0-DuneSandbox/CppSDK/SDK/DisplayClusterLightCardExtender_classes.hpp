...
{
public:
	bool                                          bIsFavorite;                                       // 0x0030(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDisplayClusterStageActorTemplate) == 0x000038, "Wrong size on UDisplayClusterStageActorTemplate");
static_assert(offsetof(UDisplayClusterStageActorTemplate, bIsFavorite) == 0x000030, "Member 'UDisplayClusterStageActorTemplate::bIsFavorite' has a wrong offset!");
