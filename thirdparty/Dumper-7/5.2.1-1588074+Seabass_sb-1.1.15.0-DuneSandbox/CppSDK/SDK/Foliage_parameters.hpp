...
// Function Foliage.FoliageType_InstancedStaticMesh.GetStaticMesh
// 0x0008 (0x0008 - 0x0000)
struct FoliageType_InstancedStaticMesh_GetStaticMesh final
{
public:
...
static_assert(alignof(FoliageType_InstancedStaticMesh_GetStaticMesh) == 0x000008, "Wrong alignment on FoliageType_InstancedStaticMesh_GetStaticMesh");
static_assert(sizeof(FoliageType_InstancedStaticMesh_GetStaticMesh) == 0x000008, "Wrong size on FoliageType_InstancedStaticMesh_GetStaticMesh");
static_assert(offsetof(FoliageType_InstancedStaticMesh_GetStaticMesh, ReturnValue) == 0x000000, "Member 'FoliageType_InstancedStaticMesh_GetStaticMesh::ReturnValue' has a wrong offset!");

// Function Foliage.InstancedFoliageActor.MulticastClientUpdateState
// 0x0028 (0x0028 - 0x0000)
struct InstancedFoliageActor_MulticastClientUpdateState final
{
public:
	uint8                                         FoliageComponentIndex;                             // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint16>                                InHiddenInstances;                                 // 0x0008(0x0010)(ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<uint16>                                InUnhiddenInstances;                               // 0x0018(0x0010)(ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(InstancedFoliageActor_MulticastClientUpdateState) == 0x000008, "Wrong alignment on InstancedFoliageActor_MulticastClientUpdateState");
static_assert(sizeof(InstancedFoliageActor_MulticastClientUpdateState) == 0x000028, "Wrong size on InstancedFoliageActor_MulticastClientUpdateState");
static_assert(offsetof(InstancedFoliageActor_MulticastClientUpdateState, FoliageComponentIndex) == 0x000000, "Member 'InstancedFoliageActor_MulticastClientUpdateState::FoliageComponentIndex' has a wrong offset!");
static_assert(offsetof(InstancedFoliageActor_MulticastClientUpdateState, InHiddenInstances) == 0x000008, "Member 'InstancedFoliageActor_MulticastClientUpdateState::InHiddenInstances' has a wrong offset!");
static_assert(offsetof(InstancedFoliageActor_MulticastClientUpdateState, InUnhiddenInstances) == 0x000018, "Member 'InstancedFoliageActor_MulticastClientUpdateState::InUnhiddenInstances' has a wrong offset!");
