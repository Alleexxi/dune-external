...
class UStaticMesh* UFoliageType_InstancedStaticMesh::GetStaticMesh() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FoliageType_InstancedStaticMesh", "GetStaticMesh");

	Params::FoliageType_InstancedStaticMesh_GetStaticMesh Parms{};
...
// Parameters:
// const uint8                             FoliageComponentIndex                                  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const TArray<uint16>&                   InHiddenInstances                                      (ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// const TArray<uint16>&                   InUnhiddenInstances                                    (ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void AInstancedFoliageActor::MulticastClientUpdateState(const uint8 FoliageComponentIndex, const TArray<uint16>& InHiddenInstances, const TArray<uint16>& InUnhiddenInstances)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InstancedFoliageActor", "MulticastClientUpdateState");

	Params::InstancedFoliageActor_MulticastClientUpdateState Parms{};

	Parms.FoliageComponentIndex = FoliageComponentIndex;
	Parms.InHiddenInstances = std::move(InHiddenInstances);
	Parms.InUnhiddenInstances = std::move(InUnhiddenInstances);
...
// Function Foliage.InstancedFoliageActor.OnRep_ReplicatedRespawnParams
// (Final, Native, Private)

void AInstancedFoliageActor::OnRep_ReplicatedRespawnParams()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InstancedFoliageActor", "OnRep_ReplicatedRespawnParams");
